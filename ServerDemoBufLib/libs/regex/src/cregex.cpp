 ...
 */
  ...
  *   DESCRIPTION: Implements high level class wjl_boost::RexEx
  */
...
typedef wjl_boost::match_flag_type match_flag_type;
#include <cstdio>
...
{
   wjl_boost::uint_fast32_t f = icase ? regex::normal | regex::icase : regex::normal;
