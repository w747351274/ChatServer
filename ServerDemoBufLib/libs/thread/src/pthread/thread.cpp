...
//#endif
        ...
        {
            wjl_boost::detail::thread_exit_function_base* func;
            thread_exit_callback_node* next;

            thread_exit_callback_node(wjl_boost::detail::thread_exit_function_base* func_,
        ...
        namespace
        {
          ...
          wjl_boost::once_flag current_thread_tls_init_flag;
#else
            wjl_boost::once_flag current_thread_tls_init_flag=BOOST_ONCE_INIT;
#endif
            ...
            extern "C"
            {
                ...
                {
                    //wjl_boost::detail::thread_data_base* thread_info=static_cast<wjl_boost::detail::thread_data_base*>(data);
                    wjl_boost::detail::thread_data_ptr thread_info = static_cast<wjl_boost::detail::thread_data_base*>(data)->shared_from_this();
            ...
            struct  delete_current_thread_tls_key_on_dlclose_t
            {
                ...
                ~delete_current_thread_tls_key_on_dlclose_t()
                {
                    const wjl_boost::once_flag uninitialized = BOOST_ONCE_INIT;
                    if (memcmp(&current_thread_tls_init_flag, &uninitialized, sizeof(wjl_boost::once_flag)))
                    {
        ...
        wjl_boost::detail::thread_data_base* get_current_thread_data()
        {
            wjl_boost::call_once(current_thread_tls_init_flag,create_current_thread_tls_key);
            return (wjl_boost::detail::thread_data_base*)pthread_getspecific(current_thread_tls_key);
        }
    ...
    namespace
    {
        extern "C"
        {
            ...
            {
                //wjl_boost::detail::thread_data_ptr thread_info = static_cast<wjl_boost::detail::thread_data_base*>(param)->self;
                wjl_boost::detail::thread_data_ptr thread_info = static_cast<wjl_boost::detail::thread_data_base*>(param)->shared_from_this();
                thread_info->self.reset();
...
//                 }
                ...
                wjl_boost::lock_guard<wjl_boost::mutex> lock(thread_info->data_mutex);
...
#   endif
    ...
    unsigned thread::physical_concurrency() BOOST_NOEXCEPT
    {
        ...
        try {
            ...
            while ( getline(proc_cpuinfo, line) ) {
                ...
                wjl_boost::split(key_val, line, wjl_boost::is_any_of(":"));
                ...
                wjl_boost::trim(key);
                wjl_boost::trim(value);

                if (key == physical_id) {
                    current_core_entry.first = wjl_boost::lexical_cast<unsigned>(value);
                    continue;
                }

                if (key == core_id) {
                    current_core_entry.second = wjl_boost::lexical_cast<unsigned>(value);
    ...
    void thread::interrupt()
    {
        ...
        if(local_thread_info)
        {
            ...
            {
                wjl_boost::pthread::pthread_mutex_scoped_lock internal_lock(local_thread_info->cond_mutex);
    ...
    namespace this_thread
    {
        ...
        {
#ifndef BOOST_NO_EXCEPTIONS
            wjl_boost::detail::thread_data_base* const thread_info=detail::get_current_thread_data();
    ...
    namespace detail
    {
        ...
        void add_new_tss_node(void const* key,
                              wjl_boost::shared_ptr<tss_cleanup_function> func,
                              void* tss_data)
        {
            detail::thread_data_base* const current_thread_data(get_or_make_current_thread_data());
