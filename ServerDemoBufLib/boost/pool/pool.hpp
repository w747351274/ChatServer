...
// wjl_boost::simple_segregated_storage
#include <boost/pool/simple_segregated_storage.hpp>
// wjl_boost::alignment_of
...
class pool: protected simple_segregated_storage < typename UserAllocator::size_type >
{
  ...
  private:
    BOOST_STATIC_CONSTANT(size_type, min_alloc_size =
        (::wjl_boost::integer::static_lcm<sizeof(void *), sizeof(size_type)>::value) );
    BOOST_STATIC_CONSTANT(size_type, min_align =
        (::wjl_boost::integer::static_lcm< ::wjl_boost::alignment_of<void *>::value, ::wjl_boost::alignment_of<size_type>::value>::value) );
