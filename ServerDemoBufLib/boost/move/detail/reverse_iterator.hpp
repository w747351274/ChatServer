...
{
   public:
   typedef typename wjl_boost::movelib::iterator_traits<It>::pointer             pointer;
   typedef typename wjl_boost::movelib::iterator_traits<It>::reference           reference;
   typedef typename wjl_boost::movelib::iterator_traits<It>::difference_type     difference_type;
   typedef typename wjl_boost::movelib::iterator_traits<It>::iterator_category   iterator_category;
   typedef typename wjl_boost::movelib::iterator_traits<It>::value_type          value_type;
   ...
   reverse_iterator( const reverse_iterator<OtherIt>& r
                   , typename wjl_boost::move_detail::enable_if_convertible<OtherIt, It>::type* =0
                   )
      : m_current(r.base())
   {}
   ...
   template<class OtherIt>
   typename wjl_boost::move_detail::enable_if_convertible<OtherIt, It, reverse_iterator &>::type
