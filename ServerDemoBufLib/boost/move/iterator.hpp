...
class move_iterator
{
   ...
   typedef typename wjl_boost::movelib::iterator_traits<iterator_type>::value_type        value_type;
   #if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES) || defined(BOOST_MOVE_DOXYGEN_INVOKED)
   typedef value_type &&                                                   reference;
   #else
   typedef typename ::wjl_boost::move_detail::if_
      < ::wjl_boost::has_move_emulation_enabled<value_type>
      , ::wjl_boost::rv<value_type>&
      , value_type & >::type                                               reference;
   #endif
   typedef It                                                              pointer;
   typedef typename wjl_boost::movelib::iterator_traits<iterator_type>::difference_type   difference_type;
   typedef typename wjl_boost::movelib::iterator_traits<iterator_type>::iterator_category iterator_category;
...
template <class I>
struct is_move_iterator< ::wjl_boost::move_iterator<I> >
{
...
class back_move_insert_iterator
{
   ...
   { container_m->push_back(wjl_boost::move(x)); return *this; }
...
public:
   ...
   { container_m->push_front(wjl_boost::move(x)); return *this; }
...
class move_insert_iterator
{
   ...
   {
      pos_ = container_m->insert(pos_, ::wjl_boost::move(x));
      ++pos_;
      return *this;
   }
