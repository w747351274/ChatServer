...
/// \brief Contains helper macros and implementation details of wjl_boost::typeindex::ctti_type_index.
...
#define BOOST_TYPE_INDEX_REGISTER_CTTI_PARSING_PARAMS(begin_skip, end_skip, runtime_skip, runtime_skip_until)   \
    namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost { namespace typeindex { namespace detail {                                                  \
    ...
    }}} /* namespace wjl_boost::typeindex::detail */                                                                \
    /**/
/// @endcond
...
#   include <boost/preprocessor/facilities/expand.hpp>
    ...
    // sizeof("const char *__cdecl wjl_boost::detail::ctti<") - 1, sizeof(">::n(void)") - 1
    BOOST_TYPE_INDEX_REGISTER_CTTI_PARSING_PARAMS(40, 10, false, "")
#elif defined(_MSC_VER) && !defined (BOOST_NO_CXX11_NOEXCEPT)
    // sizeof("const char *__cdecl wjl_boost::detail::ctti<") - 1, sizeof(">::n(void) noexcept") - 1
    ...
    // sizeof("static const char *wjl_boost::detail::ctti<") - 1, sizeof("]") - 1, true, "???????????>::n() [T = int"
    ...
    // sizeof("static const char *wjl_boost::detail::ctti<") - 1, sizeof(">::n()") - 1
    // note: checked on 3.0
    ...
    // sizeof("static const char *wjl_boost::detail::ctti<") - 1, sizeof("]") - 1, true, "int>::n() [T = int"
    // note: checked on 3.1, 3.4
    BOOST_TYPE_INDEX_REGISTER_CTTI_PARSING_PARAMS(39, 1, true, "T = ")
#elif defined(__EDG__) && !defined(BOOST_NO_CXX14_CONSTEXPR)
    // sizeof("static cha wjl_boost::detail::ctti<T>::s() [with I = 40U, T = ") - 1, sizeof("]") - 1
    // note: checked on 4.14
    BOOST_TYPE_INDEX_REGISTER_CTTI_PARSING_PARAMS(58, 1, false, "")
#elif defined(__EDG__) && defined(BOOST_NO_CXX14_CONSTEXPR)
    // sizeof("static const char *wjl_boost::detail::ctti<T>::n() [with T = ") - 1, sizeof("]") - 1
    // note: checked on 4.14
    ...
    // sizeof("static constexpr char wjl_boost::detail::ctti<T>::s() [with unsigned int I = 0u; T = ") - 1, sizeof("]") - 1
    BOOST_TYPE_INDEX_REGISTER_CTTI_PARSING_PARAMS(81, 1, false, "")
#elif defined(__GNUC__) && (__GNUC__ >= 7) && !defined(BOOST_NO_CXX14_CONSTEXPR)
    // sizeof("static constexpr char wjl_boost::detail::ctti<T>::s() [with unsigned int I = 0; T = ") - 1, sizeof("]") - 1
...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost { namespace typeindex { namespace detail {
    ...
    BOOST_CXX14_CONSTEXPR inline const char* skip_begining_runtime(const char* begin, wjl_boost::false_type) BOOST_NOEXCEPT {
        return begin;
    }
    ...
    template <unsigned int ArrayLength>
    BOOST_CXX14_CONSTEXPR inline const char* skip_begining_runtime(const char* begin, wjl_boost::true_type) BOOST_NOEXCEPT {
    ...
    BOOST_CXX14_CONSTEXPR inline const char* skip_begining(const char* begin) BOOST_NOEXCEPT {
        ...
        return skip_begining_runtime<ArrayLength - ctti_skip_size_at_begin>(
            ...
            wjl_boost::integral_constant<bool, ctti_skip_more_at_runtime>()
        );
    }
...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost { namespace detail {
...
struct ctti {
    ...
    constexpr static const char* impl(::wjl_boost::typeindex::detail::index_seq<Indexes...> ) BOOST_NOEXCEPT {
        return ::wjl_boost::typeindex::detail::cstring<s<Indexes>()...>::data_;
    }
    ...
    #else
        wjl_boost::typeindex::detail::failed_to_get_function_name();
    #endif

        wjl_boost::typeindex::detail::assert_compile_time_legths<
            (size > wjl_boost::typeindex::detail::ctti_skip_size_at_begin + wjl_boost::typeindex::detail::ctti_skip_size_at_end + sizeof("const *") - 1)
        >();
        static_assert(!wjl_boost::typeindex::detail::ctti_skip_more_at_runtime, "Skipping for GCC in C++14 mode is unsupported");

        typedef typename wjl_boost::typeindex::detail::make_index_seq_impl<
            wjl_boost::typeindex::detail::ctti_skip_size_at_begin,
            size - sizeof("const *") + 1 - wjl_boost::typeindex::detail::ctti_skip_size_at_begin
        >::type idx_seq;
        return impl(idx_seq());
    }
#else
    ...
    #if defined(BOOST_TYPE_INDEX_FUNCTION_SIGNATURE)
        return wjl_boost::typeindex::detail::skip_begining< sizeof(BOOST_TYPE_INDEX_FUNCTION_SIGNATURE) >(BOOST_TYPE_INDEX_FUNCTION_SIGNATURE);
    #elif defined(__FUNCSIG__)
        return wjl_boost::typeindex::detail::skip_begining< sizeof(__FUNCSIG__) >(__FUNCSIG__);
    #elif defined(__PRETTY_FUNCTION__) \
                || defined(__GNUC__) \
                || (defined(__SUNPRO_CC) && (__SUNPRO_CC >= 0x5130)) \
                || (defined(__MWERKS__) && (__MWERKS__ >= 0x3000)) \
                ...
                || defined(__ghs__) \
                || defined(__DMC__)
        return wjl_boost::typeindex::detail::skip_begining< sizeof(__PRETTY_FUNCTION__) >(__PRETTY_FUNCTION__);
    #else
        wjl_boost::typeindex::detail::failed_to_get_function_name();
        return "";
    #endif
