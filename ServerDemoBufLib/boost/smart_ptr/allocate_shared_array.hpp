...
struct sp_if_size_array<T[N]> {
    typedef wjl_boost::shared_ptr<T[N]> type;
};
...
inline typename sp_enable<!E && wjl_boost::has_trivial_destructor<T>::value>::type
sp_array_destroy(A&, T*, std::size_t) BOOST_SP_NOEXCEPT { }

template<bool E, class A, class T>
inline typename sp_enable<!E &&
    !wjl_boost::has_trivial_destructor<T>::value>::type
...
inline typename sp_enable<!E &&
    ...
    wjl_boost::has_trivial_assign<T>::value &&
    wjl_boost::has_trivial_destructor<T>::value>::type
...
template<class A, class T>
inline typename sp_enable<wjl_boost::has_trivial_constructor<T>::value>::type
...
struct sp_array_alignment {
    enum {
        value = sp_max_size<wjl_boost::alignment_of<T>::value,
            wjl_boost::alignment_of<U>::value>::value
    };
};
...
struct sp_array_storage {
    ...
    typedef typename wjl_boost::type_with_alignment<value>::type type;
};
