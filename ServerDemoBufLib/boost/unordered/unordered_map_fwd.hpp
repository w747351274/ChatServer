...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost {
  namespace unordered {
    template <class K, class T, class H = wjl_boost::hash<K>,
  ...
  using wjl_boost::unordered::unordered_map;
  using wjl_boost::unordered::unordered_multimap;
  using wjl_boost::unordered::swap;
  using wjl_boost::unordered::operator==;
  using wjl_boost::unordered::operator!=;
}
