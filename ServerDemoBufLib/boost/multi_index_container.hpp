...
class multi_index_container:
  private ::wjl_boost::base_from_member<
    typename wjl_boost::detail::allocator::rebind_to<
      Allocator,
...
private:
  ...
  typedef typename
  wjl_boost::detail::allocator::rebind_to<
    Allocator,
...
#endif
  typedef ::wjl_boost::base_from_member<
...
BOOST_MULTI_INDEX_PROTECTED_IF_MEMBER_TEMPLATE_FRIENDS:
  ...
  std::pair<node_type*,bool> insert_ref_(T& t)
  {
    ...
    BOOST_TRY{
      new(wjl_boost::addressof(x->value())) value_type(t);
      BOOST_TRY{
        ...
        if(res==x){
          ...
          wjl_boost::detail::allocator::destroy(wjl_boost::addressof(x->value()));
          deallocate_node(x);
          return std::pair<node_type*,bool>(res,false);
        }
      }
    ...
    BOOST_MULTI_INDEX_FUNCTION_PARAM_PACK)
  {
    ...
    BOOST_TRY{
      detail::vartempl_placement_new(
        wjl_boost::addressof(x->value()),BOOST_MULTI_INDEX_FORWARD_PARAM_PACK);
      BOOST_TRY{
        node_type* res=super::insert_(x->value(),x,detail::emplaced_tag());
        if(res==x){
          ++node_count;
  ...
  friend class wjl_boost::serialization::access;
  ...
  void save(Archive& ar,const unsigned int version)const
  {
    ...
    for(iterator it=super::begin(),it_end=super::end();it!=it_end;++it){
      serialization::save_construct_data_adl(
        ar,wjl_boost::addressof(*it),value_version);
  ...
  void load(Archive& ar,const unsigned int version)
  {
    ...
    for(std::size_t n=0;n<s;++n){
      ...
      ar.reset_object_address(
        wjl_boost::addressof(p.first->value()),wjl_boost::addressof(value.get()));
...
>
typename ::wjl_boost::multi_index::index<
  ...
  multi_index_container<Value,IndexSpecifierList,Allocator>& m)BOOST_NOEXCEPT
{
  typedef multi_index_container<
    Value,IndexSpecifierList,Allocator>         multi_index_type;
  typedef typename ::wjl_boost::multi_index::index<
    multi_index_container<
      Value,IndexSpecifierList,Allocator>,
    Tag
  >::type                                       index_type;
...
template<
  typename Tag,typename Value,typename IndexSpecifierList,typename Allocator
>
const typename ::wjl_boost::multi_index::index<
  multi_index_container<Value,IndexSpecifierList,Allocator>,Tag>::type&
get(
  const multi_index_container<Value,IndexSpecifierList,Allocator>& m
)BOOST_NOEXCEPT
 ...
 * wjl_boost::serialization::collection_size_type.
...
template<typename Value,typename IndexSpecifierList,typename Allocator>
struct version<
  wjl_boost::multi_index_container<Value,IndexSpecifierList,Allocator>
>
{
...
/* Associated global functions are promoted to namespace wjl_boost, except
