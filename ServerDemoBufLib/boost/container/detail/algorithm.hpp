...
using wjl_boost::intrusive::algo_equal;
using wjl_boost::intrusive::algo_lexicographical_compare;
...
{	return wjl_boost::container::binder1st<Func>(func, arg);  }
...
{
   return (wjl_boost::container::binder2nd<Func>(func, arg));
}
...
{
   return wjl_boost::container::unary_negate<Func>(func);
}
