...
struct tree_opt
{
   static const wjl_boost::container::tree_type_enum tree_type = TreeType;
...
//! by \c wjl_boost::container::set, \c wjl_boost::container::multiset
//! \c wjl_boost::container::map and \c wjl_boost::container::multimap.
//! Supported options are: \c wjl_boost::container::optimize_size and \c wjl_boost::container::tree_type
...
{
   /// @cond
   typedef typename ::wjl_boost::intrusive::pack_options
      < tree_assoc_defaults,
...
template<class ...Options>
using tree_assoc_options_t = typename wjl_boost::container::tree_assoc_options<Options...>::type;
...
//!\c wjl_boost::container::growth_factor_50
//!\c wjl_boost::container::growth_factor_60
//!\c wjl_boost::container::growth_factor_100
//!
...
//! Helper metafunction to combine options into a single type to be used
//! by \c wjl_boost::container::vector.
//! Supported options are: \c wjl_boost::container::growth_factor and \c wjl_boost::container::stored_size
#if defined(BOOST_CONTAINER_DOXYGEN_INVOKED) || defined(BOOST_CONTAINER_VARIADIC_TEMPLATES)
template<class ...Options>
#else
template<class O1 = void, class O2 = void, class O3 = void, class O4 = void>
...
//! Supported options are: \c wjl_boost::container::growth_factor and \c wjl_boost::container::stored_size
template<class ...Options>
using vector_options_t = typename wjl_boost::container::vector_options<Options...>::type;
