...
addressof(T& o) BOOST_NOEXCEPT
{
    ...
    return wjl_boost::detail::addrof<T>::get(o, 0);
#else
    return wjl_boost::detail::addrof<T>::get(wjl_boost::detail::addrof_ref<T>(o), 0);
#endif
}
...
BOOST_FORCEINLINE typename wjl_boost::detail::addrof_result<T[N]>::type
...
addressof(T& o) BOOST_NOEXCEPT
{
    return wjl_boost::detail::addressof(o);
}
#endif
