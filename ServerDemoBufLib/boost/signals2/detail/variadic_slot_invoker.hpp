/*
  Helper class used by variadic implementation of variadic wjl_boost::signals2::signal.
...
// if compiler has std::tuple use it instead of wjl_boost::tuple
// because wjl_boost::tuple does not have variadic template support at present.
#ifdef BOOST_NO_CXX11_HDR_TUPLE
#include <boost/tuple/tuple.hpp>
#define BOOST_SIGNALS2_TUPLE wjl_boost::tuple
#define BOOST_SIGNALS2_GET wjl_boost::get
#else
#include <tuple>
      ...
      private:
        template<typename Func, unsigned ... indices, typename ... Args>
          R m_invoke(Func &func, unsigned_meta_array<indices...>, const BOOST_SIGNALS2_TUPLE<Args...> & args,
            typename wjl_boost::disable_if<wjl_boost::is_void<typename Func::result_type> >::type * = 0
          ) const
        {
        ...
        template<typename Func, unsigned ... indices, typename ... Args>
          R m_invoke(Func &func, unsigned_meta_array<indices...>, const BOOST_SIGNALS2_TUPLE<Args...> & args,
            typename wjl_boost::enable_if<wjl_boost::is_void<typename Func::result_type> >::type * = 0
          ) const
        {
