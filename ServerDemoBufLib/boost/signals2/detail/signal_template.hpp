...
// signalN::slot_function
      ...
      private:
        ...
        wjl_boost::shared_ptr<connection> _connection;
      };
...
#define BOOST_SIGNALS2_M_ARG_NAMES(arity) BOOST_PP_ENUM(arity, BOOST_SIGNALS2_M_ARG_NAME, ~)
          ...
          result_type m_invoke(const connection_body_type &connectionBody,
            typename wjl_boost::enable_if<wjl_boost::is_void<SlotResultType> >::type * = 0) const
          {
          ...
          template<typename SlotResultType>
          result_type m_invoke(const connection_body_type &connectionBody, 
            typename wjl_boost::disable_if<wjl_boost::is_void<SlotResultType> >::type * = 0) const
          {
...
#undef BOOST_SIGNALS2_MISC_STATEMENT
    ...
    namespace detail
    {
      ...
      private:
        wjl_boost::weak_ptr<detail::BOOST_SIGNALS2_SIGNAL_IMPL_CLASS_NAME(BOOST_SIGNALS2_NUM_ARGS)
...
// const wjl_boost::signals2::connection &,
...
#define BOOST_SIGNALS2_EXT_SIGNATURE(arity, Signature) \
  typename function_traits<Signature>::result_type ( \
  const wjl_boost::signals2::connection & BOOST_SIGNALS2_PP_COMMA_IF(BOOST_SIGNALS2_NUM_ARGS) \
