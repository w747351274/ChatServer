  ...
  namespace signals2 {
    namespace detail {
      ...
      class slot_call_iterator_t
        : public wjl_boost::iterator_facade<slot_call_iterator_t<Function, Iterator, ConnectionBody>,
        typename Function::result_type,
        wjl_boost::single_pass_traversal_tag,
        typename wjl_boost::add_reference<typename wjl_boost::add_const<typename Function::result_type>::type>::type >
      {
        typedef wjl_boost::iterator_facade<slot_call_iterator_t<Function, Iterator, ConnectionBody>,
          typename Function::result_type,
          wjl_boost::single_pass_traversal_tag,
          typename wjl_boost::add_reference<typename wjl_boost::add_const<typename Function::result_type>::type>::type >
        inherited;
