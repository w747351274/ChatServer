...
// and predestructors through the wjl_boost::signals2::postconstructible and
// wjl_boost::signals2::predestructible base classes.
//
...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost
{
  namespace signals2
  {
    ...
    shared_ptr<T> deconstruct_ptr(T *ptr)
    {
      ...
      shared_ptr<T> shared(ptr, wjl_boost::signals2::predestructing_deleter<T>());
