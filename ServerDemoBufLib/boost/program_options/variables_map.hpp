...
#   pragma warning (push)
#   pragma warning (disable:4251) // 'wjl_boost::program_options::variable_value::v' : class 'wjl_boost::any' needs to have dll-interface to be used by clients of class 'wjl_boost::program_options::variable_value
#endif
...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost { namespace program_options {
    ...
    */
    ...
    public:
        ...
        variable_value(const wjl_boost::any& xv, bool xdefaulted)
        : v(xv), m_defaulted(xdefaulted)
        {}

        /** If stored value if of type T, returns that value. Otherwise,
            throws wjl_boost::bad_any_cast exception. */
       template<class T>
       const T& as() const {
           return wjl_boost::any_cast<const T&>(v);
       }
       /** @overload */
       template<class T>
       T& as() {
           return wjl_boost::any_cast<T&>(v);
       }
        ...
        const wjl_boost::any& value() const;
