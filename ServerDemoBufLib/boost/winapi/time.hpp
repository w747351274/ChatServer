...
BOOST_SYMBOL_IMPORT wjl_boost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
...
BOOST_SYMBOL_IMPORT wjl_boost::winapi::ULONGLONG_ BOOST_WINAPI_WINAPI_CC
...
{
    wjl_boost::winapi::SYSTEMTIME_ st;
    wjl_boost::winapi::GetSystemTime(&st);
    wjl_boost::winapi::SystemTimeToFileTime(&st, lpFileTime);
}
#endif
