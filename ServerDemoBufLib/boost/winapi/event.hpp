...
CreateEventA(
    ...
    wjl_boost::winapi::BOOL_ bManualReset,
    wjl_boost::winapi::BOOL_ bInitialState,
...
SetEvent(wjl_boost::winapi::HANDLE_ hEvent);

BOOST_SYMBOL_IMPORT wjl_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
ResetEvent(wjl_boost::winapi::HANDLE_ hEvent);
#endif
} // extern "C"
#endif
