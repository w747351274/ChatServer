...
template <typename R = ::wjl_boost::detail::static_visitor_default_return>
...
template< typename T > struct is_static_visitor
	: public ::wjl_boost::integral_constant<bool,(::wjl_boost::detail::is_static_visitor_impl<T>::value)>
{
public:
