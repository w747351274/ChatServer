...
//
template <class T>          struct is_constructible<recursive_wrapper<T>, T>                            : wjl_boost::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, const T>                      : wjl_boost::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, T&>                           : wjl_boost::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, const T&>                     : wjl_boost::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, recursive_wrapper<T> >        : wjl_boost::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, const recursive_wrapper<T> >  : wjl_boost::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, recursive_wrapper<T>& >       : wjl_boost::true_type{};
template <class T>          struct is_constructible<recursive_wrapper<T>, const recursive_wrapper<T>& > : wjl_boost::true_type{};

template <class T, class U> struct is_constructible<recursive_wrapper<T>, U >                           : wjl_boost::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, const U >                     : wjl_boost::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, U& >                          : wjl_boost::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, const U& >                    : wjl_boost::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, recursive_wrapper<U> >        : wjl_boost::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, const recursive_wrapper<U> >  : wjl_boost::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, recursive_wrapper<U>& >       : wjl_boost::false_type{};
template <class T, class U> struct is_constructible<recursive_wrapper<T>, const recursive_wrapper<U>& > : wjl_boost::false_type{};
...
template <class T> struct is_nothrow_move_constructible<recursive_wrapper<T> > : wjl_boost::false_type{};
...
template< typename T > struct is_recursive_wrapper
    : public ::wjl_boost::integral_constant<bool,(::wjl_boost::detail::is_recursive_wrapper_impl<T>::value)>
{
public:
