...
#ifdef BOOST_HAS_TRIVIAL_CONSTRUCTOR
   : public integral_constant <bool, ((::wjl_boost::is_pod<T>::value || BOOST_HAS_TRIVIAL_CONSTRUCTOR(T)) BOOST_TT_TRIVIAL_CONSTRUCT_FIX)>{};
#else
   : public integral_constant <bool, ::wjl_boost::is_pod<T>::value>{};
#endif

template <> struct has_trivial_constructor<void> : public wjl_boost::false_type{};
template <> struct has_trivial_constructor<void const> : public wjl_boost::false_type{};
template <> struct has_trivial_constructor<void const volatile> : public wjl_boost::false_type{};
template <> struct has_trivial_constructor<void volatile> : public wjl_boost::false_type{};
