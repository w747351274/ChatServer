...
namespace posix_time {
  ...
  inline
  std::tm to_tm(const wjl_boost::posix_time::ptime& t) {
    std::tm timetm = wjl_boost::gregorian::to_tm(t.date());
    wjl_boost::posix_time::time_duration td = t.time_of_day();
  ...
  inline
  std::tm to_tm(const wjl_boost::posix_time::time_duration& td) {
    std::tm timetm;
  ...
  ptime ptime_from_tm(const std::tm& timetm) {
    wjl_boost::gregorian::date d = wjl_boost::gregorian::date_from_tm(timetm);
   ...
   *       wjl_boost::detail::winapi::FILETIME_ type.
   */
  template< typename TimeT, typename FileTimeT >
  inline
  TimeT from_ftime(const FileTimeT& ft)
  {
    return wjl_boost::date_time::time_from_ftime<TimeT>(ft);
  }

#endif // BOOST_HAS_FTIME

} } //namespace wjl_boost::posix_time
