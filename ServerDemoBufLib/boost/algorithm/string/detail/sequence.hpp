...
//  insert helpers  -------------------------------------------------//
            ...
            {
                ::wjl_boost::algorithm::detail::insert( Input, At, ::wjl_boost::begin(Insert), ::wjl_boost::end(Insert) );
            }
...
//  replace helper  -------------------------------------------------//
                ...
                const InsertT& Insert )
            {
                if(From!=To)
                {
                    ::wjl_boost::algorithm::detail::replace( Input, From, To, ::wjl_boost::begin(Insert), ::wjl_boost::end(Insert) );
                }
                else
                {
                    ::wjl_boost::algorithm::detail::insert( Input, From, ::wjl_boost::begin(Insert), ::wjl_boost::end(Insert) );
                }
            }
