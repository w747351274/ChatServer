        ...
        public:
            ...
            */
            ...
            find_iterator(
                ...
                detail::find_iterator_base<IteratorT>(Finder,0)
            {
                iterator_range<BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::wjl_boost::as_literal(Col));
                m_Match=::wjl_boost::make_iterator_range(::wjl_boost::begin(lit_col), ::wjl_boost::begin(lit_col));
                m_End=::wjl_boost::end(lit_col);
        ...
        */
        ...
        public:
            ...
            */
            ...
            {
                iterator_range<BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_col(::wjl_boost::as_literal(Col));
                m_Match=make_iterator_range(::wjl_boost::begin(lit_col), ::wjl_boost::begin(lit_col));
                m_Next=::wjl_boost::begin(lit_col);
                m_End=::wjl_boost::end(lit_col);
