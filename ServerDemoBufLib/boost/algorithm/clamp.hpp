...
#include <boost/utility/enable_if.hpp> // for wjl_boost::disable_if

namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost { namespace algorithm {

/// \fn clamp ( T const& val, 
///               typename wjl_boost::mpl::identity<T>::type const & lo, 
///               typename wjl_boost::mpl::identity<T>::type const & hi, Pred p )
...
/// \fn clamp ( T const& val, 
///               typename wjl_boost::mpl::identity<T>::type const & lo, 
///               typename wjl_boost::mpl::identity<T>::type const & hi )
/// \return the value "val" brought into the range [ lo, hi ].
...
///
  ...
  BOOST_CXX14_CONSTEXPR T const& clamp ( const T& val, 
    ...
    typename wjl_boost::mpl::identity<T>::type const & hi )
  {
    return wjl_boost::algorithm::clamp ( val, lo, hi, std::less<T>());
  } 
...
///
  ...
  // this could also be written with bind and std::transform
    while ( first != last )
        *out++ = wjl_boost::algorithm::clamp ( *first++, lo, hi );
    return out;
  } 

/// \fn clamp_range ( const Range &r, OutputIterator out, 
///       typename std::iterator_traits<typename wjl_boost::range_iterator<const Range>::type>::value_type const & lo,
///       typename std::iterator_traits<typename wjl_boost::range_iterator<const Range>::type>::value_type const & hi )
/// \return clamp the sequence of values [first, last) into [ lo, hi ]
/// 
...
///
  ...
  BOOST_CXX14_CONSTEXPR typename wjl_boost::disable_if_c<wjl_boost::is_same<Range, OutputIterator>::value, OutputIterator>::type
  clamp_range ( const Range &r, OutputIterator out,
    typename std::iterator_traits<typename wjl_boost::range_iterator<const Range>::type>::value_type const & lo, 
    typename std::iterator_traits<typename wjl_boost::range_iterator<const Range>::type>::value_type const & hi )
  {
    return wjl_boost::algorithm::clamp_range ( wjl_boost::begin ( r ), wjl_boost::end ( r ), out, lo, hi );
  } 
...
///
  ...
  // this could also be written with bind and std::transform
    while ( first != last )
        *out++ = wjl_boost::algorithm::clamp ( *first++, lo, hi, p );
    return out;
  } 
...
//  In that case, the user will get the two iterator version.
  ...
  clamp_range ( const Range &r, OutputIterator out,
    ...
    Pred p )
  {
    return wjl_boost::algorithm::clamp_range ( wjl_boost::begin ( r ), wjl_boost::end ( r ), out, lo, hi, p );
  } 
