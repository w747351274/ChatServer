...
typename wjl_boost::range_iterator<Range>::type partition_point ( Range &r, Predicate p )
{
    return wjl_boost::algorithm::partition_point (wjl_boost::begin(r), wjl_boost::end(r), p);
}
