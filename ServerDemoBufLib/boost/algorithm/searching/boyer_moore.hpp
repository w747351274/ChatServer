...
///
        ...
        corpusIter corpus_first, corpusIter corpus_last, const PatternRange &pattern )
    {
        ...
        boyer_moore<pattern_iterator> bm ( wjl_boost::begin(pattern), wjl_boost::end (pattern));
        return bm ( corpus_first, corpus_last );
    }
    ...
    template <typename Range>
    wjl_boost::algorithm::boyer_moore<typename wjl_boost::range_iterator<const Range>::type>
    make_boyer_moore ( const Range &r ) {
        return wjl_boost::algorithm::boyer_moore
            <typename wjl_boost::range_iterator<const Range>::type> (wjl_boost::begin(r), wjl_boost::end(r));
        }
    
    template <typename Range>
    wjl_boost::algorithm::boyer_moore<typename wjl_boost::range_iterator<Range>::type>
