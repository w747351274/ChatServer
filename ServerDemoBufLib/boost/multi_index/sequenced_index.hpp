...
#endif
  typedef typename
    wjl_boost::reverse_iterator<iterator>                 reverse_iterator;
  typedef typename
    wjl_boost::reverse_iterator<const_iterator>           const_reverse_iterator;
...
public:
  ...
  reverse_iterator
    rbegin()BOOST_NOEXCEPT{return wjl_boost::make_reverse_iterator(end());}
  const_reverse_iterator
    rbegin()const BOOST_NOEXCEPT{return wjl_boost::make_reverse_iterator(end());}
  reverse_iterator
    rend()BOOST_NOEXCEPT{return wjl_boost::make_reverse_iterator(begin());}
  const_reverse_iterator
    rend()const BOOST_NOEXCEPT{return wjl_boost::make_reverse_iterator(begin());}
  const_iterator
  ...
  {
    return make_iterator(node_from_value<node_type>(wjl_boost::addressof(x)));
  }
  ...
  std::pair<iterator,bool> push_front(BOOST_RV_REF(value_type) x)
                             {return insert(begin(),wjl_boost::move(x));}
  ...
  std::pair<iterator,bool> push_back(BOOST_RV_REF(value_type) x)
                             {return insert(end(),wjl_boost::move(x));}
  ...
  void remove(value_param_type value)
  {
    sequenced_index_remove(
      *this,
      ::wjl_boost::bind(std::equal_to<value_type>(),::wjl_boost::arg<1>(),value));
  }
...
BOOST_MULTI_INDEX_PROTECTED_IF_MEMBER_TEMPLATE_FRIENDS:
    ...
    Archive& ar,const unsigned int version,const index_loader_type& lm)
  {
    lm.load(
      ::wjl_boost::bind(
        &sequenced_index::rearranger,this,::wjl_boost::arg<1>(),::wjl_boost::arg<2>()),
      ar,version);
  ...
  /* This forwarding function eases things for the wjl_boost::mem_fn construct
...
template<typename SuperMeta,typename TagList>
inline wjl_boost::mpl::true_* boost_foreach_is_noncopyable(
  wjl_boost::multi_index::detail::sequenced_index<SuperMeta,TagList>*&,
