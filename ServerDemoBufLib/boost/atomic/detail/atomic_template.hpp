...
#pragma warning(push)
// 'wjl_boost::atomics::atomic<T>' : multiple assignment operators specified
...
// error: the default constructor of "wjl_boost::atomics::atomic<T>" cannot be referenced -- it is a deleted function
...
typedef atomic< wjl_boost::ulong_long_type > atomic_ullong;
typedef atomic< wjl_boost::long_long_type > atomic_llong;
#endif
