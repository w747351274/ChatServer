...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost { template<class T> class reference_wrapper; }
...
// Can't use wjl_boost::unwrap_reference<> here because it
