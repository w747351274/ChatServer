...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost { namespace mpl {
...
# define BOOST_PARAMETER_BASIC_NAME(tag_namespace, tag, name)       \
      ...
      {                                                             \
          ...
          {                                                         \
              return BOOST_PP_STRINGIZE(tag);                       \
                                                                    ...
                                                                    \
          typedef wjl_boost::parameter::value_type<                     \
              wjl_boost::mpl::_2, tag, wjl_boost::parameter::void_          \
          > _;                                                      \
                                                                    \
          typedef wjl_boost::parameter::value_type<                     \
              wjl_boost::mpl::_2, tag, wjl_boost::parameter::void_          \
    ...
    namespace                                                       \
    {                                                               \
       ::wjl_boost::parameter::keyword<tag_namespace::tag> const& name  \
       = ::wjl_boost::parameter::keyword<tag_namespace::tag>::instance; \
    }
...
# define BOOST_PARAMETER_TEMPLATE_KEYWORD(name)                     \
    ...
    template <class T>                                              \
    struct name                                                     \
      : wjl_boost::parameter::template_keyword<tag::name, T>            \
    {};                                                             \
/**/
