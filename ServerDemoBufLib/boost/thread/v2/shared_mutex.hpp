...
public:
    ...
    template <class Rep, class Period>
        bool try_lock_for(const wjl_boost::chrono::duration<Rep, Period>& rel_time);
    template <class Clock, class Duration>
        bool
        try_lock_until(
                      const wjl_boost::chrono::time_point<Clock, Duration>& abs_time);
    void unlock();
    ...
    template <class Rep, class Period>
        bool
        try_lock_shared_for(const wjl_boost::chrono::duration<Rep, Period>& rel_time);
    template <class Clock, class Duration>
        bool
...
public:
    ...
    template <class Rep, class Period>
        ...
        try_lock_upgrade_for(
                            const wjl_boost::chrono::duration<Rep, Period>& rel_time);
    template <class Clock, class Duration>
        bool
...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost {
  namespace thread_v2 {
    ...
    class shared_mutex
    {
      typedef wjl_boost::mutex              mutex_t;
      typedef wjl_boost::condition_variable cond_t;
...
#ifdef BOOST_THREAD_USES_CHRONO
      template <class Rep, class Period>
      bool try_lock_shared_for(const wjl_boost::chrono::duration<Rep, Period>& rel_time)
      {
    ...
    inline shared_mutex::~shared_mutex()
    {
      wjl_boost::lock_guard<mutex_t> _(mut_);
    }
    ...
    {
      wjl_boost::unique_lock<mutex_t> lk(mut_);
      gate1_.wait(lk, wjl_boost::bind(&shared_mutex::no_writer, wjl_boost::ref(*this)));
      state_ |= write_entered_;
      gate2_.wait(lk, wjl_boost::bind(&shared_mutex::no_readers, wjl_boost::ref(*this)));
    }
    ...
    {
      wjl_boost::unique_lock<mutex_t> lk(mut_);
      if (!gate1_.wait_until(lk, abs_time, wjl_boost::bind(
            &shared_mutex::no_writer, wjl_boost::ref(*this))))
      {
        return false;
      }
      state_ |= write_entered_;
      if (!gate2_.wait_until(lk, abs_time, wjl_boost::bind(
            &shared_mutex::no_readers, wjl_boost::ref(*this))))
      {
        state_ &= ~write_entered_;
        return false;
      }
    ...
    {
      wjl_boost::unique_lock<mutex_t> lk(mut_);
      if (!gate1_.timed_wait(lk, abs_or_rel_time, wjl_boost::bind(
            &shared_mutex::no_writer, wjl_boost::ref(*this))))
      {
        return false;
      }
      state_ |= write_entered_;
      if (!gate2_.timed_wait(lk, abs_or_rel_time, wjl_boost::bind(
            &shared_mutex::no_readers, wjl_boost::ref(*this))))
      {
        state_ &= ~write_entered_;
        return false;
    ...
    {
      wjl_boost::unique_lock<mutex_t> lk(mut_);
      gate1_.wait(lk, wjl_boost::bind(&shared_mutex::no_writer_no_max_readers, wjl_boost::ref(*this)));
        ...
        const wjl_boost::chrono::time_point<Clock, Duration>& abs_time)
    {
      wjl_boost::unique_lock<mutex_t> lk(mut_);
      if (!gate1_.wait_until(lk, abs_time, wjl_boost::bind(
            &shared_mutex::no_writer_no_max_readers, wjl_boost::ref(*this))))
      {
        return false;
      }
      count_t num_readers = (state_ & n_readers_) + 1;
...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost {
  namespace thread_v2 {
    ...
    {
      wjl_boost::unique_lock<mutex_t> lk(mut_);
      gate1_.wait(lk, wjl_boost::bind(&upgrade_mutex::no_writer_no_upgrader, wjl_boost::ref(*this)));
      state_ |= write_entered_;
      gate2_.wait(lk, wjl_boost::bind(&upgrade_mutex::no_readers, wjl_boost::ref(*this)));
    }
        ...
        const wjl_boost::chrono::time_point<Clock, Duration>& abs_time)
    {
      wjl_boost::unique_lock<mutex_t> lk(mut_);
      if (!gate1_.wait_until(lk, abs_time, wjl_boost::bind(
            &upgrade_mutex::no_writer_no_upgrader, wjl_boost::ref(*this))))
      {
        return false;
      }
      state_ |= write_entered_;
      if (!gate2_.wait_until(lk, abs_time, wjl_boost::bind(
            &upgrade_mutex::no_readers, wjl_boost::ref(*this))))
      {
        state_ &= ~write_entered_;
        return false;
      }
    ...
    {
      wjl_boost::unique_lock<mutex_t> lk(mut_);
      gate1_.wait(lk, wjl_boost::bind(&upgrade_mutex::no_writer_no_max_readers, wjl_boost::ref(*this)));
      count_t num_readers = (state_ & n_readers_) + 1;
      state_ &= ~n_readers_;
      state_ |= num_readers;
    }
        ...
        const wjl_boost::chrono::time_point<Clock, Duration>& abs_time)
    {
      wjl_boost::unique_lock<mutex_t> lk(mut_);
      if (!gate1_.wait_until(lk, abs_time, wjl_boost::bind(
            &upgrade_mutex::no_writer_no_max_readers, wjl_boost::ref(*this))))
      {
        return false;
      }
      count_t num_readers = (state_ & n_readers_) + 1;
    ...
    {
      wjl_boost::unique_lock<mutex_t> lk(mut_);
      gate1_.wait(lk, wjl_boost::bind(&upgrade_mutex::no_writer_no_upgrader_no_max_readers, wjl_boost::ref(*this)));
      count_t num_readers = (state_ & n_readers_) + 1;
      state_ &= ~n_readers_;
        ...
        const wjl_boost::chrono::time_point<Clock, Duration>& abs_time)
    {
      wjl_boost::unique_lock<mutex_t> lk(mut_);
      if (!gate1_.wait_until(lk, abs_time, wjl_boost::bind(
            &upgrade_mutex::no_writer_no_upgrader_no_max_readers, wjl_boost::ref(*this))))
      {
        return false;
      }
      count_t num_readers = (state_ & n_readers_) + 1;
