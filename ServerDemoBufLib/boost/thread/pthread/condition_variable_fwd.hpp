...
//#endif
    ...
    public:
    //private: // used by wjl_boost::thread::try_join_until
...
//#if defined BOOST_THREAD_PROVIDES_INTERRUPTIONS
            ...
            if(res)
            {
                wjl_boost::throw_exception(thread_resource_error(res, "wjl_boost::condition_variable::condition_variable() constructor failed in pthread_mutex_init"));
            }
//#endif
...
//#endif
                wjl_boost::throw_exception(thread_resource_error(res, "wjl_boost::condition_variable::condition_variable() constructor failed in pthread::cond_init"));
            }
        }
        ~condition_variable()
        {
...
//#endif
        ...
        bool timed_wait(
            unique_lock<mutex>& m,
            wjl_boost::system_time const& abs_time)
        {
        ...
        bool timed_wait(
            unique_lock<mutex>& m,
            wjl_boost::system_time const& abs_time,predicate_type pred)
        {
#if defined BOOST_THREAD_WAIT_BUG
            const detail::real_platform_timepoint ts(abs_time + BOOST_THREAD_WAIT_BUG);
#else
