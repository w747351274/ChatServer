...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost
{
    ...
    public:
        lock_error()
        : base_type(0, "wjl_boost::lock_error")
        {}

        lock_error( int ev )
        : base_type(ev, "wjl_boost::lock_error")
        {
        }
    ...
    public:
          ...
          : base_type(static_cast<int>(system::errc::resource_unavailable_try_again), "wjl_boost::thread_resource_error")
          {}

          thread_resource_error( int ev )
          : base_type(ev, "wjl_boost::thread_resource_error")
          {
          }
    ...
    public:
          ...
          : base_type(static_cast<int>(system::errc::invalid_argument), "wjl_boost::unsupported_thread_option")
          {}

          unsupported_thread_option( int ev )
          : base_type(ev, "wjl_boost::unsupported_thread_option")
          {
          }
    ...
    public:
        ...
        : base_type(static_cast<int>(system::errc::invalid_argument), "wjl_boost::invalid_thread_argument")
        {}

        invalid_thread_argument( int ev )
        : base_type(ev, "wjl_boost::invalid_thread_argument")
        {
        }
    ...
    public:
          ...
          : base_type(static_cast<int>(system::errc::permission_denied), "wjl_boost::thread_permission_error")
          {}

          thread_permission_error( int ev )
          : base_type(ev, "wjl_boost::thread_permission_error")
          {
          }
