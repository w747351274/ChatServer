...
adjacent_find(ForwardRange & rng)
{
    ...
    return std::adjacent_find(wjl_boost::begin(rng),wjl_boost::end(rng));
}
...
adjacent_find(ForwardRange & rng, BinaryPredicate pred)
{
    ...
    BOOST_RANGE_CONCEPT_ASSERT((BinaryPredicateConcept<BinaryPredicate,
        ...
        typename range_value<ForwardRange>::type>));
    return std::adjacent_find(wjl_boost::begin(rng),wjl_boost::end(rng),pred);
}
...
adjacent_find(ForwardRange & rng)
{
    ...
    return range_return<ForwardRange,re>::
        pack(std::adjacent_find(wjl_boost::begin(rng),wjl_boost::end(rng)),
             rng);
}
...
adjacent_find(ForwardRange& rng, BinaryPredicate pred)
{
    ...
    BOOST_RANGE_CONCEPT_ASSERT((BinaryPredicateConcept<BinaryPredicate,
        ...
        typename range_value<ForwardRange>::type>));
    return range_return<ForwardRange,re>::
        pack(std::adjacent_find(wjl_boost::begin(rng),wjl_boost::end(rng),pred),
             rng);
}
