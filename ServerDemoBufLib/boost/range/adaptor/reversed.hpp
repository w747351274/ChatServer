...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost
{
    namespace range_detail
    {
        ...
        struct reversed_range : 
            public wjl_boost::iterator_range< 
                      wjl_boost::reverse_iterator<
        ...
        public:
            typedef wjl_boost::reverse_iterator<BOOST_DEDUCED_TYPENAME range_iterator<R>::type> iterator;

            explicit reversed_range( R& r ) 
                : base( iterator(wjl_boost::end(r)), iterator(wjl_boost::begin(r)) )
            { }
        };
