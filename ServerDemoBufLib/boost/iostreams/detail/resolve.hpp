...
struct resolve_traits {
    typedef typename 
            mpl::if_<
                wjl_boost::detail::is_incrementable<T>,
...
range_adapter< Mode, wjl_boost::iterator_range<Iter> >
resolve(const wjl_boost::iterator_range<Iter>& rng)
{ return range_adapter< Mode, wjl_boost::iterator_range<Iter> >(rng); }
