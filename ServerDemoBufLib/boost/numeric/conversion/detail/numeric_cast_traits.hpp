...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost { namespace numeric {
    ...
    #define BOOST_NUMERIC_CONVERSION_SEQ_A() BOOST_NUMERIC_CONVERSION_BASE_BUILTIN_TYPES()(wjl_boost::long_long_type)(wjl_boost::ulong_long_type)
	#define BOOST_NUMERIC_CONVERSION_SEQ_B() (wjl_boost::long_long_type)(wjl_boost::ulong_long_type)
