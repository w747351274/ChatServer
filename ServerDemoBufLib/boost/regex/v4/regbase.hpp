...
namespace regex_constants{
   ...
   enum flag_type_
   {
      ...
      no_except = ::wjl_boost::regbase::no_except,
      failbit = ::wjl_boost::regbase::failbit,
      literal = ::wjl_boost::regbase::literal,
      icase = ::wjl_boost::regbase::icase,
      nocollate = ::wjl_boost::regbase::nocollate,
      collate = ::wjl_boost::regbase::collate,
      nosubs = ::wjl_boost::regbase::nosubs,
      optimize = ::wjl_boost::regbase::optimize,
      bk_plus_qm = ::wjl_boost::regbase::bk_plus_qm,
      bk_vbar = ::wjl_boost::regbase::bk_vbar,
      no_intervals = ::wjl_boost::regbase::no_intervals,
      no_char_classes = ::wjl_boost::regbase::no_char_classes,
      no_escape_in_lists = ::wjl_boost::regbase::no_escape_in_lists,
      no_mod_m = ::wjl_boost::regbase::no_mod_m,
      mod_x = ::wjl_boost::regbase::mod_x,
      mod_s = ::wjl_boost::regbase::mod_s,
      no_mod_s = ::wjl_boost::regbase::no_mod_s,
      save_subexpression_location = ::wjl_boost::regbase::save_subexpression_location,
      no_empty_expressions = ::wjl_boost::regbase::no_empty_expressions,

      basic = ::wjl_boost::regbase::basic,
      extended = ::wjl_boost::regbase::extended,
      normal = ::wjl_boost::regbase::normal,
      emacs = ::wjl_boost::regbase::emacs,
      awk = ::wjl_boost::regbase::awk,
      grep = ::wjl_boost::regbase::grep,
      egrep = ::wjl_boost::regbase::egrep,
      sed = basic,
      perl = normal,
      ECMAScript = normal,
      JavaScript = normal,
   ...
   typedef ::wjl_boost::regbase::flag_type syntax_option_type;
