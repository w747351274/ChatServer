...
using wjl_boost::BOOST_REGEX_DETAIL_NS::directory_iterator;
using wjl_boost::BOOST_REGEX_DETAIL_NS::file_iterator;
using wjl_boost::BOOST_REGEX_DETAIL_NS::mapfile;
} // namespace wjl_boost
