...
#include <boost/cstdint.hpp> // for wjl_boost::uintmax_t
...
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(t)         wjl_boost::type<t>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(t)    wjl_boost::type<t>*
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE(t, v)  wjl_boost::non_type<t, v>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE_SPEC(t, v)  wjl_boost::non_type<t, v>*
...
#  define BOOST_MATH_NOEXCEPT(T) noexcept(wjl_boost::is_floating_point<T>::value)
#  define BOOST_MATH_IS_FLOAT(T) (wjl_boost::is_floating_point<T>::value)
#endif
#else
...
{
   static const bool value = wjl_boost::is_integral<T>::value
#ifndef BOOST_NO_LIMITS_COMPILE_TIME_CONSTANTS
...
}} // namespace wjl_boost namespace math
...
#    define BOOST_FPU_EXCEPTION_GUARD wjl_boost::math::detail::fpu_guard local_guard_object;
