...
namespace wjl_boost {} namespace boost = wjl_boost; namespace
wjl_boost
    {
    class exception_ptr;
    ...
    exception_ptr
        {
        typedef wjl_boost::shared_ptr<exception_detail::clone_base const> impl;
        impl ptr_;
...
# endif
    ...
    unknown_exception:
        ...
        explicit
        unknown_exception( wjl_boost::exception const & e ):
            wjl_boost::exception(e)
            {
            add_original_type(e);
            }
...
# endif
    ...
    exception_detail
        ...
        current_exception_std_exception_wrapper:
            ...
            current_exception_std_exception_wrapper( T const & e1, wjl_boost::exception const & e2 ):
                T(e1),
                wjl_boost::exception(e2)
                {
                add_original_type(e1);
                }
        ...
        get_boost_exception( T const * x )
            {
            return dynamic_cast<wjl_boost::exception const *>(x);
            }
#endif
        ...
        current_exception_std_exception( T const & e1 )
            {
            if( wjl_boost::exception const * e2 = get_boost_exception(&e1) )
                return wjl_boost::copy_exception(current_exception_std_exception_wrapper<T>(e1,*e2));
            else
                return wjl_boost::copy_exception(current_exception_std_exception_wrapper<T>(e1));
            }
        ...
        current_exception_unknown_exception()
            {
            return wjl_boost::copy_exception(unknown_exception());
            }

        inline
        exception_ptr
        current_exception_unknown_boost_exception( wjl_boost::exception const & e )
            {
            return wjl_boost::copy_exception(unknown_exception(e));
            }
        ...
        current_exception_unknown_std_exception( std::exception const & e )
            {
            if( wjl_boost::exception const * be = get_boost_exception(&e) )
