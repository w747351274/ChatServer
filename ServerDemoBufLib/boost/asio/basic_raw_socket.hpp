...
public:
   ...
   * socket.
   */
  explicit basic_raw_socket(wjl_boost::asio::io_context& io_context)
   ...
   */
  basic_raw_socket(wjl_boost::asio::io_context& io_context,
   ...
   *     wjl_boost::asio::buffer(data, size), 0, sender_endpoint, handler); @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, wjl_boost::array or
   * std::vector.
   */
