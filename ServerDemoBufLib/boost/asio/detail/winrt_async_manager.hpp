...
class winrt_async_manager
  : public wjl_boost::asio::detail::service_base<winrt_async_manager>
{
public:
  // Constructor.
  winrt_async_manager(wjl_boost::asio::io_context& io_context)
    : wjl_boost::asio::detail::service_base<winrt_async_manager>(io_context),
      ...
      wjl_boost::system::error_code& ec)
  {
    ...
    auto promise = std::make_shared<std::promise<wjl_boost::system::error_code>>();
    ...
    action->Completed = ref new AsyncActionCompletedHandler(
      [promise](IAsyncAction^ action, AsyncStatus status)
      {
        ...
        case AsyncStatus::Canceled:
          promise->set_value(wjl_boost::asio::error::operation_aborted);
          break;
      ...
      winrt_async_op<void>* handler)
  {
    ...
    auto on_completed = ref new AsyncActionCompletedHandler(
      [this, handler](IAsyncAction^ action, AsyncStatus status)
      {
        ...
        {
        case AsyncStatus::Canceled:
          handler->ec_ = wjl_boost::asio::error::operation_aborted;
          break;
        case AsyncStatus::Started:
          return;
        case AsyncStatus::Completed:
        case AsyncStatus::Error:
        default:
          handler->ec_ = wjl_boost::system::error_code(
              action->ErrorCode.Value,
              wjl_boost::system::system_category());
          break;
        }
