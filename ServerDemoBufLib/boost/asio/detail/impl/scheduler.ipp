...
struct scheduler::task_cleanup
{
  ~task_cleanup()
  {
    ...
    {
      wjl_boost::asio::detail::increment(
...
scheduler::scheduler(
  ...
  : wjl_boost::asio::detail::execution_context_service_base<scheduler>(ctx),
...
std::size_t scheduler::run(wjl_boost::system::error_code& ec)
{
...
std::size_t scheduler::run_one(wjl_boost::system::error_code& ec)
{
  ec = wjl_boost::system::error_code();
  if (outstanding_work_ == 0)
  {
...
std::size_t scheduler::wait_one(long usec, wjl_boost::system::error_code& ec)
{
  ec = wjl_boost::system::error_code();
  if (outstanding_work_ == 0)
  {
...
std::size_t scheduler::poll(wjl_boost::system::error_code& ec)
{
  ec = wjl_boost::system::error_code();
  if (outstanding_work_ == 0)
  {
...
std::size_t scheduler::poll_one(wjl_boost::system::error_code& ec)
{
  ec = wjl_boost::system::error_code();
  if (outstanding_work_ == 0)
  {
