...
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  ec = wjl_boost::system::error_code(WSAGetLastError(),
      wjl_boost::asio::error::get_system_category());
#else
  ec = wjl_boost::system::error_code(errno,
      wjl_boost::asio::error::get_system_category());
#endif
  return return_value;
}
...
socket_type accept(socket_type s, socket_addr_type* addr,
    std::size_t* addrlen, wjl_boost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = wjl_boost::asio::error::bad_descriptor;
  ...
  ec = wjl_boost::system::error_code();
  return new_s;
}

socket_type sync_accept(socket_type s, state_type state,
    socket_addr_type* addr, std::size_t* addrlen, wjl_boost::system::error_code& ec)
{
  // Accept a socket.
  for (;;)
  {
    ...
    else if (ec == wjl_boost::asio::error::connection_aborted)
    {
...
void complete_iocp_accept(socket_type s,
    ...
    socket_type new_socket, wjl_boost::system::error_code& ec)
{
  // Map non-portable errors to their portable counterparts.
  if (ec.value() == ERROR_NETNAME_DELETED)
    ec = wjl_boost::asio::error::connection_aborted;
  ...
  if (!ec)
  {
    ...
    if (addr && addrlen)
    {
      ...
      {
        ec = wjl_boost::asio::error::invalid_argument;
      }
      else
      {
...
bool non_blocking_accept(socket_type s,
    ...
    wjl_boost::system::error_code& ec, socket_type& new_socket)
{
  for (;;)
  {
...
int close(socket_type s, state_type& state,
    bool destruction, wjl_boost::system::error_code& ec)
{
  int result = 0;
  if (s != invalid_socket)
  {
    ...
    if (destruction && (state & user_set_linger))
    {
      ...
      opt.l_onoff = 0;
      opt.l_linger = 0;
      wjl_boost::system::error_code ignored_ec;
    ...
    if (result != 0
        && (ec == wjl_boost::asio::error::would_block
          || ec == wjl_boost::asio::error::try_again))
    {
...
bool set_user_non_blocking(socket_type s,
    state_type& state, bool value, wjl_boost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = wjl_boost::asio::error::bad_descriptor;
...
int shutdown(socket_type s, int what, wjl_boost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = wjl_boost::asio::error::bad_descriptor;
    ...
    std::size_t addrlen, wjl_boost::system::error_code& ec)
{
  ...
  else if (ec == wjl_boost::asio::error::try_again)
    ec = wjl_boost::asio::error::no_buffer_space;
    ...
    std::size_t addrlen, wjl_boost::system::error_code& ec)
{
  ...
  if (ec != wjl_boost::asio::error::in_progress
      && ec != wjl_boost::asio::error::would_block)
  {
  ...
  ec = wjl_boost::system::error_code(connect_error,
      wjl_boost::asio::error::get_system_category());
}

#if defined(BOOST_ASIO_HAS_IOCP)

void complete_iocp_connect(socket_type s, wjl_boost::system::error_code& ec)
{
  // Map non-portable errors to their portable counterparts.
  switch (ec.value())
  {
  case ERROR_CONNECTION_REFUSED:
    ec = wjl_boost::asio::error::connection_refused;
    break;
  case ERROR_NETWORK_UNREACHABLE:
    ec = wjl_boost::asio::error::network_unreachable;
    break;
  case ERROR_HOST_UNREACHABLE:
    ec = wjl_boost::asio::error::host_unreachable;
    break;
  case ERROR_SEM_TIMEOUT:
    ec = wjl_boost::asio::error::timed_out;
    break;
  default:
    break;
  }
...
bool non_blocking_connect(socket_type s, wjl_boost::system::error_code& ec)
{
...
int socketpair(int af, int type, int protocol,
    socket_type sv[2], wjl_boost::system::error_code& ec)
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  (void)(af);
  (void)(type);
  (void)(protocol);
  (void)(sv);
  ec = wjl_boost::asio::error::operation_not_supported;
  return socket_error_retval;
#else
  clear_last_error();
...
bool sockatmark(socket_type s, wjl_boost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = wjl_boost::asio::error::bad_descriptor;
...
# if defined(ENOTTY)
  if (ec.value() == ENOTTY)
    ec = wjl_boost::asio::error::not_socket;
...
size_t available(socket_type s, wjl_boost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = wjl_boost::asio::error::bad_descriptor;
...
int listen(socket_type s, int backlog, wjl_boost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = wjl_boost::asio::error::bad_descriptor;
...
signed_size_type recv(socket_type s, buf* bufs, size_t count,
    int flags, wjl_boost::system::error_code& ec)
{
  clear_last_error();
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  // Receive some data.
  ...
  if (ec.value() == ERROR_NETNAME_DELETED)
    ec = wjl_boost::asio::error::connection_reset;
...
size_t sync_recv(socket_type s, state_type state, buf* bufs,
    size_t count, int flags, bool all_empty, wjl_boost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = wjl_boost::asio::error::bad_descriptor;
...
void complete_iocp_recv(state_type state,
    ...
    wjl_boost::system::error_code& ec, size_t bytes_transferred)
{
  // Map non-portable errors to their portable counterparts.
  if (ec.value() == ERROR_NETNAME_DELETED)
  {
    if (cancel_token.expired())
      ec = wjl_boost::asio::error::operation_aborted;
    else
      ec = wjl_boost::asio::error::connection_reset;
  }
  else if (ec.value() == ERROR_PORT_UNREACHABLE)
...
signed_size_type recvmsg(socket_type s, buf* bufs, size_t count,
    int in_flags, int& out_flags, wjl_boost::system::error_code& ec)
{
  clear_last_error();
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  out_flags = 0;
...
int setsockopt(socket_type s, state_type& state, int level, int optname,
    const void* optval, std::size_t optlen, wjl_boost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = wjl_boost::asio::error::bad_descriptor;
...
int getsockopt(socket_type s, state_type state, int level, int optname,
    void* optval, size_t* optlen, wjl_boost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = wjl_boost::asio::error::bad_descriptor;
...
int getpeername(socket_type s, socket_addr_type* addr,
    std::size_t* addrlen, bool cached, wjl_boost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = wjl_boost::asio::error::bad_descriptor;
  ...
  if (cached)
  {
    ...
    {
      ec = wjl_boost::asio::error::not_connected;
      return socket_error_retval;
    }
...
int ioctl(socket_type s, state_type& state, int cmd,
    ioctl_arg_type* arg, wjl_boost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = wjl_boost::asio::error::bad_descriptor;
...
int select(int nfds, fd_set* readfds, fd_set* writefds,
    fd_set* exceptfds, timeval* timeout, wjl_boost::system::error_code& ec)
{
  clear_last_error();
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  ...
  // system clock (as wrapped by wjl_boost::posix_time::microsec_clock) typically
...
int poll_read(socket_type s, state_type state,
    int msec, wjl_boost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = wjl_boost::asio::error::bad_descriptor;
  ...
  if (result == 0)
    ec = (state & user_set_non_blocking)
      ? wjl_boost::asio::error::would_block : wjl_boost::system::error_code();
  else if (result > 0)
    ec = wjl_boost::system::error_code();
  return result;
}
...
int poll_connect(socket_type s, int msec, wjl_boost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = wjl_boost::asio::error::bad_descriptor;
...
const char* inet_ntop(int af, const void* src, char* dest, size_t length,
    unsigned long scope_id, wjl_boost::system::error_code& ec)
{
  clear_last_error();
#if defined(BOOST_ASIO_WINDOWS_RUNTIME)
  ...
  {
    ec = wjl_boost::asio::error::address_family_not_supported;
    return 0;
  }
#elif defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  using namespace std; // For memcpy.
...
int gethostname(char* name, int namelen, wjl_boost::system::error_code& ec)
{
  clear_last_error();
#if defined(BOOST_ASIO_WINDOWS_RUNTIME)
  try
  ...
  {
    ec = wjl_boost::system::error_code(e->HResult,
        wjl_boost::system::system_category());
    return -1;
  }
...
inline wjl_boost::system::error_code translate_netdb_error(int error)
{
  switch (error)
  {
  case 0:
    return wjl_boost::system::error_code();
  case HOST_NOT_FOUND:
    return wjl_boost::asio::error::host_not_found;
  case TRY_AGAIN:
    return wjl_boost::asio::error::host_not_found_try_again;
  case NO_RECOVERY:
    return wjl_boost::asio::error::no_recovery;
  case NO_DATA:
    return wjl_boost::asio::error::no_data;
  default:
    BOOST_ASIO_ASSERT(false);
    return wjl_boost::asio::error::invalid_argument;
  }
}

inline hostent* gethostbyaddr(const char* addr, int length, int af,
    hostent* result, char* buffer, int buflength, wjl_boost::system::error_code& ec)
{
  clear_last_error();
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  (void)(buffer);
...
inline hostent* gethostbyname(const char* name, int af, struct hostent* result,
    char* buffer, int buflength, int ai_flags, wjl_boost::system::error_code& ec)
{
  clear_last_error();
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
  (void)(buffer);
    ...
    const addrinfo_type* hintsp, addrinfo_type** result)
{
  ...
  for (gai_search* sptr = search; sptr < search + search_count; ++sptr)
  {
    ...
    if (hptr == 0)
    {
      ...
      freeaddrinfo_emulation(aihead);
      gai_free(canon);
      if (ec == wjl_boost::asio::error::host_not_found)
        return EAI_NONAME;
      if (ec == wjl_boost::asio::error::host_not_found_try_again)
        return EAI_AGAIN;
      if (ec == wjl_boost::asio::error::no_recovery)
        return EAI_FAIL;
      if (ec == wjl_boost::asio::error::no_data)
        return EAI_NONAME;
      return EAI_NONAME;
    }
...
inline wjl_boost::system::error_code getnameinfo_emulation(
    ...
    wjl_boost::system::error_code& ec)
{
  ...
  case BOOST_ASIO_OS_DEF(AF_INET):
    ...
    {
      return ec = wjl_boost::asio::error::invalid_argument;
    }
  ...
  case BOOST_ASIO_OS_DEF(AF_INET6):
    ...
    break;
  default:
    return ec = wjl_boost::asio::error::address_family_not_supported;
  }
  ...
  if (host && hostlen > 0)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          return ec = wjl_boost::asio::error::host_not_found;
        }
  ...
  if (serv && servlen > 0)
  {
    if (flags & NI_NUMERICSERV)
    {
      if (servlen < 6)
      {
        return ec = wjl_boost::asio::error::no_buffer_space;
      }
#if defined(BOOST_ASIO_HAS_SECURE_RTL)
...
inline wjl_boost::system::error_code translate_addrinfo_error(int error)
{
  switch (error)
  {
  case 0:
  ...
  case EAI_FAIL:
    return wjl_boost::asio::error::no_recovery;
  case EAI_FAMILY:
    return wjl_boost::asio::error::address_family_not_supported;
  case EAI_MEMORY:
    return wjl_boost::asio::error::no_memory;
  case EAI_NONAME:
  ...
  case EAI_NODATA:
    ...
    return wjl_boost::asio::error::host_not_found;
  case EAI_SERVICE:
    return wjl_boost::asio::error::service_not_found;
  case EAI_SOCKTYPE:
    return wjl_boost::asio::error::socket_type_not_supported;
  default: // Possibly the non-portable EAI_SYSTEM.
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
    return wjl_boost::system::error_code(
        WSAGetLastError(), wjl_boost::asio::error::get_system_category());
#else
    return wjl_boost::system::error_code(
        errno, wjl_boost::asio::error::get_system_category());
#endif
  }
}

wjl_boost::system::error_code getaddrinfo(const char* host,
    const char* service, const addrinfo_type& hints,
    addrinfo_type** result, wjl_boost::system::error_code& ec)
{
...
wjl_boost::system::error_code background_getaddrinfo(
...
wjl_boost::system::error_code getnameinfo(const socket_addr_type* addr,
    std::size_t addrlen, char* host, std::size_t hostlen,
    char* serv, std::size_t servlen, int flags, wjl_boost::system::error_code& ec)
{
#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
# if defined(BOOST_ASIO_HAS_GETADDRINFO)
  // Building for Windows XP, Windows Server 2003, or later.
...
wjl_boost::system::error_code sync_getnameinfo(
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int sock_type, wjl_boost::system::error_code& ec)
{
...
wjl_boost::system::error_code background_getnameinfo(
    const weak_cancel_token_type& cancel_token,
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int sock_type, wjl_boost::system::error_code& ec)
