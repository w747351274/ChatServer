...
winrt_timer_scheduler::winrt_timer_scheduler(
  ...
  : wjl_boost::asio::detail::service_base<winrt_timer_scheduler>(io_context),
    ...
    shutdown_(false)
{
  thread_ = new wjl_boost::asio::detail::thread(
...
void winrt_timer_scheduler::notify_fork(wjl_boost::asio::io_context::fork_event)
{
}
