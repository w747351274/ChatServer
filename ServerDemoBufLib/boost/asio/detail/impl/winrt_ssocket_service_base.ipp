    ...
    winrt_ssocket_service_base::base_implementation_type& other_impl)
{
  ...
  {
    // Insert implementation into linked list of all implementations.
    wjl_boost::asio::detail::mutex::scoped_lock lock(other_service.mutex_);
...
wjl_boost::system::error_code winrt_ssocket_service_base::close(
    winrt_ssocket_service_base::base_implementation_type& impl,
...
wjl_boost::system::error_code winrt_ssocket_service_base::do_set_option(
    winrt_ssocket_service_base::base_implementation_type& impl,
...
wjl_boost::system::error_code winrt_ssocket_service_base::do_connect(
    winrt_ssocket_service_base::base_implementation_type& impl,
    ...
    const void* addr, winrt_async_op<void>* op, bool is_continuation)
{
  if (!is_open(impl))
  {
    op->ec_ = wjl_boost::asio::error::bad_descriptor;
  ...
  case BOOST_ASIO_OS_DEF(AF_INET6):
    ...
    break;
  default:
    op->ec_ = wjl_boost::asio::error::address_family_not_supported;
    break;
  }
  ...
  {
    op->ec_ = wjl_boost::system::error_code(
        e->HResult, wjl_boost::system::system_category());
    io_context_.post_immediate_completion(op, is_continuation);
  }
}
...
std::size_t winrt_ssocket_service_base::do_send(
    winrt_ssocket_service_base::base_implementation_type& impl,
    const wjl_boost::asio::const_buffer& data,
    socket_base::message_flags flags, wjl_boost::system::error_code& ec)
{
  ...
  try
  {
    buffer_sequence_adapter<wjl_boost::asio::const_buffer,
      wjl_boost::asio::const_buffer> bufs(wjl_boost::asio::buffer(data));
      ...
      winrt_async_op<unsigned int>* op, bool is_continuation)
{
  ...
  {
    op->ec_ = wjl_boost::system::error_code(e->HResult,
        wjl_boost::system::system_category());
    io_context_.post_immediate_completion(op, is_continuation);
  }
}
...
std::size_t winrt_ssocket_service_base::do_receive(
    winrt_ssocket_service_base::base_implementation_type& impl,
    const wjl_boost::asio::mutable_buffer& data,
    socket_base::message_flags flags, wjl_boost::system::error_code& ec)
{
  if (flags)
  {
  ...
  try
  {
    buffer_sequence_adapter<wjl_boost::asio::mutable_buffer,
        wjl_boost::asio::mutable_buffer> bufs(wjl_boost::asio::buffer(data));
