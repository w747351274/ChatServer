...
public:
  ...
  BOOST_ASIO_DECL wjl_boost::system::error_code open(implementation_type& impl,
      const std::string& device, wjl_boost::system::error_code& ec);

  // Assign a native handle to a serial port implementation.
  wjl_boost::system::error_code assign(implementation_type& impl,
      const native_handle_type& handle, wjl_boost::system::error_code& ec)
  {
  ...
  // Destroy a serial port implementation.
  wjl_boost::system::error_code close(implementation_type& impl,
  ...
  wjl_boost::system::error_code cancel(implementation_type& impl,
      wjl_boost::system::error_code& ec)
  {
  ...
  wjl_boost::system::error_code set_option(implementation_type& impl,
      const SettableSerialPortOption& option, wjl_boost::system::error_code& ec)
  {
  ...
  wjl_boost::system::error_code get_option(const implementation_type& impl,
      GettableSerialPortOption& option, wjl_boost::system::error_code& ec) const
  {
  ...
  wjl_boost::system::error_code send_break(implementation_type&,
      wjl_boost::system::error_code& ec)
  {
  ...
  size_t write_some(implementation_type& impl,
      const ConstBufferSequence& buffers, wjl_boost::system::error_code& ec)
  {
  ...
  size_t read_some(implementation_type& impl,
      const MutableBufferSequence& buffers, wjl_boost::system::error_code& ec)
  {
...
private:
  ...
  typedef wjl_boost::system::error_code (*store_function_type)(
      const void*, ::DCB&, wjl_boost::system::error_code&);

  // Helper function template to store a serial port option.
  template <typename SettableSerialPortOption>
  static wjl_boost::system::error_code store_option(const void* option,
      ::DCB& storage, wjl_boost::system::error_code& ec)
  {
  ...
  BOOST_ASIO_DECL wjl_boost::system::error_code do_set_option(
      ...
      const void* option, wjl_boost::system::error_code& ec);

  // Function pointer type for loading a serial port option.
  typedef wjl_boost::system::error_code (*load_function_type)(
      void*, const ::DCB&, wjl_boost::system::error_code&);

  // Helper function template to load a serial port option.
  template <typename GettableSerialPortOption>
  static wjl_boost::system::error_code load_option(void* option,
      const ::DCB& storage, wjl_boost::system::error_code& ec)
  {
  ...
  BOOST_ASIO_DECL wjl_boost::system::error_code do_get_option(
      const implementation_type& impl, load_function_type load,
      void* option, wjl_boost::system::error_code& ec) const;
