...
public:
  ...
  // Destroy a socket implementation.
  BOOST_ASIO_DECL wjl_boost::system::error_code close(
      base_implementation_type& impl, wjl_boost::system::error_code& ec);
  ...
  wjl_boost::system::error_code cancel(base_implementation_type&,
  ...
  wjl_boost::system::error_code io_control(base_implementation_type&,
      IO_Control_Command&, wjl_boost::system::error_code& ec)
  {
    ec = wjl_boost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  wjl_boost::system::error_code non_blocking(base_implementation_type&,
      bool, wjl_boost::system::error_code& ec)
  {
    ec = wjl_boost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  wjl_boost::system::error_code native_non_blocking(base_implementation_type&,
      bool, wjl_boost::system::error_code& ec)
  {
    ec = wjl_boost::asio::error::operation_not_supported;
    return ec;
  ...
  wjl_boost::system::error_code shutdown(base_implementation_type&,
      socket_base::shutdown_type, wjl_boost::system::error_code& ec)
  {
    ec = wjl_boost::asio::error::operation_not_supported;
    return ec;
  }
  ...
  std::size_t send(base_implementation_type& impl,
      ...
      socket_base::message_flags flags, wjl_boost::system::error_code& ec)
  {
    return do_send(impl,
        buffer_sequence_adapter<wjl_boost::asio::const_buffer,
          ConstBufferSequence>::first(buffers), flags, ec);
  }

  // Wait until data can be sent without blocking.
  std::size_t send(base_implementation_type&, const null_buffers&,
      socket_base::message_flags, wjl_boost::system::error_code& ec)
  {
    ec = wjl_boost::asio::error::operation_not_supported;
    return 0;
  }
      ...
      socket_base::message_flags flags, Handler& handler)
  {
    bool is_continuation =
      wjl_boost_asio_handler_cont_helpers::is_continuation(handler);

    // Allocate and construct an operation to wrap the handler.
    typedef winrt_socket_send_op<ConstBufferSequence, Handler> op;
    typename op::ptr p = { wjl_boost::asio::detail::addressof(handler),
  ...
  {
    wjl_boost::system::error_code ec = wjl_boost::asio::error::operation_not_supported;
      ...
      socket_base::message_flags flags, wjl_boost::system::error_code& ec)
  {
    return do_receive(impl,
        buffer_sequence_adapter<wjl_boost::asio::mutable_buffer,
...
protected:
  ...
  BOOST_ASIO_DECL std::size_t do_get_endpoint(
      ...
      void* addr, std::size_t addr_len, wjl_boost::system::error_code& ec) const;

  // Helper function to set a socket option.
  BOOST_ASIO_DECL wjl_boost::system::error_code do_set_option(
  ...
  BOOST_ASIO_DECL void do_get_option(
      ...
      std::size_t* optlen, wjl_boost::system::error_code& ec) const;

  // Helper function to perform a synchronous connect.
  BOOST_ASIO_DECL wjl_boost::system::error_code do_connect(
      base_implementation_type& impl,
      const void* addr, wjl_boost::system::error_code& ec);
  ...
  BOOST_ASIO_DECL std::size_t do_send(
      base_implementation_type& impl, const wjl_boost::asio::const_buffer& data,
      socket_base::message_flags flags, wjl_boost::system::error_code& ec);

  // Helper function to start an asynchronous send.
  BOOST_ASIO_DECL void start_send_op(base_implementation_type& impl,
      const wjl_boost::asio::const_buffer& data, socket_base::message_flags flags,
  ...
  BOOST_ASIO_DECL std::size_t do_receive(
      base_implementation_type& impl, const wjl_boost::asio::mutable_buffer& data,
      socket_base::message_flags flags, wjl_boost::system::error_code& ec);

  // Helper function to start an asynchronous receive.
  BOOST_ASIO_DECL void start_receive_op(base_implementation_type& impl,
      const wjl_boost::asio::mutable_buffer& data, socket_base::message_flags flags,
  ...
  wjl_boost::asio::detail::mutex mutex_;
