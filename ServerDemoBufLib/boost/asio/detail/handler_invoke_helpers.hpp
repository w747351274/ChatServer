...
namespace wjl_boost_asio_handler_invoke_helpers {
...
inline void invoke(Function& function, Context& context)
{
  ...
  tmp();
#else
  using wjl_boost::asio::asio_handler_invoke;
  asio_handler_invoke(function, wjl_boost::asio::detail::addressof(context));
#endif
}
