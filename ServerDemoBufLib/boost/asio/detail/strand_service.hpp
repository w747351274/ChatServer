...
class strand_service
  : public wjl_boost::asio::detail::service_base<strand_service>
{
private:
...
public:
  ...
  BOOST_ASIO_DECL explicit strand_service(wjl_boost::asio::io_context& io_context);
...
private:
  ...
  BOOST_ASIO_DECL static void do_complete(void* owner,
      operation* base, const wjl_boost::system::error_code& ec,
