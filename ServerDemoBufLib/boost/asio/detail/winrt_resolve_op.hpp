...
public:
  ...
  static void do_complete(void* owner, operation* base,
      const wjl_boost::system::error_code&, std::size_t)
  {
    // Take ownership of the operation object.
    winrt_resolve_op* o(static_cast<winrt_resolve_op*>(base));
    ptr p = { wjl_boost::asio::detail::addressof(o->handler_), o, o };
    ...
    if (!o->ec_)
    {
      ...
      {
        o->ec_ = wjl_boost::system::error_code(e->HResult,
    ...
    detail::binder2<Handler, wjl_boost::system::error_code, results_type>
      handler(o->handler_, o->ec_, results);
    p.h = wjl_boost::asio::detail::addressof(handler.handler_);
    p.reset();
