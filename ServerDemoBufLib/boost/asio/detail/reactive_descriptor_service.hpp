...
public:
  ...
  class implementation_type
    : private wjl_boost::asio::detail::noncopyable
  {
  public:
    // Default constructor.
    implementation_type()
  ...
  BOOST_ASIO_DECL wjl_boost::system::error_code assign(implementation_type& impl,
  ...
  // Destroy a descriptor implementation.
  BOOST_ASIO_DECL wjl_boost::system::error_code close(implementation_type& impl,
      wjl_boost::system::error_code& ec);
  ...
  BOOST_ASIO_DECL wjl_boost::system::error_code cancel(implementation_type& impl,
      wjl_boost::system::error_code& ec);

  // Perform an IO control command on the descriptor.
  template <typename IO_Control_Command>
  wjl_boost::system::error_code io_control(implementation_type& impl,
  ...
  wjl_boost::system::error_code non_blocking(implementation_type& impl,
  ...
  wjl_boost::system::error_code native_non_blocking(implementation_type& impl,
      bool mode, wjl_boost::system::error_code& ec)
  {
  ...
  wjl_boost::system::error_code wait(implementation_type& impl,
      posix::descriptor_base::wait_type w, wjl_boost::system::error_code& ec)
  {
    switch (w)
    {
  ...
  size_t write_some(implementation_type& impl,
      const null_buffers&, wjl_boost::system::error_code& ec)
  {
