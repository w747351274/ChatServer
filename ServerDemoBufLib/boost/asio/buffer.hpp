 ...
 * member functions:
 *
 * @code wjl_boost::asio::mutable_buffer b1 = ...;
...
public:
  ...
  mutable_buffer(void* data, std::size_t size,
      wjl_boost::asio::detail::function<void()> debug_check)
    : data_(data),
      size_(size),
  ...
  const wjl_boost::asio::detail::function<void()>& get_debug_check() const
  {
    return debug_check_;
  }
#endif // BOOST_ASIO_ENABLE_BUFFER_DEBUGGING
...
#if defined(BOOST_ASIO_ENABLE_BUFFER_DEBUGGING)
  wjl_boost::asio::detail::function<void()> debug_check_;
#endif // BOOST_ASIO_ENABLE_BUFFER_DEBUGGING
};
 ...
 * member functions:
 *
 * @code wjl_boost::asio::const_buffer b1 = ...;
 * std::size_t s1 = b1.size();
...
struct is_mutable_buffer_sequence
  ...
  : wjl_boost::asio::detail::is_buffer_sequence<T, mutable_buffer>
...
struct is_const_buffer_sequence
  ...
  : integral_constant<bool, automatically_determined>
#else // defined(GENERATING_DOCUMENTATION)
  : wjl_boost::asio::detail::is_buffer_sequence<T, const_buffer>
#endif // defined(GENERATING_DOCUMENTATION)
{
};
...
struct is_dynamic_buffer
  ...
  : integral_constant<bool, automatically_determined>
#else // defined(GENERATING_DOCUMENTATION)
  : wjl_boost::asio::detail::is_dynamic_buffer<T>
#endif // defined(GENERATING_DOCUMENTATION)
{
};
...
/** @defgroup buffer_sequence_begin wjl_boost::asio::buffer_sequence_begin
 *
 * @brief The wjl_boost::asio::buffer_sequence_begin function returns an iterator
...
/** @defgroup buffer_sequence_end wjl_boost::asio::buffer_sequence_end
 *
 * @brief The wjl_boost::asio::buffer_sequence_end function returns an iterator
 ...
 * auto i = wjl_boost::asio::buffer_sequence_begin(buffers);
 * auto end = wjl_boost::asio::buffer_sequence_end(buffers);
 * for (; i != end; ++i)
 * {
 *   const_buffer b(*i);
 *   total_size += b.size();
...
inline std::size_t buffer_size(const BufferSequence& b) BOOST_ASIO_NOEXCEPT
{
  return detail::buffer_size(
      ...
      wjl_boost::asio::buffer_sequence_begin(b),
      wjl_boost::asio::buffer_sequence_end(b));
}

#if !defined(BOOST_ASIO_NO_DEPRECATED)

/** @defgroup buffer_cast wjl_boost::asio::buffer_cast
 *
 * @brief (Deprecated: Use the @c data() member function.) The
 * wjl_boost::asio::buffer_cast function is used to obtain a pointer to the
 ...
 * @code wjl_boost::asio::const_buffer b1 = ...;
 * const unsigned char* p1 = wjl_boost::asio::buffer_cast<const unsigned char*>(b1);
 * @endcode
 *
 * To access the memory of a modifiable buffer, use:
 * @code wjl_boost::asio::mutable_buffer b2 = ...;
 * unsigned char* p2 = wjl_boost::asio::buffer_cast<unsigned char*>(b2);
 * @endcode
 *
 * The wjl_boost::asio::buffer_cast function permits violations of type safety, so
...
/** @defgroup buffer wjl_boost::asio::buffer
 *
 * @brief The wjl_boost::asio::buffer function is used to create a buffer object to
 ...
 * specified size:
 *
 * @code sock.send(wjl_boost::asio::buffer(data, size)); @endcode
 *
 * In the above example, the return value of wjl_boost::asio::buffer meets the
 * requirements of the ConstBufferSequence concept so that it may be directly
 * passed to the socket's write function. A buffer created for modifiable
 * memory also meets the requirements of the MutableBufferSequence concept.
 *
 * An individual buffer may be created from a builtin array, std::vector,
 * std::array or wjl_boost::array of POD elements. This helps prevent buffer
 * overruns by automatically determining the size of the buffer:
 *
 * @code char d1[128];
 * size_t bytes_transferred = sock.receive(wjl_boost::asio::buffer(d1));
 *
 * std::vector<char> d2(128);
 * bytes_transferred = sock.receive(wjl_boost::asio::buffer(d2));
 *
 * std::array<char, 128> d3;
 * bytes_transferred = sock.receive(wjl_boost::asio::buffer(d3));
 *
 * wjl_boost::array<char, 128> d4;
 * bytes_transferred = sock.receive(wjl_boost::asio::buffer(d4)); @endcode
 *
 ...
 * unsigned char* p1 = static_cast<unsigned char*>(b1.data());
 *
 * wjl_boost::asio::const_buffer b2 = ...;
 ...
 *
 * vector<unsigned char> data(wjl_boost::asio::buffer_size(buffers));
 * wjl_boost::asio::buffer_copy(wjl_boost::asio::buffer(data), buffers); @endcode
 *
 ...
 *
 * For the wjl_boost::asio::buffer overloads that accept an argument of type
 ...
 * follows:
 *
 * @code wjl_boost::array<char, 6> a = { 'a', 'b', 'c', 'd', 'e' }; @endcode
 *
 * A buffer object @c b1 created using:
 *
 * @code b1 = wjl_boost::asio::buffer(a); @endcode
 *
 * represents the entire array, <tt>{ 'a', 'b', 'c', 'd', 'e' }</tt>. An
 * optional second argument to the wjl_boost::asio::buffer function may be used to
 * limit the size, in bytes, of the buffer:
 *
 * @code b2 = wjl_boost::asio::buffer(a, 3); @endcode
 *
 ...
 *
 * @code b4 = wjl_boost::asio::buffer(b1 + 1, 3); @endcode
 *
 ...
 * char d1[128];
 * std::vector<char> d2(128);
 * wjl_boost::array<char, 128> d3;
 *
 * wjl_boost::array<mutable_buffer, 3> bufs1 = {
 *   wjl_boost::asio::buffer(d1),
 *   wjl_boost::asio::buffer(d2),
 *   wjl_boost::asio::buffer(d3) };
 * bytes_transferred = sock.receive(bufs1);
 *
 * std::vector<const_buffer> bufs2;
 * bufs2.push_back(wjl_boost::asio::buffer(d1));
 * bufs2.push_back(wjl_boost::asio::buffer(d2));
 * bufs2.push_back(wjl_boost::asio::buffer(d3));
...
//
//   unspecified buffer(wjl_boost::array<PodType, N>& array ...);
//
// and
//
//   unspecified buffer(wjl_boost::array<const PodType, N>& array ...);
//
...
buffer(wjl_boost::array<PodType, N>& data) BOOST_ASIO_NOEXCEPT
{
  typedef typename wjl_boost::asio::detail::buffer_types<PodType>::buffer_type
    buffer_type;
  typedef typename wjl_boost::asio::detail::buffer_types<PodType>::container_type
    container_type;
...
template <typename PodType, std::size_t N>
inline typename detail::buffer_types<PodType>::container_type
buffer(wjl_boost::array<PodType, N>& data,
    std::size_t max_size_in_bytes) BOOST_ASIO_NOEXCEPT
{
  typedef typename wjl_boost::asio::detail::buffer_types<PodType>::buffer_type
    buffer_type;
...
template <typename PodType, std::size_t N>
inline BOOST_ASIO_MUTABLE_BUFFER buffer(
    wjl_boost::array<PodType, N>& data) BOOST_ASIO_NOEXCEPT
{
  return BOOST_ASIO_MUTABLE_BUFFER(
 ...
 */
template <typename PodType, std::size_t N>
inline BOOST_ASIO_MUTABLE_BUFFER buffer(wjl_boost::array<PodType, N>& data,
    std::size_t max_size_in_bytes) BOOST_ASIO_NOEXCEPT
{
...
template <typename PodType, std::size_t N>
inline BOOST_ASIO_CONST_BUFFER buffer(
    wjl_boost::array<const PodType, N>& data) BOOST_ASIO_NOEXCEPT
{
 ...
 */
template <typename PodType, std::size_t N>
inline BOOST_ASIO_CONST_BUFFER buffer(wjl_boost::array<const PodType, N>& data,
    std::size_t max_size_in_bytes) BOOST_ASIO_NOEXCEPT
{
...
template <typename PodType, std::size_t N>
inline BOOST_ASIO_CONST_BUFFER buffer(
    const wjl_boost::array<PodType, N>& data) BOOST_ASIO_NOEXCEPT
{
  return BOOST_ASIO_CONST_BUFFER(data.data(), data.size() * sizeof(PodType));
}
 ...
 */
template <typename PodType, std::size_t N>
inline BOOST_ASIO_CONST_BUFFER buffer(const wjl_boost::array<PodType, N>& data,
    std::size_t max_size_in_bytes) BOOST_ASIO_NOEXCEPT
{
  return BOOST_ASIO_CONST_BUFFER(data.data(),
      data.size() * sizeof(PodType) < max_size_in_bytes
...
public:
  ...
  {
    return const_buffers_type(wjl_boost::asio::buffer(string_, size_));
  }
  ...
  mutable_buffers_type prepare(std::size_t n)
  {
    if (size () > max_size() || max_size() - size() < n)
    {
      ...
      wjl_boost::asio::detail::throw_exception(ex);
    }

    string_.resize(size_ + n);

    return wjl_boost::asio::buffer(wjl_boost::asio::buffer(string_) + size_, n);
  }
...
public:
  ...
  const_buffers_type data() const BOOST_ASIO_NOEXCEPT
  {
    return const_buffers_type(wjl_boost::asio::buffer(vector_, size_));
  }
  ...
  mutable_buffers_type prepare(std::size_t n)
  {
    ...
    return wjl_boost::asio::buffer(wjl_boost::asio::buffer(vector_) + size_, n);
  }
...
/** @defgroup dynamic_buffer wjl_boost::asio::dynamic_buffer
 *
 * @brief The wjl_boost::asio::dynamic_buffer function is used to create a
...
/** @defgroup buffer_copy wjl_boost::asio::buffer_copy
 *
 * @brief The wjl_boost::asio::buffer_copy function is used to copy bytes from a
    ...
    std::size_t max_bytes_to_copy) BOOST_ASIO_NOEXCEPT
{
  return (buffer_copy_1)(*target_begin,
      wjl_boost::asio::buffer(*source_begin, max_bytes_to_copy));
}
      ...
      = (std::numeric_limits<std::size_t>::max)()) BOOST_ASIO_NOEXCEPT
{
  ...
  for (mutable_buffer target_buffer(
        wjl_boost::asio::buffer(*target_begin, max_bytes_to_copy));
    ...
    std::size_t max_bytes_to_copy) BOOST_ASIO_NOEXCEPT
{
      ...
      && target_iter != target_end && source_iter != source_end)
  {
    ...
    std::size_t bytes_copied = (buffer_copy_1)(
        target_buffer, wjl_boost::asio::buffer(source_buffer,
    ...
    const ConstBufferSequence& source) BOOST_ASIO_NOEXCEPT
{
  return detail::buffer_copy(
      ...
      wjl_boost::asio::buffer_sequence_begin(target),
      wjl_boost::asio::buffer_sequence_end(target),
      wjl_boost::asio::buffer_sequence_begin(source),
      wjl_boost::asio::buffer_sequence_end(source));
}
    ...
    std::size_t max_bytes_to_copy) BOOST_ASIO_NOEXCEPT
{
  return detail::buffer_copy(
      ...
      wjl_boost::asio::buffer_sequence_end(target),
      wjl_boost::asio::buffer_sequence_begin(source),
      wjl_boost::asio::buffer_sequence_end(source), max_bytes_to_copy);
}
