 ...
 *
 * Most applications will use the wjl_boost::asio::deadline_timer typedef.
 *
 * @par Thread Safety
 ...
 * wjl_boost::asio::deadline_timer timer(io_context);
 *
 * // Set an expiry time relative to now.
 * timer.expires_from_now(wjl_boost::posix_time::seconds(5));
 *
 ...
 * wjl_boost::asio::deadline_timer timer(io_context,
 *     wjl_boost::posix_time::time_from_string("2005-12-07 23:59:59.000"));
 *
 ...
 * @endcode
 *
 * @li The wjl_boost::asio::basic_deadline_timer::expires_from_now() function
...
template <typename Time,
    typename TimeTraits = wjl_boost::asio::time_traits<Time>
...
public:
   ...
   */
  explicit basic_deadline_timer(wjl_boost::asio::io_context& io_context)
   ...
   * as an absolute time.
   */
  basic_deadline_timer(wjl_boost::asio::io_context& io_context,
