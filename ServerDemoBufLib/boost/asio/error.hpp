...
inline const wjl_boost::system::error_category& get_system_category()
{
  return wjl_boost::system::system_category();
}

#if !defined(BOOST_ASIO_WINDOWS) && !defined(__CYGWIN__)

extern BOOST_ASIO_DECL
const wjl_boost::system::error_category& get_netdb_category();

extern BOOST_ASIO_DECL
const wjl_boost::system::error_category& get_addrinfo_category();

#else // !defined(BOOST_ASIO_WINDOWS) && !defined(__CYGWIN__)

inline const wjl_boost::system::error_category& get_netdb_category()
{
  return get_system_category();
}

inline const wjl_boost::system::error_category& get_addrinfo_category()
{
  return get_system_category();
}
...
extern BOOST_ASIO_DECL
const wjl_boost::system::error_category& get_misc_category();

static const wjl_boost::system::error_category&
...
static const wjl_boost::system::error_category&
  ...
  = wjl_boost::asio::error::get_netdb_category();
static const wjl_boost::system::error_category&
  addrinfo_category BOOST_ASIO_UNUSED_VARIABLE
  = wjl_boost::asio::error::get_addrinfo_category();
static const wjl_boost::system::error_category&
  misc_category BOOST_ASIO_UNUSED_VARIABLE
  = wjl_boost::asio::error::get_misc_category();
...
template<> struct is_error_code_enum<wjl_boost::asio::error::basic_errors>
{
  static const bool value = true;
};

template<> struct is_error_code_enum<wjl_boost::asio::error::netdb_errors>
{
  static const bool value = true;
};

template<> struct is_error_code_enum<wjl_boost::asio::error::addrinfo_errors>
{
  static const bool value = true;
};

template<> struct is_error_code_enum<wjl_boost::asio::error::misc_errors>
{
  static const bool value = true;
};
...
inline wjl_boost::system::error_code make_error_code(basic_errors e)
{
  return wjl_boost::system::error_code(
      static_cast<int>(e), get_system_category());
}

inline wjl_boost::system::error_code make_error_code(netdb_errors e)
{
  return wjl_boost::system::error_code(
      static_cast<int>(e), get_netdb_category());
}

inline wjl_boost::system::error_code make_error_code(addrinfo_errors e)
{
  return wjl_boost::system::error_code(
      static_cast<int>(e), get_addrinfo_category());
}

inline wjl_boost::system::error_code make_error_code(misc_errors e)
{
  return wjl_boost::system::error_code(
