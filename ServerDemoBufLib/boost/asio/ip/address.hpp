...
/**
 * The wjl_boost::asio::ip::address class provides the ability to use either IP
...
public:
  ...
  BOOST_ASIO_DECL address(const wjl_boost::asio::ip::address_v4& ipv4_address);

  /// Construct an address from an IPv6 address.
  BOOST_ASIO_DECL address(const wjl_boost::asio::ip::address_v6& ipv6_address);
  ...
  BOOST_ASIO_DECL address& operator=(
      const wjl_boost::asio::ip::address_v4& ipv4_address);

  /// Assign from an IPv6 address.
  BOOST_ASIO_DECL address& operator=(
      const wjl_boost::asio::ip::address_v6& ipv6_address);
  ...
  BOOST_ASIO_DECL wjl_boost::asio::ip::address_v4 to_v4() const;

  /// Get the address as an IP version 6 address.
  BOOST_ASIO_DECL wjl_boost::asio::ip::address_v6 to_v6() const;
  ...
  BOOST_ASIO_DECL std::string to_string(wjl_boost::system::error_code& ec) const;
  ...
  /// string in dotted decimal form, or from an IPv6 address in hexadecimal
  /// notation.
  static address from_string(const char* str, wjl_boost::system::error_code& ec);
...
private:
  ...
  wjl_boost::asio::ip::address_v4 ipv4_address_;

  // The underlying IPv6 address.
  wjl_boost::asio::ip::address_v6 ipv6_address_;
};
 ...
 */
BOOST_ASIO_DECL address make_address(
    string_view str, wjl_boost::system::error_code& ec);
 ...
 *
 * @relates wjl_boost::asio::ip::address
 */
