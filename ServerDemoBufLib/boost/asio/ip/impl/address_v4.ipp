...
address_v4::address_v4(address_v4::uint_type addr)
{
  ...
  addr_.s_addr = wjl_boost::asio::detail::socket_ops::host_to_network_long(
      static_cast<wjl_boost::asio::detail::u_long_type>(addr));
}
...
{
  return wjl_boost::asio::detail::socket_ops::network_to_host_long(addr_.s_addr);
}
...
std::string address_v4::to_string() const
{
  ...
  char addr_str[wjl_boost::asio::detail::max_addr_v4_str_len];
  const char* addr =
    wjl_boost::asio::detail::socket_ops::inet_ntop(
        BOOST_ASIO_OS_DEF(AF_INET), &addr_, addr_str,
        wjl_boost::asio::detail::max_addr_v4_str_len, 0, ec);
  if (addr == 0)
...
#if !defined(BOOST_ASIO_NO_DEPRECATED)
std::string address_v4::to_string(wjl_boost::system::error_code& ec) const
{
  char addr_str[wjl_boost::asio::detail::max_addr_v4_str_len];
  const char* addr =
    wjl_boost::asio::detail::socket_ops::inet_ntop(
    ...
    const char* str, wjl_boost::system::error_code& ec)
{
  ...
  if (wjl_boost::asio::detail::socket_ops::inet_pton(
