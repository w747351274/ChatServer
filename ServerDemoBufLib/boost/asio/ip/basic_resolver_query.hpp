...
/**
 * The wjl_boost::asio::ip::basic_resolver_query class template describes a query
...
public:
  ...
  const wjl_boost::asio::detail::addrinfo_type& hints() const
  {
    return hints_;
  }
...
private:
  wjl_boost::asio::detail::addrinfo_type hints_;
