...
/**
 * The wjl_boost::asio::ip::address_v6 class provides the ability to use and
...
#else
  typedef wjl_boost::asio::detail::array<unsigned char, 16> bytes_type;
#endif
...
private:
  ...
  wjl_boost::asio::detail::in6_addr_type addr_;
 ...
 *
 * @relates wjl_boost::asio::ip::address_v6
 */
