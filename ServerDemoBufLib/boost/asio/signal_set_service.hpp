...
#else
  : public wjl_boost::asio::detail::service_base<signal_set_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit signal_set_service(wjl_boost::asio::io_context& io_context)
    : wjl_boost::asio::detail::service_base<signal_set_service>(io_context),
