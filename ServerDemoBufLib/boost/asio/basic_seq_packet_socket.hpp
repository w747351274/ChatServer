...
public:
   ...
   * the socket.
   */
  explicit basic_seq_packet_socket(wjl_boost::asio::io_context& io_context)
   ...
   */
  basic_seq_packet_socket(wjl_boost::asio::io_context& io_context,
   ...
   * follows:
   * @code
   * socket.receive(wjl_boost::asio::buffer(data, size), out_flags);
   * @endcode
   ...
   * follows:
   * @code
   * socket.receive(wjl_boost::asio::buffer(data, size), 0, out_flags);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, wjl_boost::array or
   * std::vector.
   ...
   * follows:
   * @code
   * socket.async_receive(wjl_boost::asio::buffer(data, size), out_flags, handler);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, wjl_boost::array or
   * std::vector.
