...
/**
 * @defgroup connect wjl_boost::asio::connect
 *
 ...
 *
 * @throws wjl_boost::system::system_error Thrown on failure. If the sequence is
 * empty, the associated @c error_code is wjl_boost::asio::error::not_found.
 ...
 * wjl_boost::asio::connect(s, r.resolve(q)); @endcode
 */
 ...
 * empty, set to wjl_boost::asio::error::not_found. Otherwise, contains the error
 ...
 * wjl_boost::asio::connect(s, r.resolve(q), ec);
 * if (ec)
 * {
 *   // An error occurred.
 * } @endcode
 ...
 * iterator types such as @c wjl_boost::asio::ip::tcp::resolver::iterator.
 */
 ...
 * tcp::socket s(io_context);
 * wjl_boost::asio::connect(s, e.begin(), e.end()); @endcode
 */
template <typename Protocol BOOST_ASIO_SVC_TPARAM, typename Iterator>
Iterator connect(basic_socket<Protocol BOOST_ASIO_SVC_TARG>& s,
 ...
 * tcp::socket s(io_context);
 * wjl_boost::system::error_code ec;
 * wjl_boost::asio::connect(s, e.begin(), e.end(), ec);
 * if (ec)
 * {
 *   // An error occurred.
 * } @endcode
 ...
 *     const wjl_boost::system::error_code& ec,
 ...
 *   }
 * }; @endcode
 * It would be used with the wjl_boost::asio::connect function as follows:
 * @code tcp::resolver r(io_context);
 * tcp::resolver::query q("host", "service");
 * tcp::socket s(io_context);
 * tcp::endpoint e = wjl_boost::asio::connect(s,
...
template <typename Protocol BOOST_ASIO_SVC_TPARAM,
    typename Iterator, typename ConnectCondition>
Iterator connect(basic_socket<Protocol BOOST_ASIO_SVC_TARG>& s, Iterator begin,
    ConnectCondition connect_condition, wjl_boost::system::error_code& ec,
    typename enable_if<!is_endpoint_sequence<Iterator>::value>::type* = 0);
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)
 ...
 * tcp::resolver::results_type e = r.resolve(q);
 * tcp::socket s(io_context);
 * tcp::resolver::results_type::iterator i = wjl_boost::asio::connect(
...
/**
 * @defgroup async_connect wjl_boost::asio::async_connect
 *
 ...
 *   // wjl_boost::asio::error::not_found. Otherwise, contains the
 ...
 *   if (!ec)
 *   {
 *     wjl_boost::asio::async_connect(s, results, connect_handler);
 *   }
 * }
 *
 * // ...
 ...
 * tcp::socket s(io_context);
 * wjl_boost::asio::async_connect(s,
 ...
 *   if (!ec)
 *   {
 *     wjl_boost::asio::async_connect(s, results,
 ...
 *     wjl_boost::asio::async_connect(s, i, end,
 *         my_connect_condition(),
 *         connect_handler);
 *   }
 * }
