...
#define BOOST_ASIO_SVC_T wjl_boost::asio::detail::reactive_descriptor_service
...
public:
   ...
   * descriptor.
   */
  explicit descriptor(wjl_boost::asio::io_context& io_context)
   ...
   */
  descriptor(wjl_boost::asio::io_context& io_context,
   ...
   * wjl_boost::asio::error::operation_aborted error.
   *
   ...
   * passed the wjl_boost::asio::error::operation_aborted error.
   *
   * @throws wjl_boost::system::system_error Thrown on failure.
   */
  void cancel()
   ...
   * wjl_boost::asio::posix::descriptor_base::bytes_readable @n
   * wjl_boost::asio::posix::descriptor_base::non_blocking_io
   *
   * @par Example
   * Getting the number of bytes ready to read:
   * @code
   * wjl_boost::asio::posix::stream_descriptor descriptor(io_context);
   * ...
   * wjl_boost::asio::posix::stream_descriptor::bytes_readable command;
   ...
   * wjl_boost::asio::posix::stream_descriptor descriptor(io_context);
   * ...
   * descriptor.wait(wjl_boost::asio::posix::stream_descriptor::wait_read);
   * @endcode
   */
   ...
   * ...
   * wjl_boost::system::error_code ec;
   * descriptor.wait(wjl_boost::asio::posix::stream_descriptor::wait_read, ec);
   * @endcode
   */
   ...
   *     wjl_boost::asio::posix::stream_descriptor::wait_read,
   *     wait_handler);
   * @endcode
   */
