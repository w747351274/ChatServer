...
public:
   ...
   */
  explicit serial_port(wjl_boost::asio::io_context& io_context)
   ...
   */
  serial_port(wjl_boost::asio::io_context& io_context,
  ...
  void send_break()
  {
    ...
    wjl_boost::asio::detail::throw_error(ec, "send_break");
  }
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  BOOST_ASIO_SYNC_OP_VOID send_break(wjl_boost::system::error_code& ec)
  {
    this->get_service().send_break(this->get_implementation(), ec);
    BOOST_ASIO_SYNC_OP_VOID_RETURN(ec);
  }
   ...
   * wjl_boost::asio::serial_port_base::baud_rate @n
   * wjl_boost::asio::serial_port_base::flow_control @n
   * wjl_boost::asio::serial_port_base::parity @n
   * wjl_boost::asio::serial_port_base::stop_bits @n
   * wjl_boost::asio::serial_port_base::character_size
   */
   ...
   * @code
   * serial_port.write_some(wjl_boost::asio::buffer(data, size));
   * @endcode
   ...
   * To write a single data buffer use the @ref buffer function as follows:
   * @code
   * serial_port.async_write_some(wjl_boost::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on writing multiple
   * buffers in one go, and how to use it with arrays, wjl_boost::array or
   * std::vector.
   ...
   * @code
   * serial_port.read_some(wjl_boost::asio::buffer(data, size));
   * @endcode
   ...
   * To read into a single data buffer use the @ref buffer function as follows:
   * @code
   * serial_port.async_read_some(wjl_boost::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on reading into multiple
   * buffers in one go, and how to use it with arrays, wjl_boost::array or
   * std::vector.
