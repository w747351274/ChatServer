...
#else
  : public wjl_boost::asio::detail::service_base<serial_port_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit serial_port_service(wjl_boost::asio::io_context& io_context)
    : wjl_boost::asio::detail::service_base<serial_port_service>(io_context),
