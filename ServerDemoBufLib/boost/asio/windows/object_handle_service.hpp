...
#else
  : public wjl_boost::asio::detail::service_base<object_handle_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit object_handle_service(wjl_boost::asio::io_context& io_context)
    : wjl_boost::asio::detail::service_base<object_handle_service>(io_context),
