...
#define BOOST_ASIO_SVC_T wjl_boost::asio::detail::win_object_handle_service
...
public:
   ...
   */
  explicit object_handle(wjl_boost::asio::io_context& io_context)
   ...
   */
  object_handle(wjl_boost::asio::io_context& io_context,
  ...
  {
    wjl_boost::asio::async_completion<WaitHandler,
