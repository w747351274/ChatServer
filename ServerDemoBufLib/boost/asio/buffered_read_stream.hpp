...
public:
  ...
  std::size_t fill(wjl_boost::system::error_code& ec);
  ...
  /// Determine the amount of data that may be read without blocking.
  std::size_t in_avail(wjl_boost::system::error_code& ec)
  {
...
private:
  ...
  {
    std::size_t bytes_copied = wjl_boost::asio::buffer_copy(
  ...
  {
    return wjl_boost::asio::buffer_copy(buffers, storage_.data(), storage_.size());
  }
