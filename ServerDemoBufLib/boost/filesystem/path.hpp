...
# endif
    ...
    path(Source const& source,
      typename wjl_boost::enable_if<path_traits::is_pathable<
        typename wjl_boost::decay<Source>::type> >::type* =0)
    {
...
# endif
    ...
    template <class Source>
      typename wjl_boost::enable_if<path_traits::is_pathable<
        typename wjl_boost::decay<Source>::type>, path&>::type
    ...
    template <class CharT>
      typename wjl_boost::enable_if<is_integral<CharT>, path&>::type
    operator+=(CharT c)
    {
      CharT tmp[2];
      tmp[0] = c;
...
# endif
  ...
  private:
    ...
    friend class wjl_boost::filesystem::path;
    friend class wjl_boost::filesystem::path::reverse_iterator;
...
# endif
  ...
  //    use wjl_boost::io::quoted() to handle spaces in paths
  ...
  {
    return os
      << wjl_boost::io::quoted(p.template string<std::basic_string<Char> >(), static_cast<Char>('&'));
  }
  ...
  operator>>(std::basic_istream<Char, Traits>& is, path& p)
  {
    ...
    is >> wjl_boost::io::quoted(str, static_cast<Char>('&'));
    p = str;
    return is;
  }
