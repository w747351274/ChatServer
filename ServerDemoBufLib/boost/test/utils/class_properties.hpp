...
public:
    ...
    // access methods
    arrow_res_t     operator->() const      { return wjl_boost::addressof( base_prop::value ); }
};
...
#define BOOST_READONLY_PROPERTY( property_type, friends ) wjl_boost::unit_test::readwrite_property<property_type >
...
: public wjl_boost::unit_test::readonly_property<property_type > {                      \
    typedef wjl_boost::unit_test::readonly_property<property_type > base_prop;          \
...
public:
    ...
    arrow_res_t     operator->()            { return wjl_boost::addressof( base_prop::value ); }
    const_arrow_res_t operator->() const    { return wjl_boost::addressof( base_prop::value ); }
