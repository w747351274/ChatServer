...
public:
    ...
    /// @returns
    ///   - @c wjl_boost::exit_success on success,
    ///   - @c wjl_boost::exit_exception_failure in case test unit
    ///     was aborted for any reason (incuding uncaught exception)
    ///   - and @c wjl_boost::exit_test_failure otherwise
...
/// of the test tree.
///
/// @see wjl_boost::unit_test::test_observer
