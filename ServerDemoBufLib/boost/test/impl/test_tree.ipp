...
test_case::test_case( const_string name, wjl_boost::function<void ()> const& test_func )
...
test_case::test_case( const_string name, const_string file_name, std::size_t line_num, wjl_boost::function<void ()> const& test_func )
...
void
test_suite::add( wjl_boost::shared_ptr<test_unit_generator> gen_ptr, decorator::collector& decorators )
{
    std::pair<wjl_boost::shared_ptr<test_unit_generator>, std::vector<decorator::base_ptr> > tmp_p(gen_ptr, decorators.get_lazy_decorators() );
...
test_suite::generate( )
{
    typedef std::pair<wjl_boost::shared_ptr<test_unit_generator>, std::vector<decorator::base_ptr> > element_t;
...
auto_test_unit_registrar::auto_test_unit_registrar( wjl_boost::shared_ptr<test_unit_generator> tc_gen, decorator::collector& decorators )
{
    framework::current_auto_test_suite().add( tc_gen, decorators );
}
