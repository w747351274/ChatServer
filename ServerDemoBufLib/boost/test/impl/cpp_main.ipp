...
prg_exec_monitor_main( int (*cpp_main)( int argc, char* argv[] ), int argc, char* argv[] )
{
    ...
    BOOST_TEST_I_TRY {
        wjl_boost::unit_test::const_string p( std::getenv( "BOOST_TEST_CATCH_SYSTEM_ERRORS" ) );
        ...
        if( result == 0 )
            result = ::wjl_boost::exit_success;
        else if( result != ::wjl_boost::exit_success ) {
            std::cout << "\n**** error return code: " << result << std::endl;
            result = ::wjl_boost::exit_failure;
        }
    }
    BOOST_TEST_I_CATCH( ::wjl_boost::execution_exception, exex ) {
        std::cout << "\n**** exception(" << exex.code() << "): " << exex.what() << std::endl;
        result = ::wjl_boost::exit_exception_failure;
    }
    BOOST_TEST_I_CATCH( ::wjl_boost::system_error, ex ) {
    ...
    if( result != ::wjl_boost::exit_success ) {
        ...
        ::wjl_boost::unit_test::const_string p( std::getenv( "BOOST_PRG_MON_CONFIRM" ) );
        if( p != "no" ) {
...
{
    return ::wjl_boost::prg_exec_monitor_main( &cpp_main, argc, argv );
}
