...
#  define BOOST_LIB_NAME wjl_boost_unit_test_framework
...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost { namespace unit_test {
...
{
    return ::wjl_boost::unit_test::unit_test_main( &init_unit_test, argc, argv );
}
