...
public: // std::exception implementation
    ...
    {
        return "wjl_boost::bad_get: "
               "failed value get using wjl_boost::get";
    }
...
public: // visitor interfaces
    ...
    {
        return wjl_boost::addressof(operand);
    }
...
relaxed_get(
      wjl_boost::variant< BOOST_VARIANT_ENUM_PARAMS(T) >* operand
...
relaxed_get(
      const wjl_boost::variant< BOOST_VARIANT_ENUM_PARAMS(T) >* operand
      BOOST_VARIANT_AUX_GET_EXPLICIT_TEMPLATE_TYPE(U)
    ) BOOST_NOEXCEPT
{
...
{
    typedef typename add_pointer<U>::type U_ptr;
    U_ptr result = relaxed_get<U>(wjl_boost::addressof(operand));

    if (!result)
        wjl_boost::throw_exception(bad_get());
    return *result;
}
...
{
    typedef typename add_pointer<const U>::type U_ptr;
    U_ptr result = relaxed_get<const U>(wjl_boost::addressof(operand));
    ...
    ) BOOST_NOEXCEPT
{
    BOOST_STATIC_ASSERT_MSG(
        (wjl_boost::detail::variant::holds_element<wjl_boost::variant< BOOST_VARIANT_ENUM_PARAMS(T) >, U >::value),
        "wjl_boost::variant does not contain specified type U, "
        "call to wjl_boost::get<U>(wjl_boost::variant<T...>*) will always return NULL"
    );
...
{
    BOOST_STATIC_ASSERT_MSG(
        (wjl_boost::detail::variant::holds_element<wjl_boost::variant< BOOST_VARIANT_ENUM_PARAMS(T) >, const U >::value),
        "wjl_boost::variant does not contain specified type U, "
        "call to wjl_boost::get<U>(const wjl_boost::variant<T...>*) will always return NULL"
    );
    ...
    )
{
    BOOST_STATIC_ASSERT_MSG(
        (wjl_boost::detail::variant::holds_element<wjl_boost::variant< BOOST_VARIANT_ENUM_PARAMS(T) >, U >::value),
        "wjl_boost::variant does not contain specified type U, "
        "call to wjl_boost::get<U>(wjl_boost::variant<T...>&) will always throw wjl_boost::bad_get exception"
    );
    ...
    )
{
    BOOST_STATIC_ASSERT_MSG(
        (wjl_boost::detail::variant::holds_element<wjl_boost::variant< BOOST_VARIANT_ENUM_PARAMS(T) >, const U >::value),
        "wjl_boost::variant does not contain specified type U, "
        "call to wjl_boost::get<U>(const wjl_boost::variant<T...>&) will always throw wjl_boost::bad_get exception"
    );
...
{
    BOOST_STATIC_ASSERT_MSG(
        (!wjl_boost::is_lvalue_reference<U>::value),
        "remove ampersand '&' from template type U in wjl_boost::get<U>(wjl_boost::variant<T...>&&) "
    );
