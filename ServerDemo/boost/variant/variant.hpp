...
struct add_alignment
{
    ...
    struct apply
        : mpl::size_t<
              ::wjl_boost::integer::static_lcm<
                  BOOST_MPL_AUX_VALUE_WKND(State)::value
                , ::wjl_boost::alignment_of<Item>::value
                >::value
            >
    {};
};
...
//
// This implementation is designed to prefer wjl_boost::blank over other potential
...
private: // helpers, for metafunction result (below)
    ...
    // [...now search the rest of the sequence for wjl_boost::blank...]

    typedef typename mpl::iter_fold_if<
          mpl::iterator_range< first_result_it,end_it >
        , first_result_index, mpl::protect< mpl::next<> >
        , mpl::protect< mpl::not_same_as<wjl_boost::blank> >
        >::type second_result_;
...
struct is_variant_move_noexcept_constructible {
    typedef typename wjl_boost::mpl::find_if<
        Types, mpl::not_<wjl_boost::is_nothrow_move_constructible<wjl_boost::mpl::_1> >
    >::type iterator_t;

    typedef typename wjl_boost::mpl::end<Types>::type end_t;
    typedef typename wjl_boost::is_same<
        iterator_t, end_t
    >::type type;
};
...
struct is_variant_move_noexcept_assignable {
    typedef typename wjl_boost::mpl::find_if<
        Types, mpl::not_<wjl_boost::is_nothrow_move_assignable<wjl_boost::mpl::_1> >
    >::type iterator_t;
...
struct is_constructible_ext:
    wjl_boost::mpl::or_<
        wjl_boost::is_constructible<
            T1,
            T2
        >,
        wjl_boost::is_constructible<
            T1,
            typename wjl_boost::add_lvalue_reference<T2>::type
        >
    >
{};
...
struct is_variant_constructible_from:
    wjl_boost::mpl::not_< wjl_boost::is_same<
        typename wjl_boost::mpl::find_if<
            Types,
            is_constructible_ext<wjl_boost::mpl::_1, T>
        >::type,
        typename wjl_boost::mpl::end<Types>::type
    > >
{};

template <BOOST_VARIANT_ENUM_PARAMS(typename T), class Types>
struct is_variant_constructible_from< wjl_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Types >:
    wjl_boost::is_same<
        typename wjl_boost::mpl::find_if<
            typename wjl_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>::recursive_enabled_types,
            mpl::not_< is_variant_constructible_from< wjl_boost::mpl::_1, Types> >
        >::type,
        typename wjl_boost::mpl::end< typename wjl_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>::recursive_enabled_types >::type
    >
{};

template <BOOST_VARIANT_ENUM_PARAMS(typename T), class Types>
struct is_variant_constructible_from< const wjl_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>& , Types >:
    is_variant_constructible_from<wjl_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Types >
{};
...
template <BOOST_VARIANT_ENUM_PARAMS(typename T), class Types>
struct is_variant_constructible_from< wjl_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)> const && , Types >:
    is_variant_constructible_from<wjl_boost::variant<BOOST_VARIANT_ENUM_PARAMS(T)>, Types >
{};
...
public: // metafunction result
    ...
    typedef ::wjl_boost::aligned_storage<
...
public: // visitor interface
    ...
    T& operator()(U&) const
    {
        ...
        return ::wjl_boost::detail::variant::forced_return< T& >();
    }
};
...
public: // internal visitor interface
    ...
    template <typename T>
        BOOST_VARIANT_AUX_RETURN_VOID_TYPE
    internal_visit(wjl_boost::detail::variant::backup_holder<T>& operand, long) const
    {
    ...
    template <typename T>
        BOOST_VARIANT_AUX_RETURN_VOID_TYPE
    internal_visit(const wjl_boost::detail::variant::backup_holder<T>& operand, long) const
    {
        new(storage_) T( operand.get() );
        BOOST_VARIANT_AUX_RETURN_VOID;
    }
...
public: // internal visitor interface
    ...
    internal_visit(wjl_boost::detail::variant::backup_holder<T>& operand, long) const
    {
        new(storage_) T( ::wjl_boost::detail::variant::move(operand.get()) );
        BOOST_VARIANT_AUX_RETURN_VOID;
    }

    template <typename T>
        BOOST_VARIANT_AUX_RETURN_VOID_TYPE
    internal_visit(T& operand, int) const BOOST_NOEXCEPT_IF(BOOST_NOEXCEPT_EXPR(T(wjl_boost::declval<T>())))
    {
        new(storage_) T(::wjl_boost::detail::variant::move(operand));
        BOOST_VARIANT_AUX_RETURN_VOID;
    }
};
#endif
...
public: // internal visitor interfaces
    ...
    {
        lhs_content.get()
            = ::wjl_boost::detail::variant::move(static_cast<backup_holder<T>* >(rhs_storage_)->get());
        BOOST_VARIANT_AUX_RETURN_VOID;
    }
    ...
    internal_visit(T& lhs_content, int) const
    {
        ...
        // Hint: Are any of the bounded types const-qualified or references?
        //
        lhs_content = ::wjl_boost::detail::variant::move(*static_cast<T* >(rhs_storage_));
        BOOST_VARIANT_AUX_RETURN_VOID;
    }
...
public: // visitor interface
    ...
    bool operator()(T& lhs)
    {
        lhs = ::wjl_boost::detail::variant::move(rhs_);
        return true;
    }
...
private: // helpers, for visitor interface (below)
        ...
        )
    {
        ...
        LhsT backup_lhs_content(
              ::wjl_boost::detail::variant::move(lhs_content)
            ); // nothrow
        ...
        BOOST_CATCH (...)
        {
            ...
            new(lhs_.storage_.address())
                LhsT(
                      ::wjl_boost::detail::variant::move(backup_lhs_content)
                    ); // nothrow
...
public: // internal visitor interfaces
    ...
    void operator()(T& operand) const
    {
        ...
        // ...and swap:
        ::wjl_boost::detail::variant::move_swap( operand, other );
    }
...
class reflect
    : public static_visitor<const wjl_boost::typeindex::type_info&>
{
public: // visitor interfaces

    template <typename T>
    const wjl_boost::typeindex::type_info& operator()(const T&) const BOOST_NOEXCEPT
    {
        return wjl_boost::typeindex::type_id<T>().type_info();
    }
...
public: // internal visitor interfaces
    ...
    {
        return visitor_(::wjl_boost::move<T>(operand));
    }
...
private: // helpers, for internal visitor interfaces (below)
    ...
    {
        return visitor_(::wjl_boost::move(operand));
    }
    ...
    {
        visitor_(::wjl_boost::move(operand));
        BOOST_VARIANT_AUX_RETURN_VOID;
    }
...
public: // internal visitor interfaces, cont.
    ...
    template <typename T>
        BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
    internal_visit(wjl_boost::recursive_wrapper<T>& operand, long)
    {
    ...
    template <typename T>
        BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
    internal_visit(const wjl_boost::recursive_wrapper<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }
    ...
    template <typename T>
        BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
    internal_visit(wjl_boost::detail::reference_content<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }
    ...
    template <typename T>
        BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
    internal_visit(const wjl_boost::detail::reference_content<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }
    ...
    template <typename T>
        BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
    internal_visit(wjl_boost::detail::variant::backup_holder<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }
    ...
    template <typename T>
        BOOST_VARIANT_AUX_GENERIC_RESULT_TYPE(result_type)
    internal_visit(const wjl_boost::detail::variant::backup_holder<T>& operand, long)
    {
        return internal_visit( operand.get(), 1L );
    }
...
private: // helpers, for typedefs (below)
    ...
    BOOST_STATIC_ASSERT((
          ::wjl_boost::mpl::not_< mpl::empty<specified_types> >::value
        ));
...
public: // structors
    ...
    variant() 
              ...
              BOOST_NOEXCEPT_IF(wjl_boost::has_nothrow_constructor<internal_T0>::value)
#endif
    {
#ifdef _MSC_VER
#pragma warning( push )
...
#   endif
        ...
        template <typename T>
        int internal_visit(wjl_boost::detail::reference_content<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(const wjl_boost::detail::reference_content<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(wjl_boost::detail::variant::backup_holder<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(const wjl_boost::detail::variant::backup_holder<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(wjl_boost::recursive_wrapper<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }

        template <typename T>
        int internal_visit(const wjl_boost::recursive_wrapper<T>& operand, long) const
        {
            return internal_visit( operand.get(), 1L );
        }
...
private: // helpers, for structors, below 
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    template <typename T>
    typename wjl_boost::enable_if<wjl_boost::is_rvalue_reference<T&&> >::type convert_construct(
          T&& operand
        , int
        , mpl::false_ = mpl::false_() // is_foreign_variant
        )
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    template <typename Variant>
    typename wjl_boost::enable_if<wjl_boost::is_rvalue_reference<Variant&&> >::type convert_construct(
          Variant&& operand
        , long
        , mpl::true_// is_foreign_variant
        )
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    template <typename Variant>
    typename wjl_boost::enable_if<wjl_boost::is_rvalue_reference<Variant&&> >::type convert_construct_variant(Variant&& operand)
    {
        // [Determine if the given variant is itself a bounded type, or if its
        //  content needs to be converted (i.e., it is a 'foreign' variant):]
        //
    ...
    typename wjl_boost::enable_if<mpl::or_<
        wjl_boost::is_same<wjl_boost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>, variant>,
        wjl_boost::detail::variant::is_variant_constructible_from<wjl_boost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>&, internal_types>
    > >::type convert_construct(
          wjl_boost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>& operand
        , long
        )
    {
    ...
    typename wjl_boost::enable_if<mpl::or_<
        wjl_boost::is_same<wjl_boost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>, variant>,
        wjl_boost::detail::variant::is_variant_constructible_from<const wjl_boost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>&, internal_types>
    > >::type convert_construct(
          const wjl_boost::variant<BOOST_VARIANT_ENUM_PARAMS(U)>& operand
        , long
        )
    {
        convert_construct_variant(operand);    
...
public: // structors, cont.
    ...
    variant(const T& operand,
        typename wjl_boost::enable_if<mpl::or_<
            mpl::and_<
                mpl::not_< wjl_boost::is_same<T, variant> >,
                wjl_boost::detail::variant::is_variant_constructible_from<const T&, internal_types>
            >, 
            wjl_boost::is_same<T, wjl_boost::recursive_variant_> > >::type* = 0)
    {
    ...
    variant(
        ...
        , typename wjl_boost::enable_if<mpl::or_<
            mpl::and_<
                mpl::not_< is_const<T> >,
                mpl::not_< wjl_boost::is_same<T, variant> >,
                wjl_boost::detail::variant::is_variant_constructible_from<T&, internal_types>
            >,
            wjl_boost::is_same<T, wjl_boost::recursive_variant_> > >::type* = 0
        )
    {
    ...
    variant(T&& operand,
        typename wjl_boost::enable_if<mpl::or_<
            mpl::and_<
                wjl_boost::is_rvalue_reference<T&&>,
                mpl::not_< wjl_boost::is_const<T> >,
                mpl::not_< wjl_boost::is_same<T, variant> >,
                wjl_boost::detail::variant::is_variant_constructible_from<T&&, internal_types>
            >,
            wjl_boost::is_same<T, wjl_boost::recursive_variant_> > >::type* = 0)
...
public: // queries
    ...
    const wjl_boost::typeindex::type_info& type() const
    {
...
private: // precondition assertions
    ...
    BOOST_STATIC_ASSERT(( ::wjl_boost::mpl::is_sequence<Types>::value ));
    typedef typename wjl_boost::mpl::insert_range<
      wjl_boost::mpl::list<>
    , wjl_boost::mpl::end< wjl_boost::mpl::list<> >::type
    , Types
