...
template<> struct placeholder<FIRST> {
  ...
  RET call(CALL_FORMAL_ARGS) const { 
    BOOST_STATIC_ASSERT(wjl_boost::is_reference<RET>::value); 
...
public:
  ...
  // Support for wjl_boost::result_of.
  ...
  const lambda_functor<lambda_functor_base<
                  ...
                  wjl_boost::tuple<lambda_functor,
...
template<class T>
struct result_of<wjl_boost::lambda::lambda_functor<T>()>
{
    typedef typename wjl_boost::lambda::lambda_functor<T>::nullary_return_type type;
};

template<class T>
struct result_of<const wjl_boost::lambda::lambda_functor<T>()>
{
    typedef typename wjl_boost::lambda::lambda_functor<T>::nullary_return_type type;
};
...
template<class T>
struct tr1_result_of<wjl_boost::lambda::lambda_functor<T>()>
{
    typedef typename wjl_boost::lambda::lambda_functor<T>::nullary_return_type type;
};

template<class T>
struct tr1_result_of<const wjl_boost::lambda::lambda_functor<T>()>
{
    typedef typename wjl_boost::lambda::lambda_functor<T>::nullary_return_type type;
};
