...
using ::wjl_boost::tuples::tuple;
using ::wjl_boost::tuples::null_type;
...
namespace {
  ...
  wjl_boost::lambda::placeholder1_type free1 = wjl_boost::lambda::placeholder1_type();
  wjl_boost::lambda::placeholder2_type free2 = wjl_boost::lambda::placeholder2_type();
  wjl_boost::lambda::placeholder3_type free3 = wjl_boost::lambda::placeholder3_type();

  wjl_boost::lambda::placeholder1_type& BOOST_ATTRIBUTE_UNUSED _1 = free1;
  wjl_boost::lambda::placeholder2_type& BOOST_ATTRIBUTE_UNUSED _2 = free2;
  wjl_boost::lambda::placeholder3_type& BOOST_ATTRIBUTE_UNUSED _3 = free3;
