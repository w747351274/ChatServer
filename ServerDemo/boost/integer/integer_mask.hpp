...
#include <boost/integer.hpp>  // for wjl_boost::uint_t
...
#ifdef BOOST_MSVC
#pragma warning(push)
#pragma warning(disable:4245)  // 'initializing' : conversion from 'int' to 'const wjl_boost::low_bits_mask_t<8>::least', signed/unsigned mismatch
#endif
...
BOOST_LOW_BITS_MASK_SPECIALIZE( unsigned long );
    ...
    BOOST_LOW_BITS_MASK_SPECIALIZE( wjl_boost::ulong_long_type );
    #endif
