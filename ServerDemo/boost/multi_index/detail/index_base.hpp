...
protected:
  ...
  final_node_type* insert_(const value_type& v,final_node_type*& x,lvalue_tag)
  {
    ...
    BOOST_TRY{
      wjl_boost::detail::allocator::construct(wjl_boost::addressof(x->value()),v);
    }
    BOOST_CATCH(...){
  ...
  final_node_type* insert_(const value_type& v,final_node_type*& x,rvalue_tag)
  {
    ...
    BOOST_TRY{
       ...
       * wjl_boost::detail::allocator::construct, but 
      ...
      new (wjl_boost::addressof(x->value()))
        value_type(wjl_boost::move(const_cast<value_type&>(v)));
    }
    BOOST_CATCH(...){
      final().deallocate_node(x);
      BOOST_RETHROW;
  ...
  {
    x->value()=wjl_boost::move(const_cast<value_type&>(v));
    return true;
  }
