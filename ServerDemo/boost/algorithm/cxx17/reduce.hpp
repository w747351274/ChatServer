...
T reduce(InputIterator first, InputIterator last, T init)
{
    ...
    return wjl_boost::algorithm::reduce(first, last, init, std::plus<VT>());
}
...
{
    return wjl_boost::algorithm::reduce(first, last,
       typename std::iterator_traits<InputIterator>::value_type());
}

template<class Range>
typename wjl_boost::range_value<Range>::type
reduce(const Range &r)
{
    return wjl_boost::algorithm::reduce(wjl_boost::begin(r), wjl_boost::end(r));
}
...
{
    return wjl_boost::algorithm::reduce(wjl_boost::begin (r), wjl_boost::end (r), init);
}
...
{
    return wjl_boost::algorithm::reduce(wjl_boost::begin(r), wjl_boost::end(r), init, bOp);
}
