...
{
    return wjl_boost::algorithm::copy_if (wjl_boost::begin (r), wjl_boost::end(r), result, p);
}
...
///
template<typename Range, typename OutputIterator, typename Predicate>
BOOST_CXX14_CONSTEXPR std::pair<typename wjl_boost::range_iterator<const Range>::type, OutputIterator> 
copy_while ( const Range &r, OutputIterator result, Predicate p )
{
    return wjl_boost::algorithm::copy_while (wjl_boost::begin (r), wjl_boost::end(r), result, p);
}
...
{
    return wjl_boost::algorithm::copy_until (wjl_boost::begin (r), wjl_boost::end(r), result, p);
}
