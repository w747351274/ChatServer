...
///
    ...
    BOOST_CXX14_CONSTEXPR ForwardIterator is_sorted_until ( ForwardIterator first, ForwardIterator last )
    {
        ...
        return wjl_boost::algorithm::is_sorted_until ( first, last, std::less<value_type>());
    }
...
///
    ...
    {
        return wjl_boost::algorithm::is_sorted_until (first, last, p) == last;
    }
...
///
    ...
    {
        return wjl_boost::algorithm::is_sorted_until (first, last) == last;
    }
...
///
    ...
    BOOST_CXX14_CONSTEXPR typename wjl_boost::lazy_disable_if_c<
        wjl_boost::is_same<R, Pred>::value, 
        typename wjl_boost::range_iterator<const R> 
    >::type is_sorted_until ( const R &range, Pred p )
    {
        return wjl_boost::algorithm::is_sorted_until ( wjl_boost::begin ( range ), wjl_boost::end ( range ), p );
    }
...
///
    template <typename R>
    BOOST_CXX14_CONSTEXPR typename wjl_boost::range_iterator<const R>::type is_sorted_until ( const R &range )
    {
        return wjl_boost::algorithm::is_sorted_until ( wjl_boost::begin ( range ), wjl_boost::end ( range ));
    }
...
///
    template <typename R, typename Pred>
    BOOST_CXX14_CONSTEXPR typename wjl_boost::lazy_disable_if_c< wjl_boost::is_same<R, Pred>::value, wjl_boost::mpl::identity<bool> >::type
    is_sorted ( const R &range, Pred p )
    {
        return wjl_boost::algorithm::is_sorted ( wjl_boost::begin ( range ), wjl_boost::end ( range ), p );
    }
...
///
    ...
    {
        return wjl_boost::algorithm::is_sorted ( wjl_boost::begin ( range ), wjl_boost::end ( range ));
    }
...
///     equal. If that is not what you intended, you should use is_strictly_increasing instead.
    ...
    {
        typedef typename std::iterator_traits<ForwardIterator>::value_type value_type;
        return wjl_boost::algorithm::is_sorted (first, last, std::less<value_type>());
    }
...
///     equal. If that is not what you intended, you should use is_strictly_increasing instead.
    ...
    {
        return is_increasing ( wjl_boost::begin ( range ), wjl_boost::end ( range ));
    }
...
///     equal. If that is not what you intended, you should use is_strictly_decreasing instead.
    ...
    {
        typedef typename std::iterator_traits<ForwardIterator>::value_type value_type;
        return wjl_boost::algorithm::is_sorted (first, last, std::greater<value_type>());
    }
...
///     equal. If that is not what you intended, you should use is_strictly_decreasing instead.
    ...
    {
        return is_decreasing ( wjl_boost::begin ( range ), wjl_boost::end ( range ));
    }
...
///     equal. If that is not what you intended, you should use is_increasing instead.
    ...
    {
        typedef typename std::iterator_traits<ForwardIterator>::value_type value_type;
        return wjl_boost::algorithm::is_sorted (first, last, std::less_equal<value_type>());
    }
...
///     equal. If that is not what you intended, you should use is_increasing instead.
    ...
    {
        return is_strictly_increasing ( wjl_boost::begin ( range ), wjl_boost::end ( range ));
    }
...
///     equal. If that is not what you intended, you should use is_decreasing instead.
    ...
    {
        typedef typename std::iterator_traits<ForwardIterator>::value_type value_type;
        return wjl_boost::algorithm::is_sorted (first, last, std::greater_equal<value_type>());
    }
...
///     equal. If that is not what you intended, you should use is_decreasing instead.
    ...
    {
        return is_strictly_decreasing ( wjl_boost::begin ( range ), wjl_boost::end ( range ));
    }
