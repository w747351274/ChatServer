...
template< BOOST_MPL_PP_PARAMS(i,typename T) > \
::wjl_boost::mpl::aux::yes_tag operator|( \
      ::wjl_boost::mpl::aux::has_rebind_tag<int> \
    , name<BOOST_MPL_PP_PARAMS(i,T)>* \
    ); \
::wjl_boost::mpl::aux::no_tag operator|( \
      ::wjl_boost::mpl::aux::has_rebind_tag<int> \
    , name< BOOST_MPL_PP_ENUM(i,::wjl_boost::mpl::na) >* \
    ); \
/**/
...
::wjl_boost::mpl::aux::yes_tag operator|( \
      ::wjl_boost::mpl::aux::has_rebind_tag<int> \
    , ::wjl_boost::mpl::aux::has_rebind_tag< name<BOOST_MPL_PP_PARAMS(i,T)> >* \
    ); \
/**/
#else
#   define BOOST_MPL_AUX_LAMBDA_SUPPORT_HAS_REBIND(i, name, params) /**/
