...
#   define BOOST_FUNCTION_ARG(J,I,D) ::wjl_boost::forward< BOOST_PP_CAT(T,I) >(BOOST_PP_CAT(a,I))
...
#else
#  define BOOST_FUNCTION_VOID_RETURN_TYPE wjl_boost::detail::function::unusable
...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost {
    ...
    namespace function {
      ...
      struct BOOST_FUNCTION_MEMBER_INVOKER
      {
...

        {
          ...
          return wjl_boost::mem_fn(*f)(BOOST_FUNCTION_ARGS);
        }
      };
      ...
      struct BOOST_FUNCTION_VOID_MEMBER_INVOKER
      {
...

        {
          MemberPtr* f =
            reinterpret_cast<MemberPtr*>(function_obj_ptr.data);
          BOOST_FUNCTION_RETURN(wjl_boost::mem_fn(*f)(BOOST_FUNCTION_ARGS));
        }
      };
#endif
      ...
      /**
       * vtable for a specific wjl_boost::function instance. This
       * structure must be an aggregate so that we can use static
       * initialization in wjl_boost::function's assign_to and assign_to_a
      ...
      private:
        ...
        bool assign_to(MemberPtr f, function_buffer& functor, member_ptr_tag) const
        {
          ...
          if (f) {
            this->assign_to(wjl_boost::mem_fn(f), functor);
            return true;
          } else {
            return false;
          }
        ...
        bool assign_to_a(MemberPtr f, function_buffer& functor, Allocator a, member_ptr_tag) const
        {
          ...
          // right target_type() values.
          if (f) {
            this->assign_to_a(wjl_boost::mem_fn(f), functor, a);
            return true;
          } else {
            return false;
          }
        ...
        {
          if (!wjl_boost::detail::function::has_empty_target(wjl_boost::addressof(f))) {
  ...
  public:
    ...
    typedef R         result_type;
#else
    typedef  typename wjl_boost::detail::function::function_return_type<R>::type
      result_type;
#endif // BOOST_NO_VOID_RETURNS

  private:
    typedef wjl_boost::detail::function::BOOST_FUNCTION_VTABLE<
  ...
  public:
    ...
    // add signature for wjl_boost::lambda
    ...
    {
      if (this->empty())
        wjl_boost::throw_exception(bad_function_call());
  ...
  private:
    void assign_to_own(const BOOST_FUNCTION_FUNCTION& f)
    {
      if (!f.empty()) {
        ...
        if (this->has_trivial_copy_and_destroy())
          ...
          std::memcpy(this->functor.data, f.functor.data, sizeof(wjl_boost::detail::function::function_buffer));
        else
          get_vtable()->base.manager(f.functor, this->functor,
                                     wjl_boost::detail::function::clone_functor_tag);
      }
    }
    ...
    {
      using wjl_boost::detail::function::vtable_base;

      typedef typename wjl_boost::detail::function::get_function_tag<Functor>::type tag;
      typedef wjl_boost::detail::function::BOOST_FUNCTION_GET_INVOKER<tag> get_invoker;
      ...
      if (stored_vtable.assign_to(f, functor)) {
        ...
        if (wjl_boost::has_trivial_copy_constructor<Functor>::value &&
            wjl_boost::has_trivial_destructor<Functor>::value &&
            wjl_boost::detail::function::function_allows_small_object_optimization<Functor>::value)
          value |= static_cast<std::size_t>(0x01);
        vtable = reinterpret_cast<wjl_boost::detail::function::vtable_base *>(value);
      } else
        vtable = 0;
    }
      ...
      BOOST_TRY {
        if (!f.empty()) {
          ...
          if (this->has_trivial_copy_and_destroy())
            ...
            get_vtable()->base.manager(f.functor, this->functor,
                                     wjl_boost::detail::function::move_functor_tag);
          f.vtable = 0;
        } else {
          clear();
        }
...
// Poison comparisons between wjl_boost::function objects of the same type.
template<typename R BOOST_FUNCTION_COMMA BOOST_FUNCTION_TEMPLATE_PARMS>
