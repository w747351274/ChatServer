...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost {
  namespace unordered {
    ...
    private:
      typedef wjl_boost::unordered::detail::map<A, K, T, H, P> types;
    ...
    public:
      ...
      unordered_map(InputIt, InputIt,
        size_type = wjl_boost::unordered::detail::default_bucket_count,
  ...
  !defined(BOOST_NO_CXX11_RVALUE_REFERENCES)
      unordered_map(BOOST_RV_REF(unordered_map) other)
        BOOST_NOEXCEPT_IF(table::nothrow_move_constructible)
          : table_(other.table_, wjl_boost::unordered::detail::move_tag())
      {
...
// Assign
      ...
      {
        table_.assign(x.table_, wjl_boost::unordered::detail::true_type());
        return *this;
      }
      ...
      {
        table_.move_assign(x.table_, wjl_boost::unordered::detail::true_type());
        return *this;
      }
#else
...
// emplace
      ...
      std::pair<iterator, bool> emplace(BOOST_FWD_REF(Args)... args)
      {
        return table_.emplace_unique(
          table::extractor::extract(wjl_boost::forward<Args>(args)...),
          wjl_boost::forward<Args>(args)...);
      }
      ...
      std::pair<iterator, bool> emplace(
        wjl_boost::unordered::detail::empty_emplace =
          wjl_boost::unordered::detail::empty_emplace(),
        value_type v = value_type())
      {
        return this->emplace(wjl_boost::move(v));
      }
      ...
      {
        return table_.emplace_unique(
          table::extractor::extract(wjl_boost::forward<A0>(a0)),
          wjl_boost::unordered::detail::create_emplace_args(
            wjl_boost::forward<A0>(a0)));
      }
        ...
        BOOST_FWD_REF(A0) a0, BOOST_FWD_REF(A1) a1)
      {
        return table_.emplace_unique(
          table::extractor::extract(
            wjl_boost::forward<A0>(a0), wjl_boost::forward<A1>(a1)),
          wjl_boost::unordered::detail::create_emplace_args(
            wjl_boost::forward<A0>(a0), wjl_boost::forward<A1>(a1)));
      }
        ...
        BOOST_FWD_REF(A0) a0, BOOST_FWD_REF(A1) a1, BOOST_FWD_REF(A2) a2)
      {
        return table_.emplace_unique(
          table::extractor::extract(
            wjl_boost::forward<A0>(a0), wjl_boost::forward<A1>(a1)),
          wjl_boost::unordered::detail::create_emplace_args(wjl_boost::forward<A0>(a0),
            wjl_boost::forward<A1>(a1), wjl_boost::forward<A2>(a2)));
      }
      ...
      iterator emplace_hint(const_iterator hint,
        ...
        value_type v = value_type())
      {
        return this->emplace_hint(hint, wjl_boost::move(v));
      }
...
#undef BOOST_UNORDERED_EMPLACE
      ...
      {
        return this->emplace(wjl_boost::move(x));
      }

      template <class P2>
      std::pair<iterator, bool> insert(BOOST_RV_REF(P2) obj,
        typename wjl_boost::enable_if_c<
          wjl_boost::is_constructible<value_type, BOOST_RV_REF(P2)>::value,
          void*>::type = 0)
      {
        return this->emplace(wjl_boost::forward<P2>(obj));
      }
      ...
      {
        return this->emplace_hint(hint, wjl_boost::move(x));
      }
      ...
      iterator insert(const_iterator hint, BOOST_RV_REF(P2) obj,
        typename wjl_boost::enable_if_c<
          ...
          void*>::type = 0)
      {
        return this->emplace_hint(hint, wjl_boost::forward<P2>(obj));
      }
  ...
  (BOOST_COMP_GNUC && BOOST_COMP_GNUC < BOOST_VERSION_NUMBER(4, 6, 0))
    ...
    public:
      ...
      {
        return table_.try_emplace_unique(k, wjl_boost::forward<Args>(args)...);
      }
        ...
        BOOST_RV_REF(key_type) k, BOOST_FWD_REF(Args)... args)
      {
        return table_.try_emplace_unique(
          wjl_boost::move(k), wjl_boost::forward<Args>(args)...);
      }
        ...
        const_iterator hint, key_type const& k, BOOST_FWD_REF(Args)... args)
      {
        return table_.try_emplace_hint_unique(
          hint, k, wjl_boost::forward<Args>(args)...);
      }
      ...
      {
        return table_.try_emplace_hint_unique(
          hint, wjl_boost::move(k), wjl_boost::forward<Args>(args)...);
      }
      ...
      {
        return table_.try_emplace_unique(wjl_boost::forward<Key>(k));
      }
      ...
      {
        return table_.try_emplace_hint_unique(hint, wjl_boost::forward<Key>(k));
      }
      ...
      {
        return table_.try_emplace_unique(
          k, wjl_boost::unordered::detail::create_emplace_args(
               wjl_boost::forward<A0>(a0)));
      }
      ...
      {
        return table_.try_emplace_unique(
          wjl_boost::move(k), wjl_boost::unordered::detail::create_emplace_args(
                            wjl_boost::forward<A0>(a0)));
      }
      ...
      std::pair<iterator, bool> try_emplace(BOOST_RV_REF(key_type) k,
        BOOST_FWD_REF(A0) a0, BOOST_FWD_REF(A1) a1, BOOST_FWD_REF(A2) a2)
      {
        return table_.try_emplace_unique(wjl_boost::move(k),
          wjl_boost::unordered::detail::create_emplace_args(wjl_boost::forward<A0>(a0),
            wjl_boost::forward<A1>(a1), wjl_boost::forward<A2>(a2)));
      }
      ...
      {
        return table_.try_emplace_hint_unique(
          hint, k, wjl_boost::unordered::detail::create_emplace_args(
                     wjl_boost::forward<A0>(a0)));
      }
      ...
      {
        return table_.try_emplace_hint_unique(
          hint, wjl_boost::move(k), wjl_boost::unordered::detail::create_emplace_args(
                                  wjl_boost::forward<A0>(a0)));
      }
      ...
      iterator try_emplace(const_iterator hint, BOOST_RV_REF(key_type) k,
        BOOST_FWD_REF(A0) a0, BOOST_FWD_REF(A1) a1)
      {
        return table_.try_emplace_hint_unique(hint, wjl_boost::move(k),
          wjl_boost::unordered::detail::create_emplace_args(
            wjl_boost::forward<A0>(a0), wjl_boost::forward<A1>(a1)));
      }
...
#undef BOOST_UNORDERED_TRY_EMPLACE
      ...
      {
        return table_.insert_or_assign_unique(k, wjl_boost::forward<M>(obj));
      }
        ...
        BOOST_RV_REF(key_type) k, BOOST_FWD_REF(M) obj)
      {
        return table_.insert_or_assign_unique(
          wjl_boost::move(k), wjl_boost::forward<M>(obj));
      }
      ...
      {
        return table_.insert_or_assign_unique(k, wjl_boost::forward<M>(obj)).first;
      }
      ...
      {
        return table_
          .insert_or_assign_unique(wjl_boost::move(k), wjl_boost::forward<M>(obj))
          .first;
      }
      ...
      void merge(wjl_boost::unordered_map<K, T, H2, P2, A>& source);
      ...
      template <typename H2, typename P2>
      void merge(wjl_boost::unordered_multimap<K, T, H2, P2, A>& source);
    ...
    template <class InputIterator,
      class Hash =
        wjl_boost::hash<wjl_boost::unordered::detail::iter_key_t<InputIterator> >,
      class Pred =
        std::equal_to<wjl_boost::unordered::detail::iter_key_t<InputIterator> >,
      class Allocator = std::allocator<
        wjl_boost::unordered::detail::iter_to_alloc_t<InputIterator> > >
    unordered_map(InputIterator, InputIterator,
      std::size_t = wjl_boost::unordered::detail::default_bucket_count,
      Hash = Hash(), Pred = Pred(), Allocator = Allocator())
      ->unordered_map<wjl_boost::unordered::detail::iter_key_t<InputIterator>,
        wjl_boost::unordered::detail::iter_val_t<InputIterator>, Hash, Pred,
        Allocator>;

    template <class Key, class T, class Hash = wjl_boost::hash<Key>,
    ...
    unordered_map(InputIterator, InputIterator, std::size_t, Allocator)
      ->unordered_map<wjl_boost::unordered::detail::iter_key_t<InputIterator>,
        wjl_boost::unordered::detail::iter_val_t<InputIterator>,
        wjl_boost::hash<wjl_boost::unordered::detail::iter_key_t<InputIterator> >,
        std::equal_to<wjl_boost::unordered::detail::iter_key_t<InputIterator> >,
        Allocator>;
    ...
    unordered_map(InputIterator, InputIterator, std::size_t, Hash, Allocator)
      ->unordered_map<wjl_boost::unordered::detail::iter_key_t<InputIterator>,
        wjl_boost::unordered::detail::iter_val_t<InputIterator>, Hash,
        std::equal_to<wjl_boost::unordered::detail::iter_key_t<InputIterator> >,
        Allocator>;
    ...
    unordered_map(
      ...
      ->unordered_map<Key, T, wjl_boost::hash<Key>, std::equal_to<Key>, Allocator>;
...
// Assign
      ...
      {
        table_.assign(x.table_, wjl_boost::unordered::detail::false_type());
        return *this;
      }
      ...
      unordered_multimap& operator=(BOOST_RV_REF(unordered_multimap) x)
        BOOST_NOEXCEPT_IF(value_allocator_traits::is_always_equal::value&&
            wjl_boost::is_nothrow_move_assignable<H>::value&&
              wjl_boost::is_nothrow_move_assignable<P>::value)
      {
        table_.move_assign(x.table_, wjl_boost::unordered::detail::false_type());
        return *this;
      }
#else
...
// emplace
      ...
      template <class... Args> iterator emplace(BOOST_FWD_REF(Args)... args)
      {
        return iterator(table_.emplace_equiv(
          wjl_boost::unordered::detail::func::construct_node_from_args(
            table_.node_alloc(), wjl_boost::forward<Args>(args)...)));
      }
      ...
      iterator emplace(wjl_boost::unordered::detail::empty_emplace =
                         wjl_boost::unordered::detail::empty_emplace(),
        value_type v = value_type())
      {
        return this->emplace(wjl_boost::move(v));
      ...
      template <typename A0> iterator emplace(BOOST_FWD_REF(A0) a0)
      {
        return iterator(table_.emplace_equiv(
          wjl_boost::unordered::detail::func::construct_node_from_args(
            table_.node_alloc(), wjl_boost::unordered::detail::create_emplace_args(
                                   wjl_boost::forward<A0>(a0)))));
      }
      ...
      iterator emplace_hint(const_iterator hint, BOOST_FWD_REF(Args)... args)
      {
        return iterator(table_.emplace_hint_equiv(
          hint, wjl_boost::unordered::detail::func::construct_node_from_args(
                  table_.node_alloc(), wjl_boost::forward<Args>(args)...)));
      }
...
#undef BOOST_UNORDERED_EMPLACE
  ...
  (BOOST_COMP_GNUC && BOOST_COMP_GNUC < BOOST_VERSION_NUMBER(4, 6, 0))
    ...
    unordered_multimap(InputIterator, InputIterator,
      std::size_t = wjl_boost::unordered::detail::default_bucket_count,
      Hash = Hash(), Pred = Pred(), Allocator = Allocator())
      ->unordered_multimap<wjl_boost::unordered::detail::iter_key_t<InputIterator>,
        wjl_boost::unordered::detail::iter_val_t<InputIterator>, Hash, Pred,
        Allocator>;
    ...
    unordered_multimap(
      std::initializer_list<std::pair<const Key, T> >, std::size_t, Allocator)
      ->unordered_multimap<Key, T, wjl_boost::hash<Key>, std::equal_to<Key>,
        Allocator>;
    ...
    unordered_map<K, T, H, P, A>::unordered_map()
        : table_(wjl_boost::unordered::detail::default_bucket_count, hasher(),
    ...
    unordered_map<K, T, H, P, A>::unordered_map(InputIt f, InputIt l,
      ...
      const allocator_type& a)
        : table_(wjl_boost::unordered::detail::initial_size(f, l, n), hf, eql, a)
    {
      this->insert(f, l);
    }
              ...
              select_on_container_copy_construction(other.get_allocator()))
    {
      if (other.table_.size_) {
        table_.copy_buckets(
          other.table_, wjl_boost::unordered::detail::true_type());
      }
    }
    ...
    unordered_map<K, T, H, P, A>::unordered_map(
      BOOST_RV_REF(unordered_map) other, allocator_type const& a)
        : table_(other.table_, a, wjl_boost::unordered::detail::move_tag())
    {
    ...
    unordered_map<K, T, H, P, A>::unordered_map(
      ...
      const key_equal& eql, const allocator_type& a)
        : table_(
            wjl_boost::unordered::detail::initial_size(list.begin(), list.end(), n),
            hf, eql, a)
    {
    ...
    unordered_map<K, T, H, P, A>::unordered_map(
      InputIt f, InputIt l, size_type n, const allocator_type& a)
        : table_(wjl_boost::unordered::detail::initial_size(f, l, n), hasher(),
            key_equal(), a)
    {
      this->insert(f, l);
    }
    ...
    unordered_map<K, T, H, P, A>::unordered_map(InputIt f, InputIt l,
      size_type n, const hasher& hf, const allocator_type& a)
        : table_(
            wjl_boost::unordered::detail::initial_size(f, l, n), hf, key_equal(), a)
    {
      this->insert(f, l);
    }
    ...
    std::size_t unordered_map<K, T, H, P, A>::max_size() const BOOST_NOEXCEPT
    {
      ...
      // size <= mlf_ * count
      return wjl_boost::unordered::detail::double_to_size(
    ...
    void unordered_map<K, T, H, P, A>::merge(
      wjl_boost::unordered_map<K, T, H2, P2, A>& source)
    {
    ...
    template <typename H2, typename P2>
    void unordered_map<K, T, H, P, A>::merge(
      wjl_boost::unordered_multimap<K, T, H2, P2, A>& source)
    {
      table_.merge_unique(source.table_);
    }
    ...
    {
      return table_.try_emplace_unique(wjl_boost::move(k)).first->second;
    }
              ...
              select_on_container_copy_construction(other.get_allocator()))
    {
      if (other.table_.size_) {
        table_.copy_buckets(
          other.table_, wjl_boost::unordered::detail::false_type());
      }
    }
    ...
    template <typename N, class K, class T, class A> class node_handle_map
    {
      ...
      template <typename Types> friend struct ::wjl_boost::unordered::detail::table;
      template <class K2, class T2, class H2, class P2, class A2>
      friend class wjl_boost::unordered::unordered_map;
      template <class K2, class T2, class H2, class P2, class A2>
      friend class wjl_boost::unordered::unordered_multimap;
      ...
      typedef N node;
      typedef typename wjl_boost::unordered::detail::rebind_wrap<A, node>::type
        node_allocator;
    ...
    private:
      node_pointer ptr_;
      wjl_boost::unordered::detail::optional<value_allocator> alloc_;
    ...
    public:
      ...
      ~node_handle_map()
      {
        if (ptr_) {
          ...
          wjl_boost::unordered::detail::node_tmp<node_allocator> tmp(
            ptr_, node_alloc);
        }
      }
      ...
      node_handle_map(BOOST_RV_REF(node_handle_map) n) BOOST_NOEXCEPT
        : ptr_(n.ptr_),
          alloc_(wjl_boost::move(n.alloc_))
      {
        n.ptr_ = node_pointer();
      }
        ...
        value_allocator_traits::is_always_equal::value)
      {
        ...
        if (value_allocator_traits::propagate_on_container_swap::value ||
            !alloc_.has_value() || !n.alloc_.has_value()) {
          wjl_boost::swap(alloc_, n.alloc_);
        }
        wjl_boost::swap(ptr_, n.ptr_);
      }
    };
    ...
    public:
      bool inserted;
      wjl_boost::unordered::iterator_detail::iterator<node_> position;
      wjl_boost::unordered::node_handle_map<N, K, T, A> node;
    ...
    {
      wjl_boost::swap(x.node, y.node);
      wjl_boost::swap(x.inserted, y.inserted);
      wjl_boost::swap(x.position, y.position);
    }
  } // namespace unordered
} // namespace wjl_boost
