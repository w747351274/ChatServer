...
public:
    ...
    {
        composite_device<filter_ref, Source> cmp(wjl_boost::ref(filter2_), src);
    ...
    {
        composite_device<filter_ref, Sink> cmp(wjl_boost::ref(filter2_), snk);
    ...
    std::streampos seek( Device& dev, stream_offset off, BOOST_IOS::seekdir way,
                         BOOST_IOS::openmode which =
                             BOOST_IOS::in | BOOST_IOS::out )
    {
        composite_device<filter_ref, Device> cmp(wjl_boost::ref(filter2_), dev);
