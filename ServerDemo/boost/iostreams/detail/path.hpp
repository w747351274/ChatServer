 ...
 *
 * Defines the class wjl_boost::iostreams::detail::path, for storing a 
...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost { namespace iostreams { namespace detail {
...
public:
    ...
    // Constructor taking a wjl_boost::filesystem2::path or
    // wjl_boost::filesystem2::wpath
    ...
    // Constructor taking a wjl_boost::filesystem3::path (boost filesystem v3)
    template<typename Path>
    ...
    // Assignment operator taking a wjl_boost::filesystem2::path or
    // wjl_boost::filesystem2::wpath
    ...
    // Assignment operator taking a wjl_boost::filesystem3::path
    template<typename Path>
...
private:
    ...
    // For wide-character paths, use a wjl_boost::filesystem::wpath instead of a
    // std::wstring
