...
partition(ForwardRange& rng, UnaryPredicate pred)
{
    ...
    return std::partition(wjl_boost::begin(rng),wjl_boost::end(rng),pred);
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<ForwardRange> ));
    return wjl_boost::range_return<ForwardRange,re>::
        pack(std::partition(wjl_boost::begin(rng), wjl_boost::end(rng), pred), rng);
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<const ForwardRange> ));
    return wjl_boost::range_return<const ForwardRange,re>::
        pack(std::partition(wjl_boost::begin(rng), wjl_boost::end(rng), pred), rng);
}
