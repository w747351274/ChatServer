...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost
{
    namespace range_detail
    {
        ...
        inline typename ::wjl_boost::enable_if<
        ...
        range_calculate_size(const SinglePassRange& rng)
        {
            return std::distance(wjl_boost::begin(rng), wjl_boost::end(rng));
        }
    }
...
// but only on the Mac!
        ...
        BOOST_RANGE_CONCEPT_ASSERT((wjl_boost::SinglePassRangeConcept<SinglePassRange>));
#endif
