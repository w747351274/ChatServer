...
public:
    ...
    index_type index()
    {
        return wjl_boost::tuples::get<0>(*this);
    }
    ...
    value_type value()
    {
        return wjl_boost::tuples::get<1>(*this);
    }
...
{
    typedef ::wjl_boost::range::index_value<
    ...
    >
{
    ...
    BOOST_RANGE_CONCEPT_ASSERT((
        wjl_boost::SinglePassRangeConcept<SinglePassRange>));
public:
    ...
    indexed_range(
        ...
        : base_t(iterator(wjl_boost::begin(r), i),
                 iterator(wjl_boost::end(r), i))
    {
    }
    ...
    indexed_range(
        ...
        : base_t(iterator(wjl_boost::begin(r), i),
                 iterator(wjl_boost::end(r), i + wjl_boost::size(r)))
    {
    }
};
...
{
    BOOST_RANGE_CONCEPT_ASSERT((
        wjl_boost::SinglePassRangeConcept<const SinglePassRange>
    ));
