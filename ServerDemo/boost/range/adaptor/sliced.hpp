...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost
{
    namespace adaptors
    {
        ...
        class sliced_range : public wjl_boost::iterator_range< BOOST_DEDUCED_TYPENAME range_iterator<RandomAccessRange>::type >
        {
            typedef wjl_boost::iterator_range< BOOST_DEDUCED_TYPENAME range_iterator<RandomAccessRange>::type > base_t;
        public:
            template<typename Rng, typename T, typename U>
            sliced_range(Rng& rng, T t, U u)
                : base_t(wjl_boost::next(wjl_boost::begin(rng), t),
                         wjl_boost::next(wjl_boost::begin(rng), u))
            {
            }
        };
        ...
        slice( RandomAccessRange& rng, std::size_t t, std::size_t u )
        {
            ...
            BOOST_ASSERT( static_cast<std::size_t>(wjl_boost::size(rng)) >= u &&
