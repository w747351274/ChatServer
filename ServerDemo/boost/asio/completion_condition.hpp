 ...
 * @code
 * wjl_boost::array<char, 128> buf;
 * wjl_boost::system::error_code ec;
 * std::size_t n = wjl_boost::asio::read(
 *     sock, wjl_boost::asio::buffer(buf),
 *     wjl_boost::asio::transfer_all(), ec);
 * if (ec)
 * {
 *   // An error occurred.
 * }
 ...
 * std::size_t n = wjl_boost::asio::read(
 *     sock, wjl_boost::asio::buffer(buf),
 *     wjl_boost::asio::transfer_at_least(64), ec);
 * if (ec)
 * {
 *   // An error occurred.
 * }
 ...
 * std::size_t n = wjl_boost::asio::read(
 *     sock, wjl_boost::asio::buffer(buf),
 *     wjl_boost::asio::transfer_exactly(64), ec);
 * if (ec)
 * {
 *   // An error occurred.
 * }
