...
public:
  ...
  explicit win_iocp_overlapped_ptr(
      wjl_boost::asio::io_context& io_context, BOOST_ASIO_MOVE_ARG(Handler) handler)
    : ptr_(0),
      iocp_service_(0)
  {
  ...
  // object.
  template <typename Handler>
  void reset(wjl_boost::asio::io_context& io_context, Handler handler)
  {
  ...
  void complete(const wjl_boost::system::error_code& ec,
