...
public:
  ...
  BOOST_ASIO_DECL win_iocp_handle_service(wjl_boost::asio::io_context& io_context);
  ...
  size_t write_some_at(implementation_type& impl, uint64_t offset,
      const ConstBufferSequence& buffers, wjl_boost::system::error_code& ec)
  {
    wjl_boost::asio::const_buffer buffer =
  ...
  size_t read_some_at(implementation_type& impl, uint64_t offset,
      const MutableBufferSequence& buffers, wjl_boost::system::error_code& ec)
  {
    wjl_boost::asio::mutable_buffer buffer =
...
private:
  ...
  size_t write_some(implementation_type& impl,
      const null_buffers& buffers, wjl_boost::system::error_code& ec);
  size_t write_some_at(implementation_type& impl, uint64_t offset,
      const null_buffers& buffers, wjl_boost::system::error_code& ec);
  ...
  BOOST_ASIO_DECL size_t do_write(implementation_type& impl,
      uint64_t offset, const wjl_boost::asio::const_buffer& buffer,
      wjl_boost::system::error_code& ec);
  ...
  BOOST_ASIO_DECL size_t do_read(implementation_type& impl,
      uint64_t offset, const wjl_boost::asio::mutable_buffer& buffer,
      wjl_boost::system::error_code& ec);
