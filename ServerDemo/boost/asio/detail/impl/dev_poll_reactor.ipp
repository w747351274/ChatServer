...
dev_poll_reactor::dev_poll_reactor(wjl_boost::asio::execution_context& ctx)
  : wjl_boost::asio::detail::execution_context_service_base<dev_poll_reactor>(ctx),
...
{
  wjl_boost::asio::detail::mutex::scoped_lock lock(mutex_);
  cancel_ops_unlocked(descriptor, wjl_boost::asio::error::operation_aborted);
}
...
void dev_poll_reactor::run(long usec, op_queue<operation>& ops)
{
  ...
  if (events_size > 0)
  {
    ...
    {
      wjl_boost::system::error_code ec = wjl_boost::system::error_code(
...
int dev_poll_reactor::do_dev_poll_create()
{
  ...
  if (fd == -1)
  {
    wjl_boost::system::error_code ec(errno,
        wjl_boost::asio::error::get_system_category());
    wjl_boost::asio::detail::throw_error(ec, "/dev/poll");
  }
  return fd;
}
