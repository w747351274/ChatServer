...
public:
   ...
   * socket.
   */
  explicit basic_datagram_socket(wjl_boost::asio::io_context& io_context)
   ...
   */
  basic_datagram_socket(wjl_boost::asio::io_context& io_context,
   ...
   * @code socket.send(wjl_boost::asio::buffer(data, size)); @endcode
  ...
  std::size_t send(const ConstBufferSequence& buffers)
  {
    ...
    wjl_boost::asio::detail::throw_error(ec, "send");
    return s;
  }
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_send(wjl_boost::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, wjl_boost::array or
   * std::vector.
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * wjl_boost::asio::ip::udp::endpoint destination(
   *     wjl_boost::asio::ip::address::from_string("1.2.3.4"), 12345);
   * socket.send_to(wjl_boost::asio::buffer(data, size), destination);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, wjl_boost::array or
   * std::vector.
      ...
      const endpoint_type& destination)
  {
    ...
    wjl_boost::asio::detail::throw_error(ec, "send_to");
    return s;
  }
   ...
   *     wjl_boost::asio::buffer(data, size), destination, handler);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, wjl_boost::array or
   * std::vector.
   ...
   * follows:
   * @code socket.receive(wjl_boost::asio::buffer(data, size)); @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, wjl_boost::array or
   * std::vector.
   */
  ...
  std::size_t receive(const MutableBufferSequence& buffers)
  {
    ...
    std::size_t s = this->get_service().receive(
        this->get_implementation(), buffers, 0, ec);
    wjl_boost::asio::detail::throw_error(ec, "receive");
    return s;
  }
   ...
   * follows:
   * @code
   * socket.async_receive(wjl_boost::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, wjl_boost::array or
   * std::vector.
   ...
   * follows:
   * @code
   * wjl_boost::asio::ip::udp::endpoint sender_endpoint;
   * socket.receive_from(
   *     wjl_boost::asio::buffer(data, size), sender_endpoint);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, wjl_boost::array or
   * std::vector.
      ...
      endpoint_type& sender_endpoint)
  {
    ...
    wjl_boost::asio::detail::throw_error(ec, "receive_from");
    return s;
  }
   ...
   *     wjl_boost::asio::buffer(data, size), sender_endpoint, handler); @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, wjl_boost::array or
   * std::vector.
   */
