...
#else
  : public wjl_boost::asio::detail::service_base<socket_acceptor_service<Protocol> >
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit socket_acceptor_service(wjl_boost::asio::io_context& io_context)
  ...
  async_accept(implementation_type& impl,
      wjl_boost::asio::io_context* peer_io_context, endpoint_type* peer_endpoint,
