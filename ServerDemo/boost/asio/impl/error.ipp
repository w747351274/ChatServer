...
class netdb_category : public wjl_boost::system::error_category
{
public:
...
class addrinfo_category : public wjl_boost::system::error_category
{
public:
  const char* name() const BOOST_ASIO_ERROR_CATEGORY_NOEXCEPT
  {
...
class misc_category : public wjl_boost::system::error_category
{
public:
  const char* name() const BOOST_ASIO_ERROR_CATEGORY_NOEXCEPT
  {
