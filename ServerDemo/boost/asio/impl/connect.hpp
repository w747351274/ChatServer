...
namespace detail
{
  struct default_connect_condition
  {
    ...
    bool operator()(const wjl_boost::system::error_code&, const Endpoint&)
    {
      return true;
    }
  };
  ...
  inline typename Protocol::endpoint deref_connect_result(
      Iterator iter, wjl_boost::system::error_code& ec)
  {
    ...
    static const bool value =
      sizeof(asio_connect_condition_check(
        (*static_cast<legacy_connect_condition_helper<T, Iterator>*>(0))(
          *static_cast<const wjl_boost::system::error_code*>(0),
  ...
  inline Iterator call_connect_condition(ConnectCondition& connect_condition,
      const wjl_boost::system::error_code& ec, Iterator next, Iterator end,
...
typename Protocol::endpoint connect(
    basic_socket<Protocol BOOST_ASIO_SVC_TARG>& s,
    const EndpointSequence& endpoints, wjl_boost::system::error_code& ec,
    typename enable_if<is_endpoint_sequence<
        EndpointSequence>::value>::type*)
{
...
inline Iterator connect(basic_socket<Protocol BOOST_ASIO_SVC_TARG>& s,
    Iterator begin, wjl_boost::system::error_code& ec,
    typename enable_if<!is_endpoint_sequence<Iterator>::value>::type*)
{
...
template <typename Protocol BOOST_ASIO_SVC_TPARAM, typename Iterator>
inline Iterator connect(basic_socket<Protocol BOOST_ASIO_SVC_TARG>& s,
    Iterator begin, Iterator end, wjl_boost::system::error_code& ec)
{
    ...
    wjl_boost::system::error_code& ec)
{
  ...
  if (!ec)
    ec = wjl_boost::asio::error::not_found;
...
namespace detail
{
  ...
  protected:
    ...
    void check_condition(const wjl_boost::system::error_code& ec,
  ...
  protected:
    ...
    template <typename Iterator>
    void check_condition(const wjl_boost::system::error_code&, Iterator&, Iterator&)
    {
    }
  };
  ...
  public:
    ...
    void operator()(wjl_boost::system::error_code ec, int start = 0)
    {
      ...
      switch (start_ = start)
      {
        ...
        for (;;)
        {
          ...
          {
            ec = wjl_boost::asio::error::not_found;
            wjl_boost::asio::post(socket_.get_executor(),
                detail::bind_handler(
        ...
        handler_(static_cast<const wjl_boost::system::error_code&>(ec),
  ...
  {
    return wjl_boost_asio_handler_alloc_helpers::allocate(
  ...
  inline void asio_handler_deallocate(void* pointer, std::size_t size,
      range_connect_op<Protocol BOOST_ASIO_SVC_TARG, EndpointSequence,
        ConnectCondition, RangeConnectHandler>* this_handler)
  {
    wjl_boost_asio_handler_alloc_helpers::deallocate(
  ...
  inline bool asio_handler_is_continuation(
      range_connect_op<Protocol BOOST_ASIO_SVC_TARG, EndpointSequence,
        ConnectCondition, RangeConnectHandler>* this_handler)
  {
    return wjl_boost_asio_handler_cont_helpers::is_continuation(
  ...
  inline void asio_handler_invoke(Function& function,
      range_connect_op<Protocol BOOST_ASIO_SVC_TARG, EndpointSequence,
        ConnectCondition, RangeConnectHandler>* this_handler)
  {
    wjl_boost_asio_handler_invoke_helpers::invoke(
...
inline BOOST_ASIO_INITFN_RESULT_TYPE(RangeConnectHandler,
    void (wjl_boost::system::error_code, typename Protocol::endpoint))
  ...
  detail::range_connect_op<Protocol BOOST_ASIO_SVC_TARG, EndpointSequence,
    detail::default_connect_condition,
      BOOST_ASIO_HANDLER_TYPE(RangeConnectHandler,
        void (wjl_boost::system::error_code, typename Protocol::endpoint))>(s,
          endpoints, detail::default_connect_condition(),
            init.completion_handler)(wjl_boost::system::error_code(), 1);
...
inline BOOST_ASIO_INITFN_RESULT_TYPE(IteratorConnectHandler,
    void (wjl_boost::system::error_code, Iterator))
async_connect(basic_socket<Protocol BOOST_ASIO_SVC_TARG>& s,
    ...
    typename enable_if<!is_endpoint_sequence<Iterator>::value>::type*)
{
  ...
  async_completion<IteratorConnectHandler,
    void (wjl_boost::system::error_code, Iterator)> init(handler);

  detail::iterator_connect_op<Protocol BOOST_ASIO_SVC_TARG, Iterator,
    detail::default_connect_condition, BOOST_ASIO_HANDLER_TYPE(
      IteratorConnectHandler, void (wjl_boost::system::error_code, Iterator))>(s,
