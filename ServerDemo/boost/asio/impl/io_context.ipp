...
{
  wjl_boost::asio::detail::scoped_ptr<impl_type> scoped_impl(impl);
  wjl_boost::asio::add_service<impl_type>(*this, scoped_impl.get());
...
io_context::count_type io_context::run(wjl_boost::system::error_code& ec)
{
  return impl_.run(ec);
}
...
#if !defined(BOOST_ASIO_NO_DEPRECATED)
io_context::count_type io_context::run_one(wjl_boost::system::error_code& ec)
{
...
#if !defined(BOOST_ASIO_NO_DEPRECATED)
io_context::count_type io_context::poll(wjl_boost::system::error_code& ec)
{
...
#if !defined(BOOST_ASIO_NO_DEPRECATED)
io_context::count_type io_context::poll_one(wjl_boost::system::error_code& ec)
{
...
io_context::service::service(wjl_boost::asio::io_context& owner)
