...
thread_clock::time_point thread_clock::now( system::error_code & ec )
{
    ...
    if ( wjl_boost::detail::winapi::GetThreadTimes(
            wjl_boost::detail::winapi::GetCurrentThread (), &creation, &exit,
    ...
    else
    {
        ...
        {
            ec.assign( wjl_boost::detail::winapi::GetLastError(), BOOST_CHRONO_SYSTEM_CATEGORY );
