...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost
{
  namespace signals2
  {
    namespace detail
    {
      ...
      typedef wjl_boost::variant<wjl_boost::weak_ptr<trackable_pointee>, wjl_boost::weak_ptr<void>, detail::foreign_void_weak_ptr > void_weak_ptr_variant;
      typedef wjl_boost::variant<wjl_boost::shared_ptr<void>, detail::foreign_void_shared_ptr > void_shared_ptr_variant;
      ...
      public:
        ...
        {
          return wjl_boost::shared_ptr<void>();
        }
      };
    ...
    public:
      ...
      locked_container_type lock() const
      {
        ...
        for(it = tracked_objects().begin(); it != tracked_objects().end(); ++it)
        {
          ...
          {
            wjl_boost::throw_exception(expired_slot());
          }
        }
