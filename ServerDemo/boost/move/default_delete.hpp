...
namespace bmupmu = ::wjl_boost::move_upmu;
...
namespace bmupd = wjl_boost::move_upd;
namespace bmupmu = ::wjl_boost::move_upmu;
...
struct default_delete
{
      ...
      ) BOOST_NOEXCEPT
   {
      ...
      BOOST_STATIC_ASSERT(( !::wjl_boost::move_upmu::missing_virtual_destructor<default_delete, U>::value ));
   }
