...
// @endcond
   ...
   template <class T>
   class rv
      : public ::wjl_boost::move_detail::if_c
         < ::wjl_boost::move_detail::is_class<T>::value
         , T
         , ::wjl_boost::move_detail::nat
         >::type
   {
      rv();
      ~rv() throw();
   ...
   struct is_rv
      ...
      : integral_constant<bool, ::wjl_boost::move_detail::is_rv_impl<T>::value >
   {};
   ...
   struct has_move_emulation_enabled
      : ::wjl_boost::move_detail::has_move_emulation_enabled_impl<T>
   {};

   template<class T>
   struct has_move_emulation_disabled
   {
      static const bool value = !::wjl_boost::move_detail::has_move_emulation_enabled_impl<T>::value;
   };
   ...
   #define BOOST_RV_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      ::wjl_boost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_RV_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      ::wjl_boost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
   ...
   #define BOOST_COPY_ASSIGN_REF_2_TEMPL_ARGS(TYPE, ARG1, ARG2)\
      const ::wjl_boost::rv< TYPE<ARG1, ARG2> >& \
   //

   #define BOOST_COPY_ASSIGN_REF_3_TEMPL_ARGS(TYPE, ARG1, ARG2, ARG3)\
      const ::wjl_boost::rv< TYPE<ARG1, ARG2, ARG3> >& \
   //
   ...
   BOOST_MOVE_FORCEINLINE typename ::wjl_boost::move_detail::enable_if_c
      <  ::wjl_boost::move_detail::is_lvalue_reference<Ret>::value ||
        !::wjl_boost::has_move_emulation_enabled<T>::value
      , T&>::type
   ...
   BOOST_MOVE_FORCEINLINE typename ::wjl_boost::move_detail::enable_if_c
      < !::wjl_boost::move_detail::is_lvalue_reference<Ret>::value &&
         ::wjl_boost::has_move_emulation_enabled<T>::value
      , ::wjl_boost::rv<T>&>::type
         move_return(::wjl_boost::rv<T>& x) BOOST_NOEXCEPT
   {
      return x;
   }
   ...
   #define BOOST_MOVE_RET(RET_TYPE, REF)\
      wjl_boost::move_detail::move_return< RET_TYPE >(REF)
   //

   #define BOOST_MOVE_BASE(BASE_TYPE, ARG) \
      ::wjl_boost::move((BASE_TYPE&)(ARG))
   //
   ...
   #define BOOST_MOVABLE_BUT_NOT_COPYABLE(TYPE)\
      ...
      public:\
      BOOST_MOVE_FORCEINLINE operator ::wjl_boost::rv<TYPE>&() \
      {  return *BOOST_MOVE_TO_RV_CAST(::wjl_boost::rv<TYPE>*, this);  }\
      BOOST_MOVE_FORCEINLINE operator const ::wjl_boost::rv<TYPE>&() const \
      {  return *BOOST_MOVE_TO_RV_CAST(const ::wjl_boost::rv<TYPE>*, this);  }\
      private:\
   //
   ...
   template< class T>
   struct forward_type< wjl_boost::rv<T> >
   { typedef T type; };
   ...
   //!cast to the base type before calling `::wjl_boost::move()` due to rvalue reference limitations.
   //!
