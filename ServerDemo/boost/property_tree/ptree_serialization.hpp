...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost { namespace property_tree
{
    ...
    ///////////////////////////////////////////////////////////////////////////
    // wjl_boost::serialization support
     ...
     *       library's @c wjl_boost::property_tree::xml_parser::write_xml.
    ...
    {
        using namespace wjl_boost::serialization;
    ...
    namespace detail
    {
        ...
        inline void load_children(Archive &ar,
                                  basic_ptree<K, D, C> &t)
        {
            namespace bsl = wjl_boost::serialization;
            namespace bsa = wjl_boost::archive;
