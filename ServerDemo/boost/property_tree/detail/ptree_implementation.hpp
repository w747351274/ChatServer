...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost { namespace property_tree
{
    ...
    template <class K, class D, class C>
    class basic_ptree<K, D, C>::iterator : public wjl_boost::iterator_adaptor<
        iterator, typename subs::base_container::iterator, value_type>
    {
        friend class wjl_boost::iterator_core_access;
        typedef wjl_boost::iterator_adaptor<
            iterator, typename subs::base_container::iterator, value_type>
            baset;
    public:
    ...
    template <class K, class D, class C>
    class basic_ptree<K, D, C>::const_iterator : public wjl_boost::iterator_adaptor<
    ...
    class basic_ptree<K, D, C>::reverse_iterator
        : public wjl_boost::reverse_iterator<iterator>
    {
    public:
        reverse_iterator() {}
        explicit reverse_iterator(iterator b)
            : wjl_boost::reverse_iterator<iterator>(b)
        {}
    };
    template <class K, class D, class C>
    class basic_ptree<K, D, C>::const_reverse_iterator
        : public wjl_boost::reverse_iterator<const_iterator>
    {
    public:
        const_reverse_iterator() {}
        explicit const_reverse_iterator(const_iterator b)
            : wjl_boost::reverse_iterator<const_iterator>(b)
        {}
        const_reverse_iterator(
    ...
    class basic_ptree<K, D, C>::assoc_iterator
        : public wjl_boost::iterator_adaptor<assoc_iterator,
                                         typename subs::by_name_index::iterator,
                                         value_type>
    {
        friend class wjl_boost::iterator_core_access;
        typedef wjl_boost::iterator_adaptor<assoc_iterator,
                                         typename subs::by_name_index::iterator,
                                         value_type>
            baset;
    public:
    ...
    class basic_ptree<K, D, C>::const_assoc_iterator
        : public wjl_boost::iterator_adaptor<const_assoc_iterator,
    ...
    {
        wjl_boost::swap(m_data, rhs.m_data);
    ...
    typename wjl_boost::enable_if<detail::is_translator<Translator>, Type>::type
    basic_ptree<K, D, C>::get_value(Translator tr) const
    {
        if(wjl_boost::optional<Type> o = get_value_optional<Type>(tr)) {
            return *o;
        }
    ...
    template<class K, class D, class C>
    template<class Type> inline
    typename wjl_boost::disable_if<detail::is_translator<Type>, Type>::type
