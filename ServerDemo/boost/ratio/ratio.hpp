...
class ratio
{
    static const wjl_boost::intmax_t ABS_N = mpl::abs_c<wjl_boost::intmax_t, N>::value;
    static const wjl_boost::intmax_t ABS_D = mpl::abs_c<wjl_boost::intmax_t, D>::value;
    ...
    static const wjl_boost::intmax_t SIGN_N = mpl::sign_c<wjl_boost::intmax_t,N>::value
      * mpl::sign_c<wjl_boost::intmax_t,D>::value;
    static const wjl_boost::intmax_t GCD = mpl::gcd_c<wjl_boost::intmax_t, ABS_N, ABS_D>::value;
public:
    BOOST_STATIC_CONSTEXPR wjl_boost::intmax_t num = SIGN_N * ABS_N / GCD;
    BOOST_STATIC_CONSTEXPR wjl_boost::intmax_t den = ABS_D / GCD;

#ifdef BOOST_RATIO_EXTENSIONS
    typedef mpl::rational_c_tag tag;
    typedef wjl_boost::rational<wjl_boost::intmax_t> value_type;
    typedef wjl_boost::intmax_t num_type;
    typedef wjl_boost::intmax_t den_type;
    ratio()
    {}
    template <wjl_boost::intmax_t _N2, wjl_boost::intmax_t _D2>
...
template <wjl_boost::intmax_t N, wjl_boost::intmax_t D>
const    wjl_boost::intmax_t ratio<N, D>::num;
template <wjl_boost::intmax_t N, wjl_boost::intmax_t D>
const    wjl_boost::intmax_t ratio<N, D>::den;
#endif
...
struct ratio_add
: wjl_boost::ratio_detail::ratio_add<R1, R2>::type
{
};

template <class R1, class R2>
struct ratio_subtract
: wjl_boost::ratio_detail::ratio_subtract<R1, R2>::type
{
};

template <class R1, class R2>
struct ratio_multiply
: wjl_boost::ratio_detail::ratio_multiply<R1, R2>::type
{
};

template <class R1, class R2>
struct ratio_divide
: wjl_boost::ratio_detail::ratio_divide<R1, R2>::type
{
};
...
template <class R1, class R2>
struct ratio_equal
    : public wjl_boost::integral_constant<bool,
                               (R1::num == R2::num && R1::den == R2::den)>
{};

template <class R1, class R2>
struct ratio_not_equal
    : public wjl_boost::integral_constant<bool, !ratio_equal<R1, R2>::value>
{};
...
template <class R1, class R2>
struct ratio_less
    : wjl_boost::integral_constant<bool, wjl_boost::ratio_detail::ratio_less<R1, R2>::value>
{};

template <class R1, class R2>
struct ratio_less_equal
    : wjl_boost::integral_constant<bool, !ratio_less<R2, R1>::value>
{};
...
struct ratio_greater_equal
    : wjl_boost::integral_constant<bool, !ratio_less<R1, R2>::value>
{};

template <class R1, class R2>
struct ratio_gcd :
    ratio<mpl::gcd_c<wjl_boost::intmax_t, R1::num, R2::num>::value,
        mpl::lcm_c<wjl_boost::intmax_t, R1::den, R2::den>::value>::type
{
};
...
template <class R>
struct ratio_abs
    : ratio<mpl::abs_c<wjl_boost::intmax_t, R::num>::value, R::den>::type
{
};
template <class R>
struct ratio_sign
    : mpl::sign_c<wjl_boost::intmax_t, R::num>
{
};
...
template <class R1, class R2>
struct ratio_lcm :
    ratio<mpl::lcm_c<wjl_boost::intmax_t, R1::num, R2::num>::value,
        mpl::gcd_c<wjl_boost::intmax_t, R1::den, R2::den>::value>::type
{
};
