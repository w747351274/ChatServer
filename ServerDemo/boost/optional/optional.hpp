...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost { namespace optional_detail {
...
template <typename T>
struct optional_value_type< ::wjl_boost::optional<T> >
{
  typedef T type;
};

}} // namespace wjl_boost::optional_detail
...
class optional_base : public optional_tag
{
  ...
  protected:
    ...
    BOOST_NOEXCEPT_IF(::wjl_boost::is_nothrow_move_constructible<T>::value)
      :
      m_initialized(false)
    {
      if ( rhs.is_initialized() )
        construct( wjl_boost::move(rhs.get_impl()) );
    }
#endif
    ...
    explicit optional_base ( Expr&& expr, PtrExpr const* tag )
      ...
      m_initialized(false)
    {
      construct(wjl_boost::forward<Expr>(expr),tag);
    }
    ...
    BOOST_NOEXCEPT_IF(::wjl_boost::is_nothrow_move_constructible<T>::value && ::wjl_boost::is_nothrow_move_assignable<T>::value)
    {
    ...
    void assign ( optional_base&& rhs )
    {
      ...
      {
        if ( rhs.is_initialized() )
             assign_value( wjl_boost::move(rhs.get_impl()) );
        else destroy();
      }
      else
      {
    ...
    {
      if (is_initialized())
           assign_value( wjl_boost::move(val) );
      else construct( wjl_boost::move(val) );
    }
#endif
    ...
    {
      if (is_initialized())
        assign_expr_to_initialized(wjl_boost::forward<Expr>(expr),tag);
      else construct(wjl_boost::forward<Expr>(expr),tag);
    }
#else
    template<class Expr>
  ...
  protected :
    ...
    void construct ( rval_reference_type val )
     {
       ::new (m_storage.address()) value_type( wjl_boost::move(val) ) ;
       m_initialized = true ;
     }
#endif
    ...
    {
      ::new (m_storage.address()) value_type( wjl_boost::forward<Args>(args)... ) ;
      m_initialized = true ;
    }
    ...
    {
      destroy();
      construct(in_place_init, wjl_boost::forward<Args>(args)...);
    }
    ...
    void construct ( in_place_init_t, Arg&& arg )
     {
       ::new (m_storage.address()) value_type( wjl_boost::forward<Arg>(arg) );
       m_initialized = true ;
     }
    ...
    void emplace_assign ( Arg&& arg )
     {
       destroy();
       construct(in_place_init, wjl_boost::forward<Arg>(arg)) ;
     }
    ...
    void construct ( Expr&& factory, in_place_factory_base const* )
     {
       wjl_boost_optional_detail::construct<value_type>(factory, m_storage.address());
       m_initialized = true ;
     }
    ...
    {
      new (m_storage.address()) value_type(wjl_boost::forward<Expr>(expr)) ;
      m_initialized = true ;
    }
    ...
    {
      assign_value( wjl_boost::forward<Expr>(expr) );
    }
#else
    // Constructs using any expression implicitly convertible to the single argument
    // of a one-argument T constructor.
    ...
    void construct ( Expr&& expr, optional_tag const* )
     {
       if ( expr.is_initialized() )
       {
         ...
         new (m_storage.address()) value_type(wjl_boost::move(expr.get())) ;
         m_initialized = true ;
       }
     }
#else
...
struct is_optional_related
  : wjl_boost::conditional< wjl_boost::is_base_of<optional_detail::optional_tag, BOOST_DEDUCED_TYPENAME wjl_boost::decay<U>::type>::value
                     || wjl_boost::is_same<BOOST_DEDUCED_TYPENAME wjl_boost::decay<U>::type, none_t>::value
                     || wjl_boost::is_same<BOOST_DEDUCED_TYPENAME wjl_boost::decay<U>::type, in_place_init_t>::value
                     || wjl_boost::is_same<BOOST_DEDUCED_TYPENAME wjl_boost::decay<U>::type, in_place_init_if_t>::value,
    wjl_boost::true_type, wjl_boost::false_type>::type
{};
...
struct is_convertible_to_T_or_factory
  : wjl_boost::conditional< wjl_boost::is_base_of<wjl_boost::in_place_factory_base, BOOST_DEDUCED_TYPENAME wjl_boost::decay<U>::type>::value
                     || wjl_boost::is_base_of<wjl_boost::typed_in_place_factory_base, BOOST_DEDUCED_TYPENAME wjl_boost::decay<U>::type>::value
                     || (wjl_boost::is_constructible<T, U&&>::value && !wjl_boost::is_same<T, BOOST_DEDUCED_TYPENAME wjl_boost::decay<U>::type>::value)
                      , wjl_boost::true_type, wjl_boost::false_type>::type
{};

template <typename T, typename U>
struct is_optional_constructible : wjl_boost::is_constructible<T, U>
{};

#else

template <typename, typename>
struct is_convertible_to_T_or_factory : wjl_boost::true_type
{};

template <typename T, typename U>
struct is_optional_constructible : wjl_boost::true_type
{};
...
struct is_optional_val_init_candidate
  : wjl_boost::conditional< !is_optional_related<U>::value && is_convertible_to_T_or_factory<T, U>::value
                      , wjl_boost::true_type, wjl_boost::false_type>::type
{};
...
struct optional_uses_direct_storage_for
  : wjl_boost::conditional<(wjl_boost::is_scalar<T>::value && !wjl_boost::is_const<T>::value && !wjl_boost::is_volatile<T>::value)
                      , wjl_boost::true_type, wjl_boost::false_type>::type
{};
...
#  define BOOST_OPTIONAL_BASE_TYPE(T) wjl_boost::conditional< optional_config::optional_uses_direct_storage_for<T>::value, \
  ...
  : public BOOST_OPTIONAL_BASE_TYPE(T)
{
  ...
  public :
    ...
    // Can throw if T::T(T &&) does
    optional ( rval_reference_type val ) : base( wjl_boost::forward<T>(val) )
      {}
#endif
    ...
    /// Creates an optional<T> initialized with 'val' IFF cond is true, otherwise creates an uninitialized optional.
    // Can throw if T::T(T &&) does
    optional ( bool cond, rval_reference_type val ) : base( cond, wjl_boost::forward<T>(val) )
      {}
#endif
    ...
    explicit optional ( optional<U> const& rhs
                        ...
                        ,BOOST_DEDUCED_TYPENAME wjl_boost::enable_if< optional_detail::is_optional_constructible<T, U const&>, bool>::type = true
#endif
                      )
      :
      base()
...
#ifndef BOOST_OPTIONAL_DETAIL_NO_SFINAE_FRIENDLY_CONSTRUCTORS
                        ,BOOST_DEDUCED_TYPENAME wjl_boost::enable_if< optional_detail::is_optional_constructible<T, U>, bool>::type = true
#endif
                      )
      :
      base()
    {
      if ( rhs.is_initialized() )
        this->construct( wjl_boost::move(rhs.get()) );
    }
#endif
  ...
  explicit optional ( Expr&& expr,
                      BOOST_DEDUCED_TYPENAME wjl_boost::enable_if< optional_detail::is_optional_val_init_candidate<T, Expr>, bool>::type = true
  )
    : base(wjl_boost::forward<Expr>(expr),wjl_boost::addressof(expr))
    {}

#else
    template<class Expr>
    explicit optional ( Expr const& expr ) : base(expr,wjl_boost::addressof(expr)) {}
    ...
    template<class Expr>
    BOOST_DEDUCED_TYPENAME wjl_boost::enable_if<optional_detail::is_optional_val_init_candidate<T, Expr>, optional&>::type
    operator= ( Expr&& expr )
      {
        this->assign_expr(wjl_boost::forward<Expr>(expr),wjl_boost::addressof(expr));
        return *this ;
      }
    ...
    optional& operator= ( Expr const& expr )
      {
        this->assign_expr(expr,wjl_boost::addressof(expr));
        return *this ;
      }
#endif // !defined  BOOST_OPTIONAL_DETAIL_NO_RVALUE_REFERENCES
    ...
    optional& operator= ( optional<U> && rhs )
      {
        this->assign(wjl_boost::move(rhs));
        return *this ;
      }
#endif
    ...
    BOOST_DEDUCED_TYPENAME wjl_boost::enable_if<wjl_boost::is_same<T, BOOST_DEDUCED_TYPENAME wjl_boost::decay<T_>::type>, optional&>::type
    operator= ( T_&& val )
      {
        this->assign( wjl_boost::forward<T_>(val) ) ;
        return *this ;
      }
    ...
    optional& operator= ( rval_reference_type val )
      {
        this->assign( wjl_boost::move(val) ) ;
        return *this ;
      }
#endif
    ...
    {
      this->emplace_assign( wjl_boost::forward<Args>(args)... );
    }

    template<class... Args>
    explicit optional ( in_place_init_t, Args&&... args )
    : base( in_place_init, wjl_boost::forward<Args>(args)... )
    {}

    template<class... Args>
    explicit optional ( in_place_init_if_t, bool cond, Args&&... args )
    : base( in_place_init_if, cond, wjl_boost::forward<Args>(args)... )
    {}
    ...
    void emplace ( Arg&& arg )
     {
       this->emplace_assign( wjl_boost::forward<Arg>(arg) );
     }
    ...
    reference_type_of_temporary_wrapper operator *() && { return wjl_boost::move(this->get()) ; }
#else
    reference_const_type operator *() const { return this->get() ; }
    reference_type       operator *()       { return this->get() ; }
    ...
    reference_type_of_temporary_wrapper value() &&
      {
        if (this->is_initialized())
          return wjl_boost::move(this->get()) ;
        else
          throw_exception(bad_optional_access());
      }
    ...
    template <typename F>
    optional<typename wjl_boost::result_of<F(reference_type)>::type> map(F f) &
      {
        if (this->has_value())
          return f(get());
        else
    ...
    template <typename F>
    optional<typename wjl_boost::result_of<F(reference_const_type)>::type> map(F f) const&
      {
        if (this->has_value())
          return f(get());
        else
    ...
    template <typename F>
    optional<typename wjl_boost::result_of<F(reference_type_of_temporary_wrapper)>::type> map(F f) &&
      {
        if (this->has_value())
          return f(wjl_boost::move(this->get()));
        else
          return none;
      }

    template <typename F>
    optional<typename optional_detail::optional_value_type<typename wjl_boost::result_of<F(reference_type)>::type>::type> flat_map(F f) &
      {
        if (this->has_value())
          return f(get());
        else
    ...
    template <typename F>
    optional<typename optional_detail::optional_value_type<typename wjl_boost::result_of<F(reference_const_type)>::type>::type> flat_map(F f) const&
      {
        if (this->has_value())
          return f(get());
        else
    ...
    template <typename F>
    optional<typename optional_detail::optional_value_type<typename wjl_boost::result_of<F(reference_type_of_temporary_wrapper)>::type>::type> flat_map(F f) &&
      {
        if (this->has_value())
          return f(wjl_boost::move(get()));
        else
          return none;
      }
...
template<class T>
inline
optional<BOOST_DEDUCED_TYPENAME wjl_boost::decay<T>::type> make_optional ( T && v  )
{
  return optional<BOOST_DEDUCED_TYPENAME wjl_boost::decay<T>::type>(wjl_boost::forward<T>(v));
}

// Returns optional<T>(cond,v)
template<class T>
inline
optional<BOOST_DEDUCED_TYPENAME wjl_boost::decay<T>::type> make_optional ( bool cond, T && v )
{
  return optional<BOOST_DEDUCED_TYPENAME wjl_boost::decay<T>::type>(cond,wjl_boost::forward<T>(v));
}
...
{
  BOOST_STATIC_ASSERT_MSG(sizeof(CharType) == 0, "If you want to output wjl_boost::optional, include header <boost/optional/optional_io.hpp>");
  return os;
}
