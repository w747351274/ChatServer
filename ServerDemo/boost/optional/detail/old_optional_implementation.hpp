...
#else
  static rval_reference_type move(reference_type r) { return wjl_boost::move(r); }
#endif
#endif
...
void prevent_binding_rvalue_ref_to_optional_lvalue_ref()
{
  ...
  BOOST_STATIC_ASSERT_MSG(
    !wjl_boost::is_lvalue_reference<To>::value || !wjl_boost::is_rvalue_reference<From>::value, 
...
class optional_base : public optional_tag
{
...
#endif
    ::wjl_boost::detail::make_reference_content<T>::type internal_type ;
  ...
  protected:
    ...
    void assign ( optional_base&& rhs )
    {
      ...
      {
        if ( rhs.is_initialized() )
             assign_value(wjl_boost::move(rhs.get_impl()), is_reference_predicate() );
        else destroy();
      }
      else
      {
    ...
    {
      if (is_initialized())
           assign_value( wjl_boost::move(val), is_reference_predicate() );
  ...
  protected :
    ...
    void emplace_assign ( Args&&... args )
     {
       destroy();
       ::new (m_storage.address()) internal_type( wjl_boost::forward<Args>(args)... );
       m_initialized = true ;
     }
    ...
    void emplace_assign ( Arg&& arg )
     {
       destroy();
       ::new (m_storage.address()) internal_type( wjl_boost::forward<Arg>(arg) );
       m_initialized = true ;
     }
    ...
    void construct ( Expr&& factory, in_place_factory_base const* )
     {
       BOOST_STATIC_ASSERT ( ::wjl_boost::mpl::not_<is_reference_predicate>::value ) ;
    ...
    {
      new (m_storage.address()) internal_type(wjl_boost::forward<Expr>(expr)) ;
      m_initialized = true ;
    }
    ...
    {
      assign_value(wjl_boost::forward<Expr>(expr), is_reference_predicate());
    }
#else
    // Constructs using any expression implicitly convertible to the single argument
    // of a one-argument T constructor.
...
class optional : public optional_detail::optional_base<T>
{
  ...
  explicit optional ( Expr&& expr, 
                      BOOST_DEDUCED_TYPENAME wjl_boost::disable_if_c<
                        (wjl_boost::is_base_of<optional_detail::optional_tag, BOOST_DEDUCED_TYPENAME wjl_boost::decay<Expr>::type>::value) || 
                        wjl_boost::is_same<BOOST_DEDUCED_TYPENAME wjl_boost::decay<Expr>::type, none_t>::value, bool >::type = true 
  ) 
   ...
   // No-throw (assuming T::~T() doesn't)
    ...
    BOOST_DEDUCED_TYPENAME wjl_boost::disable_if_c<
      wjl_boost::is_base_of<optional_detail::optional_tag, BOOST_DEDUCED_TYPENAME wjl_boost::decay<Expr>::type>::value || 
        wjl_boost::is_same<BOOST_DEDUCED_TYPENAME wjl_boost::decay<Expr>::type, none_t>::value,
      optional&
    >::type 
    operator= ( Expr&& expr )
      {
