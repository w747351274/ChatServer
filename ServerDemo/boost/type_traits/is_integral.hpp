...
template<> struct is_integral< ::wjl_boost::ulong_long_type> : public true_type{};
template<> struct is_integral< ::wjl_boost::long_long_type> : public true_type{};
...
template<> struct is_integral<wjl_boost::int128_type> : public true_type{};
template<> struct is_integral<wjl_boost::uint128_type> : public true_type{};
#endif
