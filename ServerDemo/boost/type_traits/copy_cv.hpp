...
private:
    ...
    typedef typename wjl_boost::conditional<wjl_boost::is_const<U>::value, typename wjl_boost::add_const<T>::type, T>::type CT;

public:

    typedef typename wjl_boost::conditional<wjl_boost::is_volatile<U>::value, typename wjl_boost::add_volatile<CT>::type, CT>::type type;
};
