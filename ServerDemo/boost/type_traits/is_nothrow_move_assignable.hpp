...
{
   BOOST_STATIC_ASSERT_MSG(wjl_boost::is_complete<T>::value, "Arguments to is_nothrow_move_assignable must be complete types");
};
...
struct false_or_cpp11_noexcept_move_assignable: public ::wjl_boost::false_type {};

template <class T>
struct false_or_cpp11_noexcept_move_assignable <
        T,
        typename ::wjl_boost::enable_if_c<sizeof(T) && BOOST_NOEXCEPT_EXPR(::wjl_boost::declval<T&>() = ::wjl_boost::declval<T>())>::type
    > : public ::wjl_boost::integral_constant<bool, BOOST_NOEXCEPT_EXPR(::wjl_boost::declval<T&>() = ::wjl_boost::declval<T>())>
{};

}

template <class T>
struct is_nothrow_move_assignable : public integral_constant<bool, ::wjl_boost::detail::false_or_cpp11_noexcept_move_assignable<T>::value>
{
   BOOST_STATIC_ASSERT_MSG(wjl_boost::is_complete<T>::value, "Arguments to is_nothrow_move_assignable must be complete types");
};

template <class T> struct is_nothrow_move_assignable<T const> : public ::wjl_boost::false_type {};
template <class T> struct is_nothrow_move_assignable<T const volatile> : public ::wjl_boost::false_type{};
template <class T> struct is_nothrow_move_assignable<T volatile> : public ::wjl_boost::false_type{};
template <class T> struct is_nothrow_move_assignable<T&> : public ::wjl_boost::false_type{};
...
struct is_nothrow_move_assignable : public integral_constant<bool,
   (::wjl_boost::has_trivial_move_assign<T>::value || ::wjl_boost::has_nothrow_assign<T>::value) &&  ! ::wjl_boost::is_array<T>::value>
{
   BOOST_STATIC_ASSERT_MSG(wjl_boost::is_complete<T>::value, "Arguments to is_nothrow_move_assignable must be complete types");
};
