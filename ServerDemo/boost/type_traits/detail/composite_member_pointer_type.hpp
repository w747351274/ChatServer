...
template<class C1, class C2> struct common_member_class
{
    typedef typename wjl_boost::conditional<
        ...
        wjl_boost::is_base_of<C1, C2>::value,
        C2,
        typename wjl_boost::conditional<wjl_boost::is_base_of<C2, C1>::value, C1, void>::type
...
private:
    ...
    typedef typename wjl_boost::remove_pointer<CPT>::type CT;
