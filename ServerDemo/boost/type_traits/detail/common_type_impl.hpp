...
{
    BOOST_STATIC_CONSTANT( bool, ct = wjl_boost::is_class<T>::value || wjl_boost::is_union<T>::value );
    BOOST_STATIC_CONSTANT( bool, cu = wjl_boost::is_class<U>::value || wjl_boost::is_union<U>::value );
...
template<class T, class U> struct common_type_class: public wjl_boost::conditional<

    wjl_boost::is_convertible<T, U>::value && !wjl_boost::is_convertible<U, T>::value,
    wjl_boost::type_identity<U>,

    typename wjl_boost::conditional<

        wjl_boost::is_convertible<U, T>::value && !wjl_boost::is_convertible<T, U>::value,
        wjl_boost::type_identity<T>,
...
template<class T, class U> struct common_type_impl: public wjl_boost::conditional<
    ct_class<T, U>::value,
...
template<class T, class U> struct common_type_impl3: public wjl_boost::conditional<
    wjl_boost::is_pointer<T>::value || wjl_boost::is_pointer<U>::value,
...
template<class T, class U> struct common_type_impl4: public wjl_boost::conditional<
    wjl_boost::is_member_pointer<T>::value || wjl_boost::is_member_pointer<U>::value,
