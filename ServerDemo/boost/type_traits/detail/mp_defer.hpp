...
struct mp_valid_impl
{
    ...
    static wjl_boost::true_type check_s(int);

    template<template<class...> class>
    static wjl_boost::false_type check_s(...);
...
template<template<class...> class F, class... T> using mp_defer = typename wjl_boost::conditional<mp_valid<F, T...>::value, mp_defer_impl<F, T...>, mp_empty>::type;
