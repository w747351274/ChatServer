...
template <class T> struct is_copy_constructible : public wjl_boost::is_constructible<T, const T&>{};
...
// wjl_boost::non_copyable as a base class as a special case:
//
...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost {
   ...
   namespace detail
   {
      ...
      template <class T, bool b> struct is_copy_constructible_imp : public wjl_boost::is_constructible<T, const T&>{};
      template <class T> struct is_copy_constructible_imp<T, true> : public false_type{};

   }

   template <class T> struct is_copy_constructible : public detail::is_copy_constructible_imp<T, is_base_and_derived<wjl_boost::noncopyable, T>::value>{};
...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost {
   ...
   namespace detail{
      ...
      struct is_copy_constructible_impl2 {
         ...
         template <class T1>
         static wjl_boost::type_traits::yes_type test(const T1&, wjl_boost::mpl::int_<sizeof(T1(wjl_boost::declval<const T1&>()))>* = 0);
#else
         template <class T1>
         static wjl_boost::type_traits::yes_type test(const T1&, decltype(T1(wjl_boost::declval<const T1&>()))* = 0);
#endif

         static wjl_boost::type_traits::no_type test(...);
#else
         template <class T1>
         static wjl_boost::type_traits::no_type test(const T1&, typename T1::boost_move_no_copy_constructor_or_assign* = 0);
         static wjl_boost::type_traits::yes_type test(...);
#endif
         ...
         //      struct T: private wjl_boost::noncopyable {
         //          ...
         //      private:
         //          T(const T &);
         //          ...
         ...
         BOOST_STATIC_CONSTANT(bool, value = (
            sizeof(test(
            wjl_boost::declval<BOOST_DEDUCED_TYPENAME wjl_boost::add_reference<T const>::type>()
            )) == sizeof(wjl_boost::type_traits::yes_type)
            &&
            !wjl_boost::is_rvalue_reference<T>::value
            && !wjl_boost::is_array<T>::value
            ));
      };
      ...
      struct is_copy_constructible_impl {
         ...
         BOOST_STATIC_CONSTANT(bool, value = (
            wjl_boost::detail::is_copy_constructible_impl2<
            wjl_boost::is_base_and_derived<wjl_boost::noncopyable, T>::value,
            T
            >::value
            ));
      };
   ...
   template <class T> struct is_copy_constructible : public integral_constant<bool, ::wjl_boost::detail::is_copy_constructible_impl<T>::value>{};
   template <> struct is_copy_constructible<void> : public false_type{};
