...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost { namespace serialization {
...
struct is_wrapper_impl :
    wjl_boost::mpl::eval_if<
      wjl_boost::is_base_and_derived<basic_traits,T>,
      wjl_boost::mpl::true_,
...
template<>                                              \
struct is_wrapper_impl<const T> : wjl_boost::mpl::true_ {}; \
}                                                       \
}                                                       \
/**/
