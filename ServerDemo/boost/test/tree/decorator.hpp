...
class base;
typedef wjl_boost::shared_ptr<base> base_ptr;
...
inline fixture_t
fixture( wjl_boost::function<void()> const& setup, wjl_boost::function<void()> const& teardown = wjl_boost::function<void()>() )
{
...
public:
    typedef wjl_boost::function<test_tools::assertion_result (test_unit_id)>   predicate_t;
