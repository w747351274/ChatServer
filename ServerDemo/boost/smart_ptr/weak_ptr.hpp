...
//
    ...
    weak_ptr( weak_ptr<Y> const & r, typename wjl_boost::detail::sp_enable_if_convertible<Y,T>::type = wjl_boost::detail::sp_empty() )
    ...
    weak_ptr( weak_ptr<Y> && r, typename wjl_boost::detail::sp_enable_if_convertible<Y,T>::type = wjl_boost::detail::sp_empty() )
...
#endif
    BOOST_SP_NOEXCEPT : px( r.lock().get() ), pn( static_cast< wjl_boost::detail::weak_count && >( r.pn ) )
    {
        wjl_boost::detail::sp_assert_convertible< Y, T >();
        r.px = 0;
    }
    ...
    weak_ptr( weak_ptr && r )
    BOOST_SP_NOEXCEPT : px( r.px ), pn( static_cast< wjl_boost::detail::weak_count && >( r.pn ) )
    {
        r.px = 0;
    }
    ...
    weak_ptr( shared_ptr<Y> const & r, typename wjl_boost::detail::sp_enable_if_convertible<Y,T>::type = wjl_boost::detail::sp_empty() )
    ...
    {
        return shared_ptr<T>( *this, wjl_boost::detail::sp_nothrow_tag() );
    }
...
private:
    ...
    wjl_boost::detail::weak_count pn; // reference counter
