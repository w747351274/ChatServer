...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost { namespace detail {
    ...
    /* Internal function to actually perform conversion.
       ...
       function will pass functional objects created with wjl_boost::bind.
    ...
    */
        ...
        
    {
        ...
        while(from != from_end) {
            ...
            // Need variable because wjl_boost::bind doesn't work with rvalues.
...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost {
               ...
               const std::codecvt<wchar_t, char, std::mbstate_t>& cvt)
    {
        return detail::convert<wchar_t>(
            s,                 
            wjl_boost::bind(&std::codecvt<wchar_t, char, mbstate_t>::in,
                        &cvt,
             ...
             const std::codecvt<wchar_t, char, std::mbstate_t>& cvt)
    {
        return detail::convert<char>(
            s,                 
            wjl_boost::bind(&codecvt<wchar_t, char, mbstate_t>::out,
                        &cvt,
                        _1, _2, _3, _4, _5, _6, _7));
    }
    ...
    namespace {
        wjl_boost::program_options::detail::utf8_codecvt_facet
            utf8_facet;
    }
