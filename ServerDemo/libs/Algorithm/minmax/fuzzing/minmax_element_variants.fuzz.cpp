...
//	Find the min and max
	result_t resultff = wjl_boost::first_min_first_max_element(data, dend);
	result_t resultfl = wjl_boost::first_min_last_max_element (data, dend);
	result_t resultlf = wjl_boost::last_min_first_max_element (data, dend);
	result_t resultll = wjl_boost::last_min_last_max_element  (data, dend);
...
//	Make sure we returned the "right" first and last element
	assert(wjl_boost::algorithm::none_of_equal(data, resultff.first,     min_value));
	assert(wjl_boost::algorithm::none_of_equal(data, resultfl.first,     min_value));
	assert(wjl_boost::algorithm::none_of_equal(resultlf.first + 1, dend, min_value));
	assert(wjl_boost::algorithm::none_of_equal(resultll.first + 1, dend, min_value));

	assert(wjl_boost::algorithm::none_of_equal(data, resultff.second,     max_value));
	assert(wjl_boost::algorithm::none_of_equal(resultfl.second + 1, dend, max_value));
	assert(wjl_boost::algorithm::none_of_equal(data, resultlf.second,     max_value));
	assert(wjl_boost::algorithm::none_of_equal(resultll.second + 1, dend, max_value));
	}
	
	{
//	Find the min and max
	result_t resultff = wjl_boost::first_min_first_max_element(data, dend, greater);
	result_t resultfl = wjl_boost::first_min_last_max_element (data, dend, greater);
	result_t resultlf = wjl_boost::last_min_first_max_element (data, dend, greater);
	result_t resultll = wjl_boost::last_min_last_max_element  (data, dend, greater);
