...
//	Find the min and max
	result_t result = wjl_boost::minmax_element(data, data + sz);
...
//	We returned the first min element, and the first max element
	assert(wjl_boost::algorithm::none_of_equal(data, result.first,  min_value));
	assert(wjl_boost::algorithm::none_of_equal(data, result.second, max_value));
	}
	
	{
//	Find the min and max
	result_t result = wjl_boost::minmax_element(data, data + sz, greater);
