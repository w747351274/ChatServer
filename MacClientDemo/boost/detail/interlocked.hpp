...
# define BOOST_INTERLOCKED_INCREMENT ::wjl_boost::detail::InterlockedIncrement
# define BOOST_INTERLOCKED_DECREMENT ::wjl_boost::detail::InterlockedDecrement
# define BOOST_INTERLOCKED_COMPARE_EXCHANGE ::wjl_boost::detail::InterlockedCompareExchange
# define BOOST_INTERLOCKED_EXCHANGE ::wjl_boost::detail::InterlockedExchange
# define BOOST_INTERLOCKED_EXCHANGE_ADD ::wjl_boost::detail::InterlockedExchangeAdd

# if defined(_M_IA64) || defined(_M_AMD64)
#  define BOOST_INTERLOCKED_COMPARE_EXCHANGE_POINTER ::wjl_boost::detail::InterlockedCompareExchangePointer
#  define BOOST_INTERLOCKED_EXCHANGE_POINTER ::wjl_boost::detail::InterlockedExchangePointer
# else
#  define BOOST_INTERLOCKED_COMPARE_EXCHANGE_POINTER(dest,exchange,compare) \
    ((void*)BOOST_INTERLOCKED_COMPARE_EXCHANGE((long volatile*)(dest),(long)(exchange),(long)(compare)))
#  define BOOST_INTERLOCKED_EXCHANGE_POINTER(dest,exchange) \
