...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost { namespace property_tree
{
    ...
    public:
        ...
        /** Equivalent to erase(wjl_boost::prior(end())). */
        void pop_back();
        ...
        /** Get the child at the given path, or return wjl_boost::null. */
        ...
        /** Take the value of this node and attempt to translate it to a
         * @c Type object using the supplied translator. Return wjl_boost::null if
         * this fails.
         */
        template<class Type, class Translator>
        ...
        /** Take the value of this node and attempt to translate it to a
         * @c Type object using the default translator. Return wjl_boost::null if
         * this fails.
         */
        template<class Type>
