...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost { namespace property_tree { namespace detail
{
    ...
    struct is_character : public wjl_boost::false_type {};
    template <>
    struct is_character<char> : public wjl_boost::true_type {};
    template <>
    struct is_character<wchar_t> : public wjl_boost::true_type {};


    BOOST_MPL_HAS_XXX_TRAIT_DEF(internal_type)
    BOOST_MPL_HAS_XXX_TRAIT_DEF(external_type)
    template <typename T>
    struct is_translator : public wjl_boost::mpl::and_<
