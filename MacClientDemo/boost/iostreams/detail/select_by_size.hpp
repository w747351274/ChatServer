...
//
//    using namespace wjl_boost::utility;
//
//    case_<0> helper(bool);
//    case_<1> helper(int);
...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost { namespace utility {
...
#define BOOST_SELECT_BY_SIZE(type_, name, expr) \
    ...
    BOOST_STATIC_CONSTANT( \
        type_, \
        name = \
            ( ::wjl_boost::iostreams::detail::select_by_size< \
