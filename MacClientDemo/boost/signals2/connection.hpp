/*
  wjl_boost::signals2::connection provides a handle to a signal/slot connection.
  ...
  namespace signals2
  {
    ...
    namespace detail
    {
      ...
      public:
        ...
        connection_body(const SlotType &slot_in, const wjl_boost::shared_ptr<mutex_type> &signal_mutex):
      ...
      private:
        mutable wjl_boost::shared_ptr<SlotType> m_slot;
        const wjl_boost::shared_ptr<mutex_type> _mutex;
        GroupKey _group_key;
      };
    }
    ...
    public:
      ...
      {}
      connection(const wjl_boost::weak_ptr<detail::connection_body_base> &connectionBody):
      ...
      {
        wjl_boost::shared_ptr<detail::connection_body_base> connectionBody(_weak_connection_body.lock());
      ...
      {
        wjl_boost::shared_ptr<detail::connection_body_base> connectionBody(_weak_connection_body.lock());
        wjl_boost::shared_ptr<detail::connection_body_base> otherConnectionBody(other._weak_connection_body.lock());
    ...
    protected:
      ...
      wjl_boost::weak_ptr<detail::connection_body_base> _weak_connection_body;
    };
