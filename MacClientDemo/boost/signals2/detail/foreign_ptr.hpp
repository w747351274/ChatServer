...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost
{
  ...
  namespace signals2
  {
    ...
    {};
    template<typename T> struct weak_ptr_traits<wjl_boost::weak_ptr<T> >
    {
      typedef wjl_boost::shared_ptr<T> shared_type;
    };
#ifndef BOOST_NO_CXX11_SMART_PTR
    ...
    template<typename T> struct shared_ptr_traits<wjl_boost::shared_ptr<T> >
    {
      typedef wjl_boost::weak_ptr<T> weak_type;
    };
#ifndef BOOST_NO_CXX11_SMART_PTR
    ...
    namespace detail
    {
      ...
      private:
        wjl_boost::scoped_ptr<foreign_weak_ptr_impl_base> _p;
      };
    } // namespace detail
