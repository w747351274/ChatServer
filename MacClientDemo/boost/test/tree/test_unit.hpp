...
//
/// @file
/// Defines @ref wjl_boost::unit_test::test_unit "test_unit", @ref wjl_boost::unit_test::test_case "test_case",
/// @ref wjl_boost::unit_test::test_suite "test_suite" and @ref wjl_boost::unit_test::master_test_suite_t "master_test_suite_t"
// ***************************************************************************
...
public:
    ...
    typedef wjl_boost::function<test_tools::assertion_result (test_unit_id)>    precondition_t;
...
public:
    ...
    // Constructor
    test_case( const_string tc_name, wjl_boost::function<void ()> const& test_func );
    test_case( const_string tc_name, const_string tc_file, std::size_t tc_line, wjl_boost::function<void ()> const& test_func );

    // Public property
    typedef BOOST_READONLY_PROPERTY(wjl_boost::function<void ()>,(test_case))  test_func;
...
public:
    ...
    /// @overload
    void            add( wjl_boost::shared_ptr<test_unit_generator> gen_ptr, decorator::collector& decorators );
...
protected:
    ...
    std::vector< std::pair<wjl_boost::shared_ptr<test_unit_generator>, std::vector<decorator::base_ptr> > > m_generators; /// lazy evaluation
};
...
public:
    ...
    friend master_test_suite_t& wjl_boost::unit_test::framework::master_test_suite();
};
...
inline test_case*
make_test_case( wjl_boost::function<void ()> const& test_func, const_string tc_name, const_string tc_file, std::size_t tc_line )
{
...
make_test_case( void (UserTestCase::*           test_method )(),
                ...
                std::size_t                     tc_line,
                wjl_boost::shared_ptr<InstanceType> user_test_case )
{
