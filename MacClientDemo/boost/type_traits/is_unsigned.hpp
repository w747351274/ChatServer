...
{
   BOOST_STATIC_CONSTANT(bool, value = (::wjl_boost::detail::is_unsigned_values<T>::minus_one > ::wjl_boost::detail::is_unsigned_values<T>::zero));
};
...
struct is_unsigned
{
   typedef ::wjl_boost::detail::is_unsigned_select_helper< ::wjl_boost::is_integral<T>::value || ::wjl_boost::is_enum<T>::value > selector;
...
template <class T> struct is_unsigned : public integral_constant<bool, wjl_boost::detail::is_unsigned<T>::value> {};
...
template <> struct is_unsigned< ::wjl_boost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const ::wjl_boost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<volatile ::wjl_boost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const volatile ::wjl_boost::ulong_long_type> : public true_type{};

template <> struct is_unsigned< ::wjl_boost::long_long_type> : public false_type{};
template <> struct is_unsigned<const ::wjl_boost::long_long_type> : public false_type{};
template <> struct is_unsigned<volatile ::wjl_boost::long_long_type> : public false_type{};
template <> struct is_unsigned<const volatile ::wjl_boost::long_long_type> : public false_type{};
#endif
#if defined(CHAR_MIN) 
#if CHAR_MIN == 0
