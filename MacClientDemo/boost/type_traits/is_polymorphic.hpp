...
{
   typedef is_polymorphic_selector< ::wjl_boost::is_class<T>::value> selector;
...
template <class T> struct is_polymorphic : public integral_constant<bool, ::wjl_boost::detail::is_polymorphic_imp<T>::value> {};
