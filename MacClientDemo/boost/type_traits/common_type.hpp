...
template<class T> struct common_type<T>: wjl_boost::decay<T>
{
   BOOST_STATIC_ASSERT_MSG(::wjl_boost::is_complete<T>::value || ::wjl_boost::is_void<T>::value || ::wjl_boost::is_array<T>::value, "Arguments to common_type must both be complete types");
};
...
template<class T1, class T2> using builtin_common_type = typename wjl_boost::decay<decltype( wjl_boost::declval<bool>()? wjl_boost::declval<T1>(): wjl_boost::declval<T2>() )>::type;
...
template<class T1, class T2> using builtin_common_type = decltype( wjl_boost::declval<bool>()? wjl_boost::declval<T1>(): wjl_boost::declval<T2>() );

template<class T1, class T2> struct common_type_impl_2: mp_defer<builtin_common_type, T1, T2>
{
};

template<class T1, class T2> using decay_common_type = typename wjl_boost::decay<typename common_type_impl_2<T1, T2>::type>::type;
...
template<class T1, class T2> struct common_type_impl: wjl_boost::decay<decltype( wjl_boost::declval<bool>()? wjl_boost::declval<T1>(): wjl_boost::declval<T2>() )>
{
};
...
template<class T1, class T2, class T1d = typename wjl_boost::decay<T1>::type, class T2d = typename wjl_boost::decay<T2>::type> struct common_type_decay_helper: wjl_boost::common_type<T1d, T2d>
{
};
...
{
   BOOST_STATIC_ASSERT_MSG(::wjl_boost::is_complete<T1>::value || ::wjl_boost::is_void<T1>::value || ::wjl_boost::is_array<T1>::value, "Arguments to common_type must both be complete types");
   BOOST_STATIC_ASSERT_MSG(::wjl_boost::is_complete<T2>::value || ::wjl_boost::is_void<T2>::value || ::wjl_boost::is_array<T2>::value, "Arguments to common_type must both be complete types");
};
