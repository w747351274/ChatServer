...
struct has_nothrow_copy_constructor_imp : public wjl_boost::integral_constant<bool, false>{};
template <class T>
struct has_nothrow_copy_constructor_imp<T, true> : public wjl_boost::integral_constant<bool, noexcept(T(wjl_boost::declval<const T&>()))>{};

}

template <class T> struct has_nothrow_copy_constructor : public detail::has_nothrow_copy_constructor_imp<T, wjl_boost::is_copy_constructible<T>::value>{};
...
template <class T> struct has_nothrow_copy_constructor : public integral_constant<bool, ::wjl_boost::has_trivial_copy<T>::value>{};
