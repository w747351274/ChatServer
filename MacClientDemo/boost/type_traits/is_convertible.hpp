...
#  define BOOST_TT_CXX11_IS_CONVERTIBLE
   ...
   template<typename From, typename To, bool b = or_helper<wjl_boost::is_void<From>, wjl_boost::is_function<To>, wjl_boost::is_array<To> >::value>
   ...
   class is_convertible_basic_impl<From, To, false>
   {
      ...
      static decltype(test_aux<To1>(wjl_boost::declval<From1>()), one()) test(int);
...
#pragma option push -w-8074
    ...
    {
        static ::wjl_boost::type_traits::no_type BOOST_TT_DECL _m_check(...);
        static ::wjl_boost::type_traits::yes_type BOOST_TT_DECL _m_check(T);
    };

    static typename add_lvalue_reference<From>::type  _m_from;
    static bool const value = sizeof( checker<To>::_m_check(_m_from) )
        == sizeof(::wjl_boost::type_traits::yes_type);
#pragma option pop
};
...
template <typename T> struct checker
{
    static wjl_boost::type_traits::no_type _m_check(any_conversion ...);
    static wjl_boost::type_traits::yes_type _m_check(T, int);
};
...
struct is_convertible_basic_impl
{
    ...
    static bool const value =
        sizeof( wjl_boost::detail::checker<To>::_m_check(static_cast<rvalue_type>(_m_from), 0) )
        == sizeof(::wjl_boost::type_traits::yes_type);
#else
    static bool const value =
        sizeof( wjl_boost::detail::checker<To>::_m_check(_m_from, 0) )
        == sizeof(::wjl_boost::type_traits::yes_type);
#endif
};
...
struct is_convertible_basic_impl
{
    static ::wjl_boost::type_traits::no_type BOOST_TT_DECL _m_check(any_conversion ...);
    static ::wjl_boost::type_traits::yes_type BOOST_TT_DECL _m_check(To, int);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type; 
    static lvalue_type _m_from;
    ...
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from), 0) ) == sizeof(::wjl_boost::type_traits::yes_type)
        );
#else
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from, 0) ) == sizeof(::wjl_boost::type_traits::yes_type)
        );
#endif
};
...
struct is_convertible_basic_impl
{
    ...
    template <class T>
    static ::wjl_boost::type_traits::no_type BOOST_TT_DECL _m_check(any_conversion,  float, T);
    static ::wjl_boost::type_traits::yes_type BOOST_TT_DECL _m_check(To, int, int);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type;
    static lvalue_type _m_from;
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    enum { value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from), 0, 0) ) == sizeof(::wjl_boost::type_traits::yes_type)
        };
#else
    enum { value =
        sizeof( _m_check(_m_from, 0, 0) ) == sizeof(::wjl_boost::type_traits::yes_type)
        };
#endif
};
...
{
    static ::wjl_boost::type_traits::no_type BOOST_TT_DECL _m_check(...);
    static ::wjl_boost::type_traits::yes_type BOOST_TT_DECL _m_check(To);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type;
    static lvalue_type _m_from;
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from)) ) == sizeof(::wjl_boost::type_traits::yes_type)
        );
#else
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from) ) == sizeof(::wjl_boost::type_traits::yes_type)
        );
#endif
};
...
struct is_convertible_basic_impl:
  is_convertible_basic_impl_aux<
    From,To,
    ::wjl_boost::is_function<typename ::wjl_boost::remove_reference<From>::type>::value
  >
{};
...
{
    enum { 
       value = ( ::wjl_boost::detail::is_convertible_basic_impl<From,To>::value && ! ::wjl_boost::is_array<To>::value && ! ::wjl_boost::is_function<To>::value) 
    };
};
...
struct is_convertible_impl
{
   BOOST_STATIC_CONSTANT(bool, value = ( ::wjl_boost::detail::is_convertible_basic_impl<From, To>::value && !::wjl_boost::is_array<To>::value && !::wjl_boost::is_function<To>::value));
};
#endif
...
struct is_convertible_impl_dispatch_base
{
   ...
   typedef is_convertible_impl_select< 
      ::wjl_boost::is_arithmetic<From>::value, 
      ::wjl_boost::is_arithmetic<To>::value,
      ...
      ::wjl_boost::is_abstract<To>::value
#else
      false
#endif
   > selector;
...
template <class From, class To> 
struct is_convertible : public integral_constant<bool, ::wjl_boost::detail::is_convertible_impl_dispatch<From, To>::value> 
{
   BOOST_STATIC_ASSERT_MSG(wjl_boost::is_complete<To>::value || wjl_boost::is_void<To>::value || wjl_boost::is_array<To>::value, "Destination argument type to is_convertible must be a complete type");
   BOOST_STATIC_ASSERT_MSG(wjl_boost::is_complete<From>::value || wjl_boost::is_void<From>::value || wjl_boost::is_array<From>::value, "From argument type to is_convertible must be a complete type");
};
...
struct is_convertible : public integral_constant<bool, BOOST_IS_CONVERTIBLE(From, To)> 
{
   ...
   BOOST_STATIC_ASSERT_MSG(wjl_boost::is_complete<From>::value || wjl_boost::is_void<From>::value || wjl_boost::is_array<From>::value || wjl_boost::is_reference<From>::value, "From argument type to is_convertible must be a complete type");
#endif
