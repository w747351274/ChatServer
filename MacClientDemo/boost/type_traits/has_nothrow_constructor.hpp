...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost { namespace detail{
   ...
   template <class T, bool b> struct has_nothrow_constructor_imp : public wjl_boost::integral_constant<bool, false>{};
   template <class T> struct has_nothrow_constructor_imp<T, true> : public wjl_boost::integral_constant<bool, noexcept(T())>{};
...
template <class T> struct has_nothrow_constructor : public ::wjl_boost::has_trivial_constructor<T> {};
