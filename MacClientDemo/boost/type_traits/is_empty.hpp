...
struct is_empty_impl
{
    ...
    BOOST_STATIC_CONSTANT(
        bool, 
        value = ( ::wjl_boost::detail::empty_helper<cvt,::wjl_boost::is_class<T>::value>::value || BOOST_INTERNAL_IS_EMPTY(cvt)));
};
...
struct is_empty_impl
{
   ...
   BOOST_STATIC_CONSTANT(
       bool, value = (
              ::wjl_boost::detail::empty_helper<
                  cvt
                , ::wjl_boost::is_class<T>::value
                , ::wjl_boost::is_convertible< r_type,int>::value
...
template <class T> struct is_empty : integral_constant<bool, ::wjl_boost::detail::is_empty_impl<T>::value> {};
