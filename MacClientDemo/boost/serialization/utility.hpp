...
inline void serialize(
    ...
    typedef typename wjl_boost::remove_const<F>::type typef;
    ar & wjl_boost::serialization::make_nvp("first", const_cast<typef &>(p.first));
    ar & wjl_boost::serialization::make_nvp("second", p.second);
}
