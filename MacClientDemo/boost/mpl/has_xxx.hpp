...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost { namespace mpl { namespace aux {
...
template< typename T, typename name = ::wjl_boost::mpl::aux::has_xxx_tag > \
struct BOOST_PP_CAT(trait,_impl) : T \
{ \
    static wjl_boost::mpl::aux::no_tag \
    test(void(*)(::wjl_boost::mpl::aux::has_xxx_tag)); \
    \
    static wjl_boost::mpl::aux::yes_tag test(...); \
    \
    BOOST_STATIC_CONSTANT(bool, value = \
          sizeof(test(static_cast<void(*)(name)>(0))) \
            != sizeof(wjl_boost::mpl::aux::no_tag) \
        ); \
    typedef wjl_boost::mpl::bool_<value> type; \
}; \
\
template< typename T, typename fallback_ = wjl_boost::mpl::bool_<default_> > \
struct trait \
    : wjl_boost::mpl::if_c< \
          wjl_boost::mpl::aux::msvc_is_incomplete<T>::value \
        , wjl_boost::mpl::bool_<false> \
...
{ \
    BOOST_STATIC_CONSTANT(bool, value = false); \
    typedef wjl_boost::mpl::bool_<false> type; \
}; \
/**/
...
{ \
    ...
    { \
        template < class U > \
        static int  resolve( wjl_boost::mpl::aux::type_wrapper<U> const volatile * \
                           , wjl_boost::mpl::aux::type_wrapper<typename U::name >* = 0 ); \
        static char resolve( ... ); \
    }; \
    typedef wjl_boost::mpl::aux::type_wrapper<T> t_; \
    BOOST_STATIC_CONSTANT( bool, value = ( sizeof( trait_tester_impl::resolve( static_cast< t_ * >(0) ) ) == sizeof(int) ) ); \
}; \
template< typename T, typename fallback_ = wjl_boost::mpl::bool_<default_> > \
struct trait           \
{                      \
    BOOST_STATIC_CONSTANT( bool, value = (trait_tester< T, wjl_boost::is_class< T >::value >::value) );     \
    typedef wjl_boost::mpl::bool_< trait< T, fallback_ >::value > type; \
};
...
{ \
    ...
    { \
        template< typename U > \
        static wjl_boost::mpl::aux::yes_tag test( \
              wjl_boost::mpl::aux::type_wrapper<U> const volatile* \
            , wjl_boost::mpl::aux::type_wrapper<BOOST_MSVC_TYPENAME U::name>* = 0 \
            ); \
    \
        static wjl_boost::mpl::aux::no_tag test(...); \
    }; \
    \
    typedef wjl_boost::mpl::aux::type_wrapper<T> t_; \
    BOOST_STATIC_CONSTANT(bool, value = \
          sizeof(gcc_3_2_wknd::test(static_cast<t_*>(0))) \
            == sizeof(wjl_boost::mpl::aux::yes_tag) \
        ); \
    typedef wjl_boost::mpl::bool_<value> type; \
}; \
/**/
...
#     define BOOST_MPL_HAS_MEMBER_MULTI_ACCEPT(z, n, args) \
        template< typename V > \
        static wjl_boost::mpl::aux::yes_tag \
        BOOST_MPL_HAS_MEMBER_INTROSPECTION_TEST_NAME(args)( \
            wjl_boost::mpl::aux::type_wrapper< V > const volatile* \
...
#       define BOOST_MPL_HAS_MEMBER_TEST(args) \
          sizeof( \
              BOOST_MPL_HAS_MEMBER_INTROSPECTION_TEST_NAME(args)( \
                  static_cast< wjl_boost::mpl::aux::type_wrapper< U >* >(0) \
              ) \
          ) == sizeof(wjl_boost::mpl::aux::yes_tag) \
        /**/
#     else
...
#   define BOOST_MPL_HAS_MEMBER_IMPLEMENTATION( \
      ...
      template< \
          typename T \
        , typename fallback_ \
              = wjl_boost::mpl::bool_< BOOST_PP_ARRAY_ELEM(3, args) > \
      > \
...
#   define BOOST_MPL_HAS_XXX_TEMPLATE_NAMED_DEF(trait, name, default_) \
      template< typename T \
              , typename fallback_ = wjl_boost::mpl::bool_< default_ > > \
      struct trait { \
          BOOST_STATIC_CONSTANT(bool, value = fallback_::value); \
          typedef fallback_ type; \
      }; \
