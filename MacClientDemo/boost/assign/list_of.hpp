...
namespace assign_detail
{
    ...
    struct assign_decay
    {
        ...
        typedef BOOST_DEDUCED_TYPENAME mpl::eval_if<
            ::wjl_boost::is_array<T>,
            ::wjl_boost::decay<const T>,
            ::wjl_boost::decay<T> >::type type;
    };
...
// old Dinkumware doesn't support iterator type as template
    ...
    {
        return ::wjl_boost::iterator_range_detail::equal( l, r );
    }
    ...
    inline bool operator<( const converter<T,I>& l, const Range& r )
    {
        return ::wjl_boost::iterator_range_detail::less_than( l, r );
    }
    ...
    {
        return Os << ::wjl_boost::make_iterator_range( r.begin(), r.end() );
    }
...
#include BOOST_PP_LOCAL_ITERATE()
        ...
        {
            return range( wjl_boost::begin(r), wjl_boost::end(r) );
        }
