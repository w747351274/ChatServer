...
{     wjl_boost::container::allocator_traits<Allocator>::construct(a, dest, *source);  }
...
{
   wjl_boost::container::allocator_traits<Allocator>::construct(a, dest);
}
...
{
   wjl_boost::container::allocator_traits<Allocator>::construct(a, dest, default_init);
}
