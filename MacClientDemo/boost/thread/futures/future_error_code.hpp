...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost
{
  ...
  {
    template <>
    struct BOOST_SYMBOL_VISIBLE is_error_code_enum< ::wjl_boost::future_errc> : public true_type {};

    #ifdef BOOST_NO_CXX11_SCOPED_ENUMS
    template <>
    struct BOOST_SYMBOL_VISIBLE is_error_code_enum< ::wjl_boost::future_errc::enum_type> : public true_type { };
    #endif
  } // system
  ...
  namespace system
  {
    ...
    {
        return error_code(underlying_cast<int>(e), wjl_boost::future_category());
    }
    ...
    {
        return error_condition(underlying_cast<int>(e), wjl_boost::future_category());
    }
  } // system
} // boost
