...
#define BOOST_THREAD_DEFINES_THREAD_ATTRIBUTES_NATIVE_HANDLE
    ...
    namespace detail
    {
        ...
        {
            wjl_boost::shared_ptr<wjl_boost::detail::tss_cleanup_function> func;
            void* value;

            tss_data_node(wjl_boost::shared_ptr<wjl_boost::detail::tss_cleanup_function> func_,
                          void* value_):
        ...
        typedef wjl_boost::shared_ptr<thread_data_base> thread_data_ptr;
            ...
            enable_shared_from_this<thread_data_base>
        {
            ...
            wjl_boost::mutex data_mutex;
            wjl_boost::condition_variable done_condition;
            bool done;
            bool join_started;
            bool joined;
            wjl_boost::detail::thread_exit_callback_node* thread_exit_callbacks;
            std::map<void const*,wjl_boost::detail::tss_data_node> tss_data;
