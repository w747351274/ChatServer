...
namespace gregorian {
  ...
  typedef wjl_boost::date_time::period_formatter<wchar_t> wperiod_formatter;
  typedef wjl_boost::date_time::period_formatter<char>    period_formatter;
  
  typedef wjl_boost::date_time::date_facet<date,wchar_t> wdate_facet;
  typedef wjl_boost::date_time::date_facet<date,char>    date_facet;

  typedef wjl_boost::date_time::period_parser<date,char>       period_parser;
  typedef wjl_boost::date_time::period_parser<date,wchar_t>    wperiod_parser;
    
  typedef wjl_boost::date_time::special_values_formatter<char> special_values_formatter; 
  typedef wjl_boost::date_time::special_values_formatter<wchar_t> wspecial_values_formatter; 
  
  typedef wjl_boost::date_time::special_values_parser<date,char> special_values_parser; 
  typedef wjl_boost::date_time::special_values_parser<date,wchar_t> wspecial_values_parser; 
  
  typedef wjl_boost::date_time::date_input_facet<date,char>    date_input_facet;
  typedef wjl_boost::date_time::date_input_facet<date,wchar_t> wdate_input_facet;

  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const wjl_boost::gregorian::date& d) {
    wjl_boost::io::ios_flags_saver iflags(os);
    typedef wjl_boost::date_time::date_facet<date, CharT> custom_date_facet;
  ...
  {
    wjl_boost::io::ios_flags_saver iflags(is);
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const wjl_boost::gregorian::date_duration& dd) {
    wjl_boost::io::ios_flags_saver iflags(os);
    typedef wjl_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const wjl_boost::gregorian::date_period& dp) {
    wjl_boost::io::ios_flags_saver iflags(os);
    typedef wjl_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const wjl_boost::gregorian::greg_month& gm) {
    wjl_boost::io::ios_flags_saver iflags(os);
    typedef wjl_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const wjl_boost::gregorian::greg_weekday& gw) {
    wjl_boost::io::ios_flags_saver iflags(os);
    typedef wjl_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const wjl_boost::gregorian::partial_date& pd) {
    wjl_boost::io::ios_flags_saver iflags(os);
    typedef wjl_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const wjl_boost::gregorian::nth_day_of_the_week_in_month& nkd) {
    wjl_boost::io::ios_flags_saver iflags(os);
    typedef wjl_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const wjl_boost::gregorian::first_day_of_the_week_in_month& fkd) {
    wjl_boost::io::ios_flags_saver iflags(os);
    typedef wjl_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const wjl_boost::gregorian::last_day_of_the_week_in_month& lkd) {
    wjl_boost::io::ios_flags_saver iflags(os);
    typedef wjl_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc()))
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const wjl_boost::gregorian::first_day_of_the_week_after& fda) {
    wjl_boost::io::ios_flags_saver iflags(os);
    typedef wjl_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc())) {
  ...
  template <class CharT, class TraitsT>
  inline std::basic_ostream<CharT, TraitsT>&
  operator<<(std::basic_ostream<CharT, TraitsT>& os, const wjl_boost::gregorian::first_day_of_the_week_before& fdb) {
    wjl_boost::io::ios_flags_saver iflags(os);
    typedef wjl_boost::date_time::date_facet<date, CharT> custom_date_facet;
    std::ostreambuf_iterator<CharT> output_itr(os);
    if (std::has_facet<custom_date_facet>(os.getloc())) {
