...
#define BOOST_DATE_TIME_HAS_NANOSECONDS
  typedef date_time::time_resolution_traits<wjl_boost::date_time::time_resolution_traits_adapted64_impl, wjl_boost::date_time::nano,
...
#undef  BOOST_DATE_TIME_HAS_NANOSECONDS
  typedef date_time::time_resolution_traits<
    wjl_boost::date_time::time_resolution_traits_adapted64_impl, wjl_boost::date_time::micro,
...
// #undef BOOST_DATE_TIME_HAS_NANOSECONDS
//   typedef date_time::time_resolution_traits<wjl_boost::int64_t, wjl_boost::date_time::tenth,
//                                              10, 0 > time_res_traits;
  ...
  public:
    ...
    time_duration(wjl_boost::date_time::special_values sv) :
...
#else
    BOOST_STATIC_CONSTANT(wjl_boost::int64_t, tick_per_second = 1000000000);
#endif
  };
  ...
  {
   public:
    typedef wjl_boost::int64_t time_rep_type;
...
#if (defined(BOOST_DATE_TIME_NO_MEMBER_INIT)) //help bad compilers
#else
    BOOST_STATIC_CONSTANT(wjl_boost::int64_t, tick_per_second = 1000000);
#endif
  };
