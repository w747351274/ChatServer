...
struct cast<void(T), Args>
{
    ...
    typedef typename wjl_boost::add_reference<
        typename wjl_boost::remove_const<type0>::type 
    >::type reference;
...
#  define BOOST_PARAMETER_FUNCTION_CAST(value, predicate, args) \
    wjl_boost::parameter::aux::cast<void predicate, args>::remove_const( \
        wjl_boost::parameter::aux::cast<void predicate, args>::execute(value) \
    )
