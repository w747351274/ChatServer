...
public:
  ...
  static IntType pow(IntType a, wjl_boost::uintmax_t exponent)
  {
      IntType result = 1;
      while(exponent != 0) {
          if(exponent % 2 == 1) {
...
private:
  ...
  static IntType mult_general(IntType a, IntType b)
  {
    ...
    if(::wjl_boost::uintmax_t(modulus) <=
        (::std::numeric_limits< ::wjl_boost::uintmax_t>::max)() / modulus)
    {
      return static_cast<IntType>(wjl_boost::uintmax_t(a) * b % modulus);
    } else {
