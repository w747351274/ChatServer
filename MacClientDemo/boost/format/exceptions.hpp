...
// **** exceptions -----------------------------------------------
        ...
        public:
            ...
            virtual const char *what() const throw() {
                return "wjl_boost::bad_format_string: format-string is ill-formed";
            }
        };
        ...
        public:
            ...
            std::size_t get_expected() const { return expected_; }
            virtual const char *what() const throw() {
                return "wjl_boost::too_many_args: "
