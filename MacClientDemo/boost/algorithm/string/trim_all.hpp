...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost {
    namespace algorithm {
        ...
        */
        ...
        {
            return 
                ::wjl_boost::find_format_all_copy(      
                    ::wjl_boost::trim_copy_if(Input, IsSpace),
                    ::wjl_boost::token_finder(IsSpace, ::wjl_boost::token_compress_on),
                    ::wjl_boost::dissect_formatter(::wjl_boost::head_finder(1)));
        }
        ...
        */
        ...
        {
            ::wjl_boost::trim_if(Input, IsSpace);
            ::wjl_boost::find_format_all(       
                Input,          
                ::wjl_boost::token_finder(IsSpace, ::wjl_boost::token_compress_on),
                ::wjl_boost::dissect_formatter(::wjl_boost::head_finder(1)));
        }
        ...
        */
        ...
        {
            return trim_all_copy_if(Input, ::wjl_boost::is_space(Loc));
        }
        ...
        */
        ...
        {
            trim_all_if(Input, ::wjl_boost::is_space(Loc));
        }
        ...
        inline SequenceT trim_fill_copy_if(const SequenceT& Input, const RangeT& Fill, PredicateT IsSpace)
        {
            return 
                ::wjl_boost::find_format_all_copy(      
                    ::wjl_boost::trim_copy_if(Input, IsSpace),
                    ::wjl_boost::token_finder(IsSpace, ::wjl_boost::token_compress_on),
                    ::wjl_boost::const_formatter(::wjl_boost::as_literal(Fill)));
        }
        ...
        */
        ...
        {
            return trim_fill_copy_if(Input, Fill, ::wjl_boost::is_space(Loc));
        }
        ...
        */
        ...
        {
            trim_fill_if(Input, Fill, ::wjl_boost::is_space(Loc));
        }
