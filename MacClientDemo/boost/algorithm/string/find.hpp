...
//  Generic find -----------------------------------------------//
        ...
        */
            ...
            const FinderT& Finder)
        {
            ...
            return Finder(::wjl_boost::begin(lit_input),::wjl_boost::end(lit_input));
        }
...
//  find_first  -----------------------------------------------//
        ...
        */
        ...
        {
            return ::wjl_boost::algorithm::find(Input, ::wjl_boost::algorithm::first_finder(Search));
        }
        ...
        */
        ...
        {
            return ::wjl_boost::algorithm::find(Input, ::wjl_boost::algorithm::first_finder(Search,is_iequal(Loc)));
        }
...
//  find_last  -----------------------------------------------//
        ...
        */
        ...
        find_last( 
            ...
            const Range2T& Search)
        {
            return ::wjl_boost::algorithm::find(Input, ::wjl_boost::algorithm::last_finder(Search));
        }
        ...
        */
        ...
        ifind_last( 
            ...
            const std::locale& Loc=std::locale())
        {
            return ::wjl_boost::algorithm::find(Input, ::wjl_boost::algorithm::last_finder(Search, is_iequal(Loc)));
        }
...
//  find_nth ----------------------------------------------------------------------//
        ...
        */
        ...
        find_nth( 
            ...
            int Nth)
        {
            return ::wjl_boost::algorithm::find(Input, ::wjl_boost::algorithm::nth_finder(Search,Nth));
        }
        ...
        */
        ...
        ifind_nth( 
            ...
            const std::locale& Loc=std::locale())
        {
            return ::wjl_boost::algorithm::find(Input, ::wjl_boost::algorithm::nth_finder(Search,Nth,is_iequal(Loc)));
        }
...
//  find_head ----------------------------------------------------------------------//
        ...
        */
        ...
        find_head( 
            ...
            int N)
        {
            return ::wjl_boost::algorithm::find(Input, ::wjl_boost::algorithm::head_finder(N));
        }
...
//  find_tail ----------------------------------------------------------------------//
        ...
        */
        ...
        find_tail( 
            ...
            int N)
        {
            return ::wjl_boost::algorithm::find(Input, ::wjl_boost::algorithm::tail_finder(N));
        }
...
//  find_token --------------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::wjl_boost::algorithm::find(Input, ::wjl_boost::algorithm::token_finder(Pred, eCompress));
        }
