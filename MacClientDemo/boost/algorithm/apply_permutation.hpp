...
{
    apply_permutation(wjl_boost::begin(item_range), wjl_boost::end(item_range),
                      wjl_boost::begin(ind_range), wjl_boost::end(ind_range));
}
...
{
    apply_reverse_permutation(wjl_boost::begin(item_range), wjl_boost::end(item_range),
                              wjl_boost::begin(ind_range), wjl_boost::end(ind_range));
}
