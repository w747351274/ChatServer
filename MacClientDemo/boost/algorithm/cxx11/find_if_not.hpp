...
BOOST_CXX14_CONSTEXPR typename wjl_boost::range_iterator<const Range>::type find_if_not ( const Range &r, Predicate p )
{
    return wjl_boost::algorithm::find_if_not (wjl_boost::begin (r), wjl_boost::end(r), p);
}
