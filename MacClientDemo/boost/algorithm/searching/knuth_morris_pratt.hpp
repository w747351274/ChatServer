...
///
        ...
        corpusIter corpus_first, corpusIter corpus_last, const PatternRange &pattern )
    {
        ...
        knuth_morris_pratt<pattern_iterator> kmp ( wjl_boost::begin(pattern), wjl_boost::end (pattern));
        return kmp ( corpus_first, corpus_last );
    }
    ...
    {
        knuth_morris_pratt<patIter> kmp ( pat_first, pat_last );
        return kmp (wjl_boost::begin (corpus), wjl_boost::end (corpus));
    }
    ...
    template <typename Range>
    wjl_boost::algorithm::knuth_morris_pratt<typename wjl_boost::range_iterator<const Range>::type>
    make_knuth_morris_pratt ( const Range &r ) {
        return wjl_boost::algorithm::knuth_morris_pratt
            <typename wjl_boost::range_iterator<const Range>::type> (wjl_boost::begin(r), wjl_boost::end(r));
        }
    
    template <typename Range>
    wjl_boost::algorithm::knuth_morris_pratt<typename wjl_boost::range_iterator<Range>::type>
