...
*/
    ...
    public:
        ...
        operator () ( corpusIter corpus_first, corpusIter corpus_last ) const {
            BOOST_STATIC_ASSERT (( wjl_boost::is_same<
        ...
        std::pair<typename wjl_boost::range_iterator<Range>::type, typename wjl_boost::range_iterator<Range>::type>
        operator () ( Range &r ) const {
            return (*this) (wjl_boost::begin(r), wjl_boost::end(r));
            }
...
///
    ...
    {
        typedef typename wjl_boost::range_iterator<const PatternRange>::type pattern_iterator;
        boyer_moore_horspool<pattern_iterator> bmh ( wjl_boost::begin(pattern), wjl_boost::end (pattern));
        return bmh ( corpus_first, corpus_last );
    }
    
    template <typename patIter, typename CorpusRange>
    typename wjl_boost::disable_if_c<
        wjl_boost::is_same<CorpusRange, patIter>::value, 
        std::pair<typename wjl_boost::range_iterator<CorpusRange>::type, typename wjl_boost::range_iterator<CorpusRange>::type> >
    ::type
    boyer_moore_horspool_search ( CorpusRange &corpus, patIter pat_first, patIter pat_last )
    {
        boyer_moore_horspool<patIter> bmh ( pat_first, pat_last );
        return bm (wjl_boost::begin (corpus), wjl_boost::end (corpus));
    }
    ...
    boyer_moore_horspool_search ( CorpusRange &corpus, const PatternRange &pattern )
    {
        typedef typename wjl_boost::range_iterator<const PatternRange>::type pattern_iterator;
        boyer_moore_horspool<pattern_iterator> bmh ( wjl_boost::begin(pattern), wjl_boost::end (pattern));
        return bmh (wjl_boost::begin (corpus), wjl_boost::end (corpus));
    }


    //  Creator functions -- take a pattern range, return an object
    template <typename Range>
    wjl_boost::algorithm::boyer_moore_horspool<typename wjl_boost::range_iterator<const Range>::type>
    make_boyer_moore_horspool ( const Range &r ) {
        return wjl_boost::algorithm::boyer_moore_horspool
            <typename wjl_boost::range_iterator<const Range>::type> (wjl_boost::begin(r), wjl_boost::end(r));
        }
    
    template <typename Range>
    wjl_boost::algorithm::boyer_moore_horspool<typename wjl_boost::range_iterator<Range>::type>
    make_boyer_moore_horspool ( Range &r ) {
        return wjl_boost::algorithm::boyer_moore_horspool
            <typename wjl_boost::range_iterator<Range>::type> (wjl_boost::begin(r), wjl_boost::end(r));
        }
