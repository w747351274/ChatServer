...
public:
   ...
   * Setting the option:
   * @code
   * wjl_boost::asio::ip::udp::socket socket(io_context); 
   * ...
   * wjl_boost::asio::socket_base::broadcast option(true);
   ...
   * wjl_boost::asio::ip::udp::socket socket(io_context); 
   * ...
   * wjl_boost::asio::socket_base::broadcast option;
   ...
   * ...
   * wjl_boost::asio::socket_base::debug option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * wjl_boost::asio::ip::tcp::socket socket(io_context); 
   * ...
   * wjl_boost::asio::socket_base::debug option;
   * socket.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
   ...
   * wjl_boost::asio::ip::udp::socket socket(io_context); 
   * ...
   * wjl_boost::asio::socket_base::do_not_route option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * wjl_boost::asio::ip::udp::socket socket(io_context); 
   * ...
   * wjl_boost::asio::socket_base::do_not_route option;
   * socket.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
   ...
   * wjl_boost::asio::ip::tcp::socket socket(io_context); 
   * ...
   * wjl_boost::asio::socket_base::keep_alive option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * wjl_boost::asio::ip::tcp::socket socket(io_context); 
   * ...
   * wjl_boost::asio::socket_base::keep_alive option;
   * socket.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
   ...
   * wjl_boost::asio::ip::tcp::socket socket(io_context); 
   * ...
   * wjl_boost::asio::socket_base::send_buffer_size option(8192);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * wjl_boost::asio::ip::tcp::socket socket(io_context); 
   * ...
   * wjl_boost::asio::socket_base::send_buffer_size option;
   * socket.get_option(option);
...
#else
  typedef wjl_boost::asio::detail::socket_option::integer<
   ...
   * wjl_boost::asio::ip::tcp::socket socket(io_context); 
   * ...
   * wjl_boost::asio::socket_base::send_low_watermark option(1024);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * wjl_boost::asio::ip::tcp::socket socket(io_context); 
   * ...
   * wjl_boost::asio::socket_base::send_low_watermark option;
   * socket.get_option(option);
   * int size = option.value();
   * @endcode
   *
   ...
   * wjl_boost::asio::ip::tcp::socket socket(io_context); 
   * ...
   * wjl_boost::asio::socket_base::receive_buffer_size option(8192);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * wjl_boost::asio::ip::tcp::socket socket(io_context); 
   * ...
   * wjl_boost::asio::socket_base::receive_buffer_size option;
   * socket.get_option(option);
   * int size = option.value();
   * @endcode
   *
   ...
   * wjl_boost::asio::ip::tcp::socket socket(io_context); 
   * ...
   * wjl_boost::asio::socket_base::receive_low_watermark option(1024);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * wjl_boost::asio::ip::tcp::socket socket(io_context); 
   * ...
   * wjl_boost::asio::socket_base::receive_low_watermark option;
   * socket.get_option(option);
   * int size = option.value();
   * @endcode
   *
   ...
   * ...
   * wjl_boost::asio::socket_base::reuse_address option(true);
   ...
   * wjl_boost::asio::ip::tcp::acceptor acceptor(io_context); 
   * ...
   * wjl_boost::asio::socket_base::reuse_address option;
   ...
   * wjl_boost::asio::ip::tcp::socket socket(io_context); 
   * ...
   * wjl_boost::asio::socket_base::linger option(true, 30);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * wjl_boost::asio::ip::tcp::socket socket(io_context); 
   * ...
   * wjl_boost::asio::socket_base::linger option;
   * socket.get_option(option);
...
#else
  typedef wjl_boost::asio::detail::socket_option::linger<
   ...
   * wjl_boost::asio::ip::tcp::socket socket(io_context);
   * ...
   * wjl_boost::asio::socket_base::out_of_band_inline option(true);
   * socket.set_option(option);
   * @endcode
   *
   * @par
   ...
   * wjl_boost::asio::ip::tcp::socket socket(io_context);
   * ...
   * wjl_boost::asio::socket_base::out_of_band_inline option;
   * socket.get_option(option);
   ...
   * operation is permitted to fail with wjl_boost::asio::error::connection_aborted.
   ...
   * wjl_boost::asio::ip::tcp::acceptor acceptor(io_context); 
   * ...
   * wjl_boost::asio::socket_base::enable_connection_aborted option(true);
   * acceptor.set_option(option);
   * @endcode
   *
   * @par
   ...
   * wjl_boost::asio::ip::tcp::acceptor acceptor(io_context); 
   * ...
   * wjl_boost::asio::socket_base::enable_connection_aborted option;
   * acceptor.get_option(option);
   * bool is_set = option.value();
   * @endcode
   *
  ...
  typedef wjl_boost::asio::detail::socket_option::boolean<
    ...
    wjl_boost::asio::detail::enable_connection_aborted_option>
   ...
   * wjl_boost::asio::ip::tcp::socket socket(io_context); 
   * ...
   * wjl_boost::asio::socket_base::bytes_readable command(true);
...
#else
  typedef wjl_boost::asio::detail::io_control::bytes_readable bytes_readable;
#endif
