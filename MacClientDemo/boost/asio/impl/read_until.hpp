    ...
    BOOST_ASIO_MOVE_ARG(DynamicBuffer) buffers, char delim)
{
  ...
  wjl_boost::asio::detail::throw_error(ec, "read_until");
    ...
    const wjl_boost::regex& expr, wjl_boost::system::error_code& ec)
{
  ...
  for (;;)
  {
    ...
    // Look for a match.
    wjl_boost::match_results<iterator,
      typename std::vector<wjl_boost::sub_match<iterator> >::allocator_type>
        match_results;
    if (regex_search(start_pos, end, match_results, expr,
          wjl_boost::match_default | wjl_boost::match_partial))
    {
...
namespace detail
{
  ...
  public:
    ...
    void operator()(const wjl_boost::system::error_code& ec,
        std::size_t bytes_transferred, int start = 0)
    {
      ...
      case 1:
        ...
        const wjl_boost::system::error_code result_ec =
          (search_position_ == not_found)
          ? error::not_found : ec;
        ...
        DynamicBuffer, ReadHandler>* this_handler)
  {
    return this_handler->start_ == 0 ? true
      : wjl_boost_asio_handler_cont_helpers::is_continuation(
      ...
      BOOST_ASIO_HANDLER_TYPE(ReadHandler,
        void (wjl_boost::system::error_code, std::size_t))>(
          s, BOOST_ASIO_MOVE_CAST(DynamicBuffer)(buffers),
            delim, init.completion_handler)(wjl_boost::system::error_code(), 0, 1);
        ...
        void (wjl_boost::system::error_code, std::size_t))>(
          s, BOOST_ASIO_MOVE_CAST(DynamicBuffer)(buffers),
            static_cast<std::string>(delim),
              init.completion_handler)(wjl_boost::system::error_code(), 0, 1);
...
namespace detail
{
  ...
  public:
    ...
    read_until_expr_op(AsyncReadStream& stream,
        BOOST_ASIO_MOVE_ARG(BufferSequence) buffers,
        const wjl_boost::regex& expr, ReadHandler& handler)
      : stream_(stream),
        buffers_(BOOST_ASIO_MOVE_CAST(BufferSequence)(buffers)),
        expr_(expr),
        start_(0),
    ...
    BOOST_ASIO_MOVE_ARG(ReadHandler) handler)
{
  ...
  detail::read_until_expr_op<AsyncReadStream,
    typename decay<DynamicBuffer>::type,
      wjl_boost::regex, BOOST_ASIO_HANDLER_TYPE(ReadHandler,
        void (wjl_boost::system::error_code, std::size_t))>(
          s, BOOST_ASIO_MOVE_CAST(DynamicBuffer)(buffers),
            expr, init.completion_handler)(wjl_boost::system::error_code(), 0, 1);
        ...
        void (wjl_boost::system::error_code, std::size_t))>(
          s, BOOST_ASIO_MOVE_CAST(DynamicBuffer)(buffers),
            match_condition, init.completion_handler)(
              wjl_boost::system::error_code(), 0, 1);
