...
public:
   ...
   */
  explicit basic_stream_socket(wjl_boost::asio::io_context& io_context)
   ...
   */
  basic_stream_socket(wjl_boost::asio::io_context& io_context,
   ...
   * @code
   * socket.send(wjl_boost::asio::buffer(data, size));
   * @endcode
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.send(wjl_boost::asio::buffer(data, size), 0);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, wjl_boost::array or
   * std::vector.
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_send(wjl_boost::asio::buffer(data, size), 0, handler);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, wjl_boost::array or
   * std::vector.
   ...
   * follows:
   * @code
   * socket.receive(wjl_boost::asio::buffer(data, size));
   * @endcode
   ...
   * follows:
   * @code
   * socket.receive(wjl_boost::asio::buffer(data, size), 0);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, wjl_boost::array or
   * std::vector.
   ...
   * follows:
   * @code
   * socket.async_receive(wjl_boost::asio::buffer(data, size), 0, handler);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, wjl_boost::array or
   * std::vector.
   ...
   * @code
   * socket.write_some(wjl_boost::asio::buffer(data, size));
   * @endcode
   ...
   * To write a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_write_some(wjl_boost::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on writing multiple
   * buffers in one go, and how to use it with arrays, wjl_boost::array or
   * std::vector.
   ...
   * @code
   * socket.read_some(wjl_boost::asio::buffer(data, size));
   * @endcode
   ...
   * To read into a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_read_some(wjl_boost::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on reading into multiple
   * buffers in one go, and how to use it with arrays, wjl_boost::array or
   * std::vector.
