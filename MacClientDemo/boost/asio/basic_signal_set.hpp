 ...
 *
 * Most applications will use the wjl_boost::asio::signal_set typedef.
 *
 * @par Thread Safety
 ...
 * wjl_boost::asio::signal_set signals(io_context, SIGINT, SIGTERM);
 *
...
public:
   ...
   */
  explicit basic_signal_set(wjl_boost::asio::io_context& io_context)
   ...
   * @code wjl_boost::asio::signal_set signals(io_context);
   * signals.add(signal_number_1); @endcode
   */
  basic_signal_set(wjl_boost::asio::io_context& io_context, int signal_number_1)
    : basic_io_object<SignalSetService>(io_context)
  {
    wjl_boost::system::error_code ec;
    this->get_service().add(this->get_implementation(), signal_number_1, ec);
    wjl_boost::asio::detail::throw_error(ec, "add");
  }
   ...
   */
  BOOST_ASIO_SYNC_OP_VOID add(int signal_number, wjl_boost::system::error_code& ec)
  {
    this->get_service().add(this->get_implementation(), signal_number, ec);
  ...
  void remove(int signal_number)
  {
    ...
    wjl_boost::asio::detail::throw_error(ec, "remove");
  }
  ...
  void clear()
  {
    ...
    wjl_boost::asio::detail::throw_error(ec, "clear");
  }
   ...
   * @note Removes all queued notifications.
   */
  BOOST_ASIO_SYNC_OP_VOID clear(wjl_boost::system::error_code& ec)
  {
    this->get_service().clear(this->get_implementation(), ec);
    BOOST_ASIO_SYNC_OP_VOID_RETURN(ec);
  }
   ...
   * operation will be invoked with the wjl_boost::asio::error::operation_aborted
   * error code.
   *
   ...
   * error code wjl_boost::asio::error::operation_aborted.
   *
