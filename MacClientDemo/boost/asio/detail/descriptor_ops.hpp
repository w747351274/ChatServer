...
BOOST_ASIO_DECL int fcntl(int d, int cmd, wjl_boost::system::error_code& ec);

BOOST_ASIO_DECL int fcntl(int d, int cmd,
    long arg, wjl_boost::system::error_code& ec);

BOOST_ASIO_DECL int poll_read(int d,
    state_type state, wjl_boost::system::error_code& ec);
