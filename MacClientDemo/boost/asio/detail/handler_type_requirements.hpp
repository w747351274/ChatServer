...
#define BOOST_ASIO_LEGACY_COMPLETION_HANDLER_CHECK( \
  ...
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(wjl_boost::asio::detail::zero_arg_copyable_handler_test( \
          wjl_boost::asio::detail::clvref< \
            asio_true_handler_type>(), 0)) == 1, \
      "CompletionHandler type requirements not met") \
  \
  typedef wjl_boost::asio::detail::handler_type_requirements< \
      sizeof( \
        wjl_boost::asio::detail::argbyv( \
          wjl_boost::asio::detail::clvref< \
            asio_true_handler_type>())) + \
      sizeof( \
        wjl_boost::asio::detail::lvref< \
          asio_true_handler_type>()(), \
...
#define BOOST_ASIO_READ_HANDLER_CHECK( \
  ...
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(wjl_boost::asio::detail::two_arg_handler_test( \
          wjl_boost::asio::detail::rvref< \
            asio_true_handler_type>(), \
  ...
  typedef wjl_boost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        wjl_boost::asio::detail::lvref< \
          asio_true_handler_type>()( \
            wjl_boost::asio::detail::lvref<const wjl_boost::system::error_code>(), \
            wjl_boost::asio::detail::lvref<const std::size_t>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
...
#define BOOST_ASIO_ACCEPT_HANDLER_CHECK( \
  ...
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(wjl_boost::asio::detail::one_arg_handler_test( \
          wjl_boost::asio::detail::rvref< \
            asio_true_handler_type>(), \
          static_cast<const wjl_boost::system::error_code*>(0))) == 1, \
...
#define BOOST_ASIO_MOVE_ACCEPT_HANDLER_CHECK( \
  ...
  \
  typedef BOOST_ASIO_HANDLER_TYPE(handler_type, \
      void(wjl_boost::system::error_code, socket_type)) \
    asio_true_handler_type; \
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(wjl_boost::asio::detail::two_arg_move_handler_test( \
          wjl_boost::asio::detail::rvref< \
            asio_true_handler_type>(), \
          static_cast<const wjl_boost::system::error_code*>(0), \
  ...
  typedef wjl_boost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        wjl_boost::asio::detail::lvref< \
          asio_true_handler_type>()( \
            wjl_boost::asio::detail::lvref<const wjl_boost::system::error_code>(), \
            wjl_boost::asio::detail::rvref<socket_type>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
...
#define BOOST_ASIO_RANGE_CONNECT_HANDLER_CHECK( \
  ...
  \
  typedef BOOST_ASIO_HANDLER_TYPE(handler_type, \
      void(wjl_boost::system::error_code, endpoint_type)) \
    asio_true_handler_type; \
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(wjl_boost::asio::detail::two_arg_handler_test( \
  ...
  typedef wjl_boost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        wjl_boost::asio::detail::lvref< \
          asio_true_handler_type>()( \
            wjl_boost::asio::detail::lvref<const wjl_boost::system::error_code>(), \
            wjl_boost::asio::detail::lvref<const endpoint_type>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
...
#define BOOST_ASIO_ITERATOR_CONNECT_HANDLER_CHECK( \
  ...
  \
  typedef BOOST_ASIO_HANDLER_TYPE(handler_type, \
      void(wjl_boost::system::error_code, iter_type)) \
    asio_true_handler_type; \
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(wjl_boost::asio::detail::two_arg_handler_test( \
  ...
  typedef wjl_boost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        wjl_boost::asio::detail::lvref< \
          asio_true_handler_type>()( \
            wjl_boost::asio::detail::lvref<const wjl_boost::system::error_code>(), \
            wjl_boost::asio::detail::lvref<const iter_type>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
...
#define BOOST_ASIO_RESOLVE_HANDLER_CHECK( \
  ...
  \
  typedef BOOST_ASIO_HANDLER_TYPE(handler_type, \
      void(wjl_boost::system::error_code, range_type)) \
    asio_true_handler_type; \
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(wjl_boost::asio::detail::two_arg_handler_test( \
  ...
  typedef wjl_boost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        wjl_boost::asio::detail::lvref< \
          asio_true_handler_type>()( \
            wjl_boost::asio::detail::lvref<const wjl_boost::system::error_code>(), \
            wjl_boost::asio::detail::lvref<const range_type>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
...
#define BOOST_ASIO_SIGNAL_HANDLER_CHECK( \
  ...
  \
  typedef BOOST_ASIO_HANDLER_TYPE(handler_type, \
      void(wjl_boost::system::error_code, int)) \
    asio_true_handler_type; \
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(wjl_boost::asio::detail::two_arg_handler_test( \
  ...
  typedef wjl_boost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        wjl_boost::asio::detail::lvref< \
          asio_true_handler_type>()( \
            wjl_boost::asio::detail::lvref<const wjl_boost::system::error_code>(), \
            wjl_boost::asio::detail::lvref<const int>()), \
        char(0))> BOOST_ASIO_UNUSED_TYPEDEF
