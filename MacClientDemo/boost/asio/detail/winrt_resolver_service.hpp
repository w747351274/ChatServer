...
public:
  ...
  // The query type.
  typedef wjl_boost::asio::ip::basic_resolver_query<Protocol> query_type;

  // The results type.
  typedef wjl_boost::asio::ip::basic_resolver_results<Protocol> results_type;

  // Constructor.
  winrt_resolver_service(wjl_boost::asio::io_context& io_context)
  ...
  void notify_fork(wjl_boost::asio::io_context::fork_event)
  {
  }
  ...
  results_type resolve(implementation_type&,
      const query_type& query, wjl_boost::system::error_code& ec)
  {
    try
    {
      ...
      const query_type& query, Handler& handler)
  {
    ...
    {
      p.p->ec_ = wjl_boost::system::error_code(
