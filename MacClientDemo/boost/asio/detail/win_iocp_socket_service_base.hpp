...
public:
  ...
  BOOST_ASIO_DECL wjl_boost::system::error_code cancel(
      base_implementation_type& impl, wjl_boost::system::error_code& ec);
  ...
  wjl_boost::system::error_code listen(base_implementation_type& impl,
  ...
  wjl_boost::system::error_code io_control(base_implementation_type& impl,
      IO_Control_Command& command, wjl_boost::system::error_code& ec)
  {
  ...
  wjl_boost::system::error_code non_blocking(base_implementation_type& impl,
  ...
  wjl_boost::system::error_code native_non_blocking(base_implementation_type& impl,
      bool mode, wjl_boost::system::error_code& ec)
  {
  ...
  wjl_boost::system::error_code wait(base_implementation_type& impl,
      socket_base::wait_type w, wjl_boost::system::error_code& ec)
  {
    switch (w)
    {
      ...
      socket_base::wait_type w, Handler& handler)
  {
    ...
    switch (w)
    {
      ...
      case socket_base::wait_error:
        ...
        break;
      default:
        p.p->ec_ = wjl_boost::asio::error::invalid_argument;
  ...
  size_t receive_with_flags(base_implementation_type& impl,
      ...
      socket_base::message_flags& out_flags, wjl_boost::system::error_code& ec)
  {
    buffer_sequence_adapter<wjl_boost::asio::mutable_buffer,
        MutableBufferSequence> bufs(buffers);
...
protected:
  ...
  BOOST_ASIO_DECL wjl_boost::system::error_code do_open(
      base_implementation_type& impl, int family, int type,
      int protocol, wjl_boost::system::error_code& ec);

  // Assign a native socket to a socket implementation.
  BOOST_ASIO_DECL wjl_boost::system::error_code do_assign(
      base_implementation_type& impl, int type,
      socket_type native_socket, wjl_boost::system::error_code& ec);
