...
struct handler_tracking_timestamp
{
  ...
  {
#if defined(BOOST_ASIO_HAS_BOOST_DATE_TIME)
    wjl_boost::posix_time::ptime epoch(wjl_boost::gregorian::date(1970, 1, 1));
    wjl_boost::posix_time::time_duration now =
      wjl_boost::posix_time::microsec_clock::universal_time() - epoch;
#elif defined(BOOST_ASIO_HAS_CHRONO)
    typedef chrono_time_traits<chrono::system_clock,
        wjl_boost::asio::wait_traits<chrono::system_clock> > traits_helper;
