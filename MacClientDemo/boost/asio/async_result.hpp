...
struct async_completion
{
  ...
  typedef typename wjl_boost::asio::async_result<
...
# define BOOST_ASIO_INITFN_RESULT_TYPE(ct, sig) \
  typename ::wjl_boost::asio::detail::async_result_helper< \
    ct, sig>::return_type
...
#else
# define BOOST_ASIO_INITFN_RESULT_TYPE(ct, sig) \
  typename ::wjl_boost::asio::async_result< \
    typename ::wjl_boost::asio::decay<ct>::type, sig>::return_type
#define BOOST_ASIO_HANDLER_TYPE(ct, sig) \
  typename ::wjl_boost::asio::async_result< \
    typename ::wjl_boost::asio::decay<ct>::type, sig>::completion_handler_type
#endif
