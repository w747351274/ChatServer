...
public:
   ...
   */
  explicit basic_stream_handle(wjl_boost::asio::io_context& io_context)
   ...
   */
  basic_stream_handle(wjl_boost::asio::io_context& io_context,
   ...
   * @code
   * handle.write_some(wjl_boost::asio::buffer(data, size));
   * @endcode
   ...
   * To write a single data buffer use the @ref buffer function as follows:
   * @code
   * handle.async_write_some(wjl_boost::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on writing multiple
   * buffers in one go, and how to use it with arrays, wjl_boost::array or
   * std::vector.
   ...
   * @code
   * handle.read_some(wjl_boost::asio::buffer(data, size));
   * @endcode
   ...
   * To read into a single data buffer use the @ref buffer function as follows:
   * @code
   * handle.async_read_some(wjl_boost::asio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on reading into multiple
   * buffers in one go, and how to use it with arrays, wjl_boost::array or
   * std::vector.
