...
#else
  : public wjl_boost::asio::detail::service_base<stream_descriptor_service>
#endif
{
public:
#if defined(GENERATING_DOCUMENTATION)
...
public:
  ...
  explicit stream_descriptor_service(wjl_boost::asio::io_context& io_context)
    : wjl_boost::asio::detail::service_base<stream_descriptor_service>(io_context),
  ...
  BOOST_ASIO_SYNC_OP_VOID wait(implementation_type& impl,
      descriptor_base::wait_type w, wjl_boost::system::error_code& ec)
  {
