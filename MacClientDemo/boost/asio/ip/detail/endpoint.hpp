...
public:
  ...
  BOOST_ASIO_DECL endpoint(const wjl_boost::asio::ip::address& addr,
  ...
  wjl_boost::asio::detail::socket_addr_type* data()
  {
    return &data_.base;
  }

  // Get the underlying endpoint in the native type.
  const wjl_boost::asio::detail::socket_addr_type* data() const
  {
    return &data_.base;
  }
  ...
  {
    if (is_v4())
      return sizeof(wjl_boost::asio::detail::sockaddr_in4_type);
    else
      return sizeof(wjl_boost::asio::detail::sockaddr_in6_type);
  }
  ...
  BOOST_ASIO_DECL wjl_boost::asio::ip::address address() const;

  // Set the IP address associated with the endpoint.
  BOOST_ASIO_DECL void address(const wjl_boost::asio::ip::address& addr);
...
private:
  ...
  union data_union
  {
    wjl_boost::asio::detail::socket_addr_type base;
    wjl_boost::asio::detail::sockaddr_in4_type v4;
    wjl_boost::asio::detail::sockaddr_in6_type v6;
  } data_;
};
