 ...
 * wjl_boost::asio::streambuf::mutable_buffers_type bufs = b.prepare(512);
 *
...
public:
  ...
  {
    return wjl_boost::asio::buffer(wjl_boost::asio::const_buffer(gptr(),
  ...
  {
    reserve(n);
    return wjl_boost::asio::buffer(wjl_boost::asio::mutable_buffer(
...
protected:
  ...
  void reserve(std::size_t n)
  {
    ...
    if (n > pend - pnext)
    {
      ...
      {
        std::length_error ex("wjl_boost::asio::streambuf too long");
