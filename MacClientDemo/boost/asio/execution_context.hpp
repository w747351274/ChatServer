...
public:
   ...
   *
   * @throws wjl_boost::system::system_error Thrown on failure. If the notification
   ...
   * constructor.
   *
   * @throws wjl_boost::asio::service_already_exists Thrown if a service of the
...
#undef BOOST_ASIO_PRIVATE_MAKE_SERVICE_DEF
   ...
   * given type is already present in the execution_context.
   *
   * @throws wjl_boost::asio::invalid_service_owner Thrown if the service's owning
...
private:
  ...
  wjl_boost::asio::detail::service_registry* service_registry_;
};
...
private:
  ...
  friend class wjl_boost::asio::detail::service_registry;
  struct key
  {
