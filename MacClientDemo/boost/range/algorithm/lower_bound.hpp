...
lower_bound( ForwardRange& rng, Value val )
{
    ...
    return std::lower_bound(wjl_boost::begin(rng), wjl_boost::end(rng), val);
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<ForwardRange> ));
    return std::lower_bound(wjl_boost::begin(rng), wjl_boost::end(rng), val, pred);
}
...
lower_bound( ForwardRange& rng, Value val )
{
    ...
    return range_return<ForwardRange,re>::
        pack(std::lower_bound(wjl_boost::begin(rng), wjl_boost::end(rng), val),
             rng);
}
...
lower_bound( ForwardRange& rng, Value val, SortPredicate pred )
{
    BOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<ForwardRange> ));
    return range_return<ForwardRange,re>::
        pack(std::lower_bound(wjl_boost::begin(rng), wjl_boost::end(rng), val, pred),
             rng);
}
