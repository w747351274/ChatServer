...
inline std::pair<
        BOOST_DEDUCED_TYPENAME wjl_boost::range_iterator<ForwardRange>::type,
        BOOST_DEDUCED_TYPENAME wjl_boost::range_iterator<ForwardRange>::type
       >
equal_range(ForwardRange& rng, const Value& val)
{
    BOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<ForwardRange> ));
    return std::equal_range(wjl_boost::begin(rng), wjl_boost::end(rng), val);
}

/// \overload
template<class ForwardRange, class Value>
inline std::pair<
        BOOST_DEDUCED_TYPENAME wjl_boost::range_iterator<const ForwardRange>::type,
        BOOST_DEDUCED_TYPENAME wjl_boost::range_iterator<const ForwardRange>::type
       >
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<ForwardRange> ));
    return std::equal_range(wjl_boost::begin(rng), wjl_boost::end(rng), val, pred);
}
