    ...
    namespace range_detail
    {
        ...
        public:
            ...
            replaced_if_range( R& r, const Pred& pred, value_type to )
                : base_t( make_transform_iterator( wjl_boost::begin(r), Fn(pred, to) ),
                          make_transform_iterator( wjl_boost::end(r), Fn(pred, to) ) )
            { }
        };
