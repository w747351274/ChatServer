...
struct formatted_holder
{
    typedef typename wjl_boost::mpl::if_<
        wjl_boost::is_array<Sep>,
        const typename wjl_boost::remove_extent<Sep>::type*,
        Sep
    >::type separator_t;

    typedef typename wjl_boost::mpl::if_<
        wjl_boost::is_array<Prefix>,
        const typename wjl_boost::remove_extent<Prefix>::type*,
        Prefix
    >::type prefix_t;

    typedef typename wjl_boost::mpl::if_<
        wjl_boost::is_array<Postfix>,
        const typename wjl_boost::remove_extent<Postfix>::type*,
        Postfix
    >::type postfix_t;
...
)
{
    ...
    return range_detail::formatted_range<iterator, Sep, Prefix, Postfix>(
        wjl_boost::begin(rng), wjl_boost::end(rng), holder);
}
...
template<typename SinglePassRange, typename Sep, typename Prefix,
         typename Postfix>
inline wjl_boost::range_detail::formatted_range<
    typename wjl_boost::range_iterator<const SinglePassRange>::type,
    Sep, Prefix, Postfix
>
format(
    const SinglePassRange& rng,
...
{
    typedef typename wjl_boost::range_iterator<const SinglePassRange>::type
                iterator_t;

    typedef wjl_boost::range_detail::formatted_range<
                iterator_t, Sep, Prefix, Postfix>       result_t;

    typedef wjl_boost::range_detail::formatted_holder<Sep, Prefix, Postfix>
                holder_t;

    return result_t(wjl_boost::begin(rng), wjl_boost::end(rng),
...
format(const SinglePassRange& rng)
{
    ...
    namespace range
    {
        using wjl_boost::range_detail::formatted_range;
    } // namespace range
} // namespace wjl_boost
