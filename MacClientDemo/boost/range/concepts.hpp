...
// during the search for black listed compilers.
    ...
    #define BOOST_RANGE_CONCEPT_ASSERT( x )
        ...
        // use case is the combination of the wjl_boost::adaptors::filtered
        // class with a wjl_boost::lambda::bind generated functor.
            ...
            , EqualityComparable<Iterator>
        {
            ...
            {
                Iterator i2(++i);
                wjl_boost::ignore_unused_variable_warning(i2);
                ...
                wjl_boost::ignore_unused_variable_warning(r1);

                BOOST_DEDUCED_TYPENAME std::iterator_traits<Iterator>::reference r2(*(++i));
                wjl_boost::ignore_unused_variable_warning(r2);
            }
        private:
            Iterator i;
#endif
    ...
    struct SinglePassRangeConcept
    {
        ...
        BOOST_CONCEPT_USAGE(SinglePassRangeConcept)
        {
            ...
            iterator i1 = wjl_boost::begin(*m_range);
            iterator i2 = wjl_boost::end(*m_range);

            wjl_boost::ignore_unused_variable_warning(i1);
            wjl_boost::ignore_unused_variable_warning(i2);
    ...
    private:
        ...
        {
            const_iterator ci1 = wjl_boost::begin(const_range);
            const_iterator ci2 = wjl_boost::end(const_range);

            wjl_boost::ignore_unused_variable_warning(ci1);
            wjl_boost::ignore_unused_variable_warning(ci2);
        }
