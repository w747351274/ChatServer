...
struct substitute<
      ::wjl_boost::variant<
        ...
        >
    , RecursiveVariant
    , ::wjl_boost::recursive_variant_
      BOOST_MPL_AUX_LAMBDA_ARITY_PARAM(Arity)
    >
{
    typedef ::wjl_boost::variant<
          recursive_flag< T0 >
        , BOOST_VARIANT_ENUM_SHIFTED_PARAMS(T)
        > type;
};
...
struct substitute<
      ::wjl_boost::variant<
          ::wjl_boost::detail::variant::over_sequence< T0 >
        , BOOST_VARIANT_ENUM_SHIFTED_PARAMS(T)
        >
    , RecursiveVariant
    , ::wjl_boost::recursive_variant_
...
public:
    ...
    typedef typename mpl::if_<
          mpl::equal<initial_types, types, ::wjl_boost::is_same<mpl::_1, mpl::_2> >
        , ::wjl_boost::variant<
              ::wjl_boost::detail::variant::over_sequence< T0 >
            , BOOST_VARIANT_ENUM_SHIFTED_PARAMS(T)
            >
        , ::wjl_boost::variant< over_sequence<types> >
        >::type type;
};
...
template <
    ...
    >
struct substitute<
      ::wjl_boost::variant< BOOST_VARIANT_ENUM_PARAMS(T) >
    , RecursiveVariant
    , ::wjl_boost::recursive_variant_
      BOOST_MPL_AUX_LAMBDA_ARITY_PARAM(Arity)
    >
...
public: // metafunction result
    ...
    typedef ::wjl_boost::variant< BOOST_VARIANT_ENUM_PARAMS(wknd_T) > type;
