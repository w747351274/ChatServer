...
public: // visitor interfaces
    ...
    {
        return visitor_(::wjl_boost::move(value1_), ::wjl_boost::forward<Value2>(value2));
    }
    ...
    operator()(Value2&& value2)
    {
        return visitor_(value1_, ::wjl_boost::forward<Value2>(value2));
    }
...
public: // visitor interfaces
    ...
    operator()(Value1&& value1)
    {
        apply_visitor_binary_invoke<
              Visitor
            , Value1
            , ! ::wjl_boost::is_lvalue_reference<Value1>::value
            > invoker(visitor_, value1);

        return wjl_boost::apply_visitor(invoker, ::wjl_boost::move(visitable2_));
    }
    ...
    operator()(Value1&& value1)
    {
        ...
        return wjl_boost::apply_visitor(invoker, visitable2_);
    }
...
{
    ::wjl_boost::detail::variant::apply_visitor_binary_unwrap<
          Visitor, Visitable2, ! ::wjl_boost::is_lvalue_reference<Visitable2>::value
        > unwrapper(visitor, visitable2);

    return wjl_boost::apply_visitor(unwrapper, ::wjl_boost::forward<Visitable1>(visitable1));
}
...
apply_visitor( Visitor& visitor, Visitable1& visitable1, Visitable2& visitable2)
{
    ...
    return wjl_boost::apply_visitor(unwrapper, visitable1);
}
...
{
    ::wjl_boost::detail::variant::apply_visitor_binary_unwrap<
          const Visitor, Visitable2, ! ::wjl_boost::is_lvalue_reference<Visitable2>::value
        > unwrapper(visitor, visitable2);
...
inline decltype(auto) apply_visitor(Visitor& visitor, Visitable1&& visitable1, Visitable2&& visitable2,
    ...
    >::type* = 0)
{
    ::wjl_boost::detail::variant::apply_visitor_binary_unwrap_cpp14<
          Visitor, Visitable2, ! ::wjl_boost::is_lvalue_reference<Visitable2>::value
        > unwrapper(visitor, visitable2);
