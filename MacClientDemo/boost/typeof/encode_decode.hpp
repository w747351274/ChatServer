...
#   define BOOST_TYPEOF_BEGIN_ENCODE_NS namespace { namespace wjl_boost_typeof {
#   define BOOST_TYPEOF_END_ENCODE_NS }}
#   define BOOST_TYPEOF_ENCODE_NS_QUALIFIER wjl_boost_typeof

#else

#   define BOOST_TYPEOF_BEGIN_ENCODE_NS namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost { namespace type_of {
#   define BOOST_TYPEOF_END_ENCODE_NS }}
#   define BOOST_TYPEOF_ENCODE_NS_QUALIFIER wjl_boost::type_of
