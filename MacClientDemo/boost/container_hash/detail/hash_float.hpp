...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost
{
    namespace hash_detail
    {
        ...
        inline std::size_t float_hash_impl(Float v,
            BOOST_DEDUCED_TYPENAME wjl_boost::enable_if_c<
        ...
        {
            wjl_boost::hash_detail::call_frexp<T> frexp;
            wjl_boost::hash_detail::call_ldexp<T> ldexp;
            ...
            std::size_t const length
                = (limits<T>::digits *
                        wjl_boost::static_log2<limits<T>::radix>::value
...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost
{
    namespace hash_detail
    {
        ...
        inline std::size_t float_hash_value(T v)
        {
            return wjl_boost::hash_detail::is_zero(v) ? 0 : float_hash_impl(v, 0);
        }
    }
}
