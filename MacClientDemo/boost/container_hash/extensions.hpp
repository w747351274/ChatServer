...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost
{
    ...
    {
        std::size_t seed = 0;
        wjl_boost::hash_combine(seed, v.first);
        wjl_boost::hash_combine(seed, v.second);
        return seed;
    }
    ...
    {
        return wjl_boost::hash_range(v.begin(), v.end());
    }
    ...
    namespace hash_detail {
        ...
        inline typename wjl_boost::enable_if_c<(I == std::tuple_size<T>::value),
                void>::type
        ...
        {
            wjl_boost::hash_combine(seed, std::get<I>(v));
            wjl_boost::hash_detail::hash_combine_tuple<I + 1>(seed, v);
        }
        ...
        {
            std::size_t seed = 0;
            wjl_boost::hash_detail::hash_combine_tuple<0>(seed, v);
            return seed;
        }
    }
    ...
    {
        return wjl_boost::hash_detail::hash_tuple(v);
    }
#else
    ...
    inline std::size_t hash_value(std::shared_ptr<T> const& x) {
        return wjl_boost::hash_value(x.get());
    }
    ...
    namespace hash_detail
    {
        ...
        struct call_hash_impl<true>
        {
            ...
            struct inner
            {
                static std::size_t call(Array const& v)
                {
                    ...
                    return wjl_boost::hash_range(v, v + size);
                }
            };
        };
        ...
        template <class T>
        struct call_hash
            : public call_hash_impl<wjl_boost::is_array<T>::value>
    ...
    template <class T> struct hash
        : wjl_boost::hash_detail::hash_base<T>
    {
#if !defined(BOOST_NO_FUNCTION_TEMPLATE_ORDERING)
    ...
    template <class T, unsigned int n> struct hash<T[n]>
        : wjl_boost::hash_detail::hash_base<T[n]>
    {
        std::size_t operator()(const T* val) const
        {
            return wjl_boost::hash_range(val, val+n);
        }
    };
#endif
    ...
    // On compilers without partial specialization, wjl_boost::hash<T>
