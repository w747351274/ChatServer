...
MultiByteToWideChar(
    wjl_boost::winapi::UINT_ CodePage,
    wjl_boost::winapi::DWORD_ dwFlags,
    wjl_boost::winapi::LPCSTR_ lpMultiByteStr,
    int cbMultiByte,
    wjl_boost::winapi::LPWSTR_ lpWideCharStr,
    int cchWideChar);
...
WideCharToMultiByte(
    wjl_boost::winapi::UINT_ CodePage,
    wjl_boost::winapi::DWORD_ dwFlags,
    wjl_boost::winapi::LPCWSTR_ lpWideCharStr,
    int cchWideChar,
    wjl_boost::winapi::LPSTR_ lpMultiByteStr,
    int cbMultiByte,
    wjl_boost::winapi::LPCSTR_ lpDefaultChar,
    wjl_boost::winapi::LPBOOL_ lpUsedDefaultChar);
