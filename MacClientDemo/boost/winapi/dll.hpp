...
#endif // _WIN64
}} // namespace wjl_boost::winapi

#if !defined( BOOST_NO_ANSI_APIS )
BOOST_SYMBOL_IMPORT wjl_boost::winapi::HMODULE_ BOOST_WINAPI_WINAPI_CC
LoadLibraryA(wjl_boost::winapi::LPCSTR_ lpFileName);

BOOST_SYMBOL_IMPORT wjl_boost::winapi::HMODULE_ BOOST_WINAPI_WINAPI_CC
LoadLibraryExA(
    wjl_boost::winapi::LPCSTR_ lpFileName,
    wjl_boost::winapi::HANDLE_ hFile,
    wjl_boost::winapi::DWORD_ dwFlags
);

BOOST_SYMBOL_IMPORT wjl_boost::winapi::HMODULE_ BOOST_WINAPI_WINAPI_CC
GetModuleHandleA(wjl_boost::winapi::LPCSTR_ lpFileName);

BOOST_SYMBOL_IMPORT wjl_boost::winapi::DWORD_ BOOST_WINAPI_WINAPI_CC
GetModuleFileNameA(
    wjl_boost::winapi::HMODULE_ hModule,
    wjl_boost::winapi::LPSTR_ lpFilename,
    wjl_boost::winapi::DWORD_ nSize
);
#endif

BOOST_SYMBOL_IMPORT wjl_boost::winapi::HMODULE_ BOOST_WINAPI_WINAPI_CC
LoadLibraryW(wjl_boost::winapi::LPCWSTR_ lpFileName);

BOOST_SYMBOL_IMPORT wjl_boost::winapi::HMODULE_ BOOST_WINAPI_WINAPI_CC
LoadLibraryExW(
    wjl_boost::winapi::LPCWSTR_ lpFileName,
    wjl_boost::winapi::HANDLE_ hFile,
    wjl_boost::winapi::DWORD_ dwFlags
);

BOOST_SYMBOL_IMPORT wjl_boost::winapi::HMODULE_ BOOST_WINAPI_WINAPI_CC
GetModuleHandleW(wjl_boost::winapi::LPCWSTR_ lpFileName);

BOOST_SYMBOL_IMPORT wjl_boost::winapi::DWORD_ BOOST_WINAPI_WINAPI_CC
GetModuleFileNameW(
    wjl_boost::winapi::HMODULE_ hModule,
    wjl_boost::winapi::LPWSTR_ lpFilename,
    wjl_boost::winapi::DWORD_ nSize
);

#if !defined( UNDER_CE )
BOOST_SYMBOL_IMPORT wjl_boost::winapi::FARPROC_ BOOST_WINAPI_WINAPI_CC
GetProcAddress(wjl_boost::winapi::HMODULE_ hModule, wjl_boost::winapi::LPCSTR_ lpProcName);
#else
...
BOOST_SYMBOL_IMPORT wjl_boost::winapi::FARPROC_ BOOST_WINAPI_WINAPI_CC
GetProcAddressA(wjl_boost::winapi::HMODULE_ hModule, wjl_boost::winapi::LPCSTR_ lpProcName);
BOOST_SYMBOL_IMPORT wjl_boost::winapi::FARPROC_ BOOST_WINAPI_WINAPI_CC
GetProcAddressW(wjl_boost::winapi::HMODULE_ hModule, wjl_boost::winapi::LPCWSTR_ lpProcName);
#endif

struct _MEMORY_BASIC_INFORMATION;

#if !defined( BOOST_WINAPI_IS_MINGW )
BOOST_SYMBOL_IMPORT wjl_boost::winapi::SIZE_T_ BOOST_WINAPI_WINAPI_CC
VirtualQuery(
    wjl_boost::winapi::LPCVOID_ lpAddress,
    ::_MEMORY_BASIC_INFORMATION* lpBuffer,
    wjl_boost::winapi::SIZE_T_ dwLength
);
...
VirtualQuery(
    wjl_boost::winapi::LPCVOID_ lpAddress,
    ::_MEMORY_BASIC_INFORMATION* lpBuffer,
    wjl_boost::winapi::DWORD_ dwLength
);
...
FreeLibrary(wjl_boost::winapi::HMODULE_ hModule);
}
#endif
