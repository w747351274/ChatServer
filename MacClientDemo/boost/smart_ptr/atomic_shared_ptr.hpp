...
private:
    ...
    wjl_boost::shared_ptr<T> p_;

    mutable wjl_boost::detail::spinlock l_;
...
public:
    ...
    {
        wjl_boost::detail::spinlock init = BOOST_DETAIL_SPINLOCK_INIT;
    ...
    {
        wjl_boost::detail::spinlock::scoped_lock lock( l_ );
        p_.swap( r );
