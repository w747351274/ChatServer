   ...
   namespace {
                                      ...
                                      bool short_ignore_case) const
    {
        ...
        if (full_matches.size() > 1) 
            wjl_boost::throw_exception(ambiguous_option(full_matches));
        ...
        if (full_matches.empty() && approximate_matches.size() > 1)
            wjl_boost::throw_exception(ambiguous_option(approximate_matches));
        ...
        */
        ...
        {                    
            ...
            else
            {
                ...
                {
                    wjl_boost::throw_exception(program_options::error(
                                ...
                                unsigned line_length)
        {
            ...
            // wjl_boost::tokenizer, not typedef.
            typedef wjl_boost::tokenizer<wjl_boost::char_separator<char> > tok;
          
            tok paragraphs(
                desc,
                char_separator<char>("\n", "", wjl_boost::keep_empty_tokens));
