...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost { namespace program_options {
    ...
    parse(wjl_boost::any& value_store, 
    ...
    void 
    untyped_value::xparse(wjl_boost::any& value_store,
                          const std::vector<std::string>& new_tokens) const
    {
        ...
        if (new_tokens.size() > 1)
            wjl_boost::throw_exception(multiple_values());
    ...
    */
                       ...
                       bool*, int)
    {
        ...
        if (s.empty() || s == "on" || s == "yes" || s == "1" || s == "true")
            ...
            wjl_boost::throw_exception(invalid_bool_value(s));
    }
    ...
    void validate(any& v, const vector<wstring>& xs, bool*, int)
    {
        ...
        if (s.empty() || s == L"on" || s == L"yes" || s == L"1" || s == L"true")
            ...
            wjl_boost::throw_exception(invalid_bool_value(convert_value(s)));
    }
#endif
    BOOST_PROGRAM_OPTIONS_DECL 
    ...
    namespace validators {
        ...
        BOOST_PROGRAM_OPTIONS_DECL 
        void check_first_occurrence(const wjl_boost::any& value)
        {
            if (!value.empty())
                wjl_boost::throw_exception(
                    multiple_occurrences());
