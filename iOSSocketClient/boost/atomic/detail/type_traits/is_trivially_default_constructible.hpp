...
template< typename T >
using is_trivially_default_constructible = wjl_boost::has_trivial_constructor< T >;
#else
template< typename T >
struct is_trivially_default_constructible : public wjl_boost::has_trivial_constructor< T > {};
#endif
