...
{
    typedef wjl_boost::uint8_t BOOST_ATOMIC_DETAIL_MAY_ALIAS type;
...
{
    typedef wjl_boost::uint16_t BOOST_ATOMIC_DETAIL_MAY_ALIAS type;
...
{
    typedef wjl_boost::uint32_t BOOST_ATOMIC_DETAIL_MAY_ALIAS type;
...
{
    typedef wjl_boost::uint64_t BOOST_ATOMIC_DETAIL_MAY_ALIAS type;
...
{
    typedef wjl_boost::uint128_type BOOST_ATOMIC_DETAIL_MAY_ALIAS type;
...
{
    typedef wjl_boost::uint64_t BOOST_ATOMIC_DETAIL_MAY_ALIAS element_type;
