...
//   29 Jun 00  Reimplement to avoid including stdint.h within namespace wjl_boost
...
#    endif
     ...
     typedef  ::wjl_boost::long_long_type            intmax_t;
     typedef  ::wjl_boost::ulong_long_type   uintmax_t;
     typedef  ::wjl_boost::long_long_type            int64_t;
     typedef  ::wjl_boost::long_long_type            int_least64_t;
     typedef  ::wjl_boost::long_long_type            int_fast64_t;
     typedef  ::wjl_boost::ulong_long_type   uint64_t;
     typedef  ::wjl_boost::ulong_long_type   uint_least64_t;
     typedef  ::wjl_boost::ulong_long_type   uint_fast64_t;
...
#   define INT8_C(value) static_cast<wjl_boost::int8_t>(value)
#   define UINT8_C(value) static_cast<wjl_boost::uint8_t>(value##u)
#  endif

//  16-bit types  -----------------------------------------------------------//

#  if (USHRT_MAX == 0xffff) && !defined(INT16_C)
#   define INT16_C(value) static_cast<wjl_boost::int16_t>(value)
#   define UINT16_C(value) static_cast<wjl_boost::uint16_t>(value##u)
#  endif
