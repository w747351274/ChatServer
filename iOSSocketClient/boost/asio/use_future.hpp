 ...
 * wjl_boost::asio::use_future. For example:
 *
 * @code std::future<std::size_t> my_future
 *   = my_socket.async_read_some(my_buffer, wjl_boost::asio::use_future); @endcode
 *
...
public:
   ...
   *     use_future([](wjl_boost::system::error_code ec, std::size_t n)
   *       {
   *         return ec ? 0 : n;
   *       }));
   * ...
...
/**
 * See the documentation for wjl_boost::asio::use_future_t for a usage example.
 */
