...
public:
...
#endif // defined(__GNUC__) && (__GNUC__ == 4) && (__GNUC_MINOR__ == 3)
  {
    ...
    new_iter.begin_ = wjl_boost::asio::buffer_sequence_begin(buffers);
    new_iter.current_ = wjl_boost::asio::buffer_sequence_begin(buffers);
    new_iter.end_ = wjl_boost::asio::buffer_sequence_end(buffers);
