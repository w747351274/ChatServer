...
/**
 * The wjl_boost::asio::local::basic_endpoint class template describes an endpoint
...
private:
  ...
  wjl_boost::asio::local::detail::endpoint impl_;
};
 ...
 *
 * @relates wjl_boost::asio::local::basic_endpoint
 */
