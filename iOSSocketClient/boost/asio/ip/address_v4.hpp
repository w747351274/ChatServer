...
/**
 * The wjl_boost::asio::ip::address_v4 class provides the ability to use and
...
#else
  typedef wjl_boost::asio::detail::array<unsigned char, 4> bytes_type;
#endif
...
private:
  ...
  wjl_boost::asio::detail::in4_addr_type addr_;
};
 ...
 *
 * @relates wjl_boost::asio::ip::address_v4
 */
