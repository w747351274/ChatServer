...
/**
 * The wjl_boost::asio::ip::basic_resolver_results class template is used to define
...
public:
  ...
  static basic_resolver_results create(
      wjl_boost::asio::detail::addrinfo_type* address_info,
...
# if defined(BOOST_ASIO_WINDOWS_RUNTIME)
  ...
  static basic_resolver_results create(
      ...
      const wjl_boost::asio::detail::addrinfo_type& hints,
      const std::string& host_name, const std::string& service_name)
  {
    basic_resolver_results results;
    if (endpoints->Size)
        ...
        results.values_->push_back(
            basic_resolver_entry<InternetProtocol>(
              typename InternetProtocol::endpoint(
                ip::make_address(
                  wjl_boost::asio::detail::winrt_utils::string(
                    pair->RemoteHostName->CanonicalName)),
                wjl_boost::asio::detail::winrt_utils::integer(
