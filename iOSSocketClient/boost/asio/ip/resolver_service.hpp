...
#if defined(BOOST_ASIO_WINDOWS_RUNTIME)
  typedef wjl_boost::asio::detail::winrt_resolver_service<InternetProtocol>
    service_impl_type;
#else
  typedef wjl_boost::asio::detail::resolver_service<InternetProtocol>
    service_impl_type;
#endif
...
public:
  ...
  explicit resolver_service(wjl_boost::asio::io_context& io_context)
...
private:
  ...
  void notify_fork(wjl_boost::asio::io_context::fork_event event)
  {
