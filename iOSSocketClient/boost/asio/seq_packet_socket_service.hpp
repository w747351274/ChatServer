...
#else
  : public wjl_boost::asio::detail::service_base<
...
public:
  ...
  static wjl_boost::asio::io_context::id id;
#endif
...
public:
  ...
  /// io_context.
  explicit seq_packet_socket_service(wjl_boost::asio::io_context& io_context)
    : wjl_boost::asio::detail::service_base<
  ...
  BOOST_ASIO_SYNC_OP_VOID set_option(implementation_type& impl,
      const SettableSocketOption& option, wjl_boost::system::error_code& ec)
  {
  ...
  BOOST_ASIO_SYNC_OP_VOID get_option(const implementation_type& impl,
      GettableSocketOption& option, wjl_boost::system::error_code& ec) const
  {
  ...
  BOOST_ASIO_SYNC_OP_VOID io_control(implementation_type& impl,
      IoControlCommand& command, wjl_boost::system::error_code& ec)
  {
