...
public:
   ...
   */
  explicit strand(wjl_boost::asio::io_context& io_context)
    : service_(wjl_boost::asio::use_service<
        wjl_boost::asio::detail::strand_service>(io_context))
  {
  ...
  wjl_boost::asio::io_context& context() const BOOST_ASIO_NOEXCEPT
  {
    return service_.get_io_context();
  }
...
#if !defined(BOOST_ASIO_NO_DEPRECATED)
  /// (Deprecated: Use wjl_boost::asio::dispatch().) Request the strand to invoke
  /// the given handler.
  /**
...
#if !defined(BOOST_ASIO_NO_DEPRECATED)
  /// (Deprecated: Use wjl_boost::asio::post().) Request the strand to invoke the
   ...
   * @code strand.dispatch(wjl_boost::bind(f, a1, ... an)); @endcode
   */
...
private:
  wjl_boost::asio::detail::strand_service& service_;
  mutable wjl_boost::asio::detail::strand_service::implementation_type impl_;
};
