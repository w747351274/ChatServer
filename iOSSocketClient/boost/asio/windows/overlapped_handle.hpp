...
#define BOOST_ASIO_SVC_T wjl_boost::asio::detail::win_iocp_handle_service
...
public:
   ...
   */
  explicit overlapped_handle(wjl_boost::asio::io_context& io_context)
   ...
   */
  overlapped_handle(wjl_boost::asio::io_context& io_context,
