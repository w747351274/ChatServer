...
public:
  ...
  BOOST_ASIO_DECL win_iocp_io_context(wjl_boost::asio::execution_context& ctx,
  ...
  BOOST_ASIO_DECL wjl_boost::system::error_code register_handle(
      HANDLE handle, wjl_boost::system::error_code& ec);

  // Run the event loop until stopped or no more work.
  BOOST_ASIO_DECL size_t run(wjl_boost::system::error_code& ec);

  // Run until stopped or one operation is performed.
  BOOST_ASIO_DECL size_t run_one(wjl_boost::system::error_code& ec);

  // Run until timeout, interrupted, or one operation is performed.
  BOOST_ASIO_DECL size_t wait_one(long usec, wjl_boost::system::error_code& ec);

  // Poll for operations without blocking.
  BOOST_ASIO_DECL size_t poll(wjl_boost::system::error_code& ec);

  // Poll for one operation without blocking.
  BOOST_ASIO_DECL size_t poll_one(wjl_boost::system::error_code& ec);
  ...
  // starting the operation.
  BOOST_ASIO_DECL void on_completion(win_iocp_operation* op,
      const wjl_boost::system::error_code& ec, DWORD bytes_transferred = 0);
...
private:
  ...
  // either 0 or 1).
  BOOST_ASIO_DECL size_t do_one(DWORD msec, wjl_boost::system::error_code& ec);
