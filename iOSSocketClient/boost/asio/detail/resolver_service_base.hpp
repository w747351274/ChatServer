...
public:
  ...
  // Constructor.
  BOOST_ASIO_DECL resolver_service_base(wjl_boost::asio::io_context& io_context);
...
protected:
  ...
  {
  public:
    explicit auto_addrinfo(wjl_boost::asio::detail::addrinfo_type* ai)
      : ai_(ai)
    {
    }
    ...
    operator wjl_boost::asio::detail::addrinfo_type*()
    {
      return ai_;
    }

  private:
    wjl_boost::asio::detail::addrinfo_type* ai_;
  };
...
private:
  ...
  wjl_boost::asio::detail::scoped_ptr<wjl_boost::asio::io_context> work_io_context_;
  ...
  wjl_boost::asio::executor_work_guard<
      wjl_boost::asio::io_context::executor_type> work_;

  // Thread used for running the work io_context's run loop.
  wjl_boost::asio::detail::scoped_ptr<wjl_boost::asio::detail::thread> work_thread_;
};
