...
public:
  ...
  public:
    ...
    BOOST_ASIO_DECL void invocation_begin(const wjl_boost::system::error_code& ec);

    // Constructor records that handler is to be invoked with two arguments.
    BOOST_ASIO_DECL void invocation_begin(
        const wjl_boost::system::error_code& ec, std::size_t bytes_transferred);

    // Constructor records that handler is to be invoked with two arguments.
    BOOST_ASIO_DECL void invocation_begin(
        const wjl_boost::system::error_code& ec, int signal_number);

    // Constructor records that handler is to be invoked with two arguments.
    BOOST_ASIO_DECL void invocation_begin(
        const wjl_boost::system::error_code& ec, const char* arg);
...
# define BOOST_ASIO_INHERIT_TRACKED_HANDLER \
  : public wjl_boost::asio::detail::handler_tracking::tracked_handler

# define BOOST_ASIO_ALSO_INHERIT_TRACKED_HANDLER \
  , public wjl_boost::asio::detail::handler_tracking::tracked_handler

# define BOOST_ASIO_HANDLER_TRACKING_INIT \
  wjl_boost::asio::detail::handler_tracking::init()

# define BOOST_ASIO_HANDLER_CREATION(args) \
  wjl_boost::asio::detail::handler_tracking::creation args

# define BOOST_ASIO_HANDLER_COMPLETION(args) \
  wjl_boost::asio::detail::handler_tracking::completion tracked_completion args
...
# define BOOST_ASIO_HANDLER_OPERATION(args) \
  wjl_boost::asio::detail::handler_tracking::operation args

# define BOOST_ASIO_HANDLER_REACTOR_REGISTRATION(args) \
  wjl_boost::asio::detail::handler_tracking::reactor_registration args

# define BOOST_ASIO_HANDLER_REACTOR_DEREGISTRATION(args) \
  wjl_boost::asio::detail::handler_tracking::reactor_deregistration args
...
# define BOOST_ASIO_HANDLER_REACTOR_EVENTS(args) \
  wjl_boost::asio::detail::handler_tracking::reactor_events args

# define BOOST_ASIO_HANDLER_REACTOR_OPERATION(args) \
  wjl_boost::asio::detail::handler_tracking::reactor_operation args
