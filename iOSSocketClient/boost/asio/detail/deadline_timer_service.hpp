...
public:
  ...
  // Constructor.
  deadline_timer_service(wjl_boost::asio::io_context& io_context)
    : service_base<deadline_timer_service<Time_Traits> >(io_context),
      scheduler_(wjl_boost::asio::use_service<timer_scheduler>(io_context))
  {
  ...
  std::size_t cancel(implementation_type& impl, wjl_boost::system::error_code& ec)
  {
    if (!impl.might_have_pending_waits)
    {
  ...
  std::size_t expires_at(implementation_type& impl,
      const time_type& expiry_time, wjl_boost::system::error_code& ec)
  {
  ...
  std::size_t expires_after(implementation_type& impl,
      const duration_type& expiry_time, wjl_boost::system::error_code& ec)
  {
  ...
  void wait(implementation_type& impl, wjl_boost::system::error_code& ec)
  {
...
private:
  ...
  // either be of type wjl_boost::posix_time::time_duration, or implement the
  // required subset of its interface.
  template <typename Duration>
  void do_wait(const Duration& timeout, wjl_boost::system::error_code& ec)
  {
#if defined(BOOST_ASIO_WINDOWS_RUNTIME)
