...
select_reactor::select_reactor(wjl_boost::asio::execution_context& ctx)
...
{
#if defined(BOOST_ASIO_HAS_IOCP)
  wjl_boost::asio::detail::signal_blocker sb;
  thread_ = new wjl_boost::asio::detail::thread(thread_function(this));
#endif // defined(BOOST_ASIO_HAS_IOCP)
}
