...
win_iocp_io_context::win_iocp_io_context(
    wjl_boost::asio::execution_context& ctx, int concurrency_hint)
    ...
    concurrency_hint_(concurrency_hint)
{
  ...
  if (!iocp_.handle)
  {
    ...
    wjl_boost::system::error_code ec(last_error,
        wjl_boost::asio::error::get_system_category());
    wjl_boost::asio::detail::throw_error(ec, "iocp");
  }
}
...
wjl_boost::system::error_code win_iocp_io_context::register_handle(
    HANDLE handle, wjl_boost::system::error_code& ec)
{
  if (::CreateIoCompletionPort(handle, iocp_.handle, 0, 0) == 0)
  {
    DWORD last_error = ::GetLastError();
    ec = wjl_boost::system::error_code(last_error,
        wjl_boost::asio::error::get_system_category());
  }
  else
  {
...
size_t win_iocp_io_context::run(wjl_boost::system::error_code& ec)
{
...
size_t win_iocp_io_context::run_one(wjl_boost::system::error_code& ec)
{
  if (::InterlockedExchangeAdd(&outstanding_work_, 0) == 0)
  {
    stop();
...
size_t win_iocp_io_context::wait_one(long usec, wjl_boost::system::error_code& ec)
{
  if (::InterlockedExchangeAdd(&outstanding_work_, 0) == 0)
  {
    stop();
...
size_t win_iocp_io_context::poll(wjl_boost::system::error_code& ec)
{
  if (::InterlockedExchangeAdd(&outstanding_work_, 0) == 0)
  {
    stop();
...
size_t win_iocp_io_context::poll_one(wjl_boost::system::error_code& ec)
{
  if (::InterlockedExchangeAdd(&outstanding_work_, 0) == 0)
  {
    stop();
  ...
  if (::InterlockedExchange(&stopped_, 1) == 0)
  {
    if (::InterlockedExchange(&stop_event_posted_, 1) == 0)
    {
      if (!::PostQueuedCompletionStatus(iocp_.handle, 0, 0, 0))
      {
        ...
        wjl_boost::system::error_code ec(last_error,
            wjl_boost::asio::error::get_system_category());
        wjl_boost::asio::detail::throw_error(ec, "pqcs");
      }
    }
  }
}
...
void win_iocp_io_context::on_completion(win_iocp_operation* op,
    const wjl_boost::system::error_code& ec, DWORD bytes_transferred)
{
  // Flag that the operation is ready for invocation.
  op->ready_ = 1;
...
size_t win_iocp_io_context::do_one(DWORD msec, wjl_boost::system::error_code& ec)
{
  for (;;)
  {
    ...
    if (overlapped)
    {
      ...
      wjl_boost::system::error_code result_ec(last_error,
          wjl_boost::asio::error::get_system_category());
      ...
      {
        result_ec = wjl_boost::system::error_code(static_cast<int>(op->Offset),
            *reinterpret_cast<wjl_boost::system::error_category*>(op->Internal));
...
void win_iocp_io_context::do_add_timer_queue(timer_queue_base& queue)
{
  ...
  if (!waitable_timer_.handle)
  {
    ...
    if (waitable_timer_.handle == 0)
    {
      ...
      wjl_boost::system::error_code ec(last_error,
          wjl_boost::asio::error::get_system_category());
      wjl_boost::asio::detail::throw_error(ec, "timer");
    }
