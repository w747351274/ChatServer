...
void win_thread::start_thread(func_base* arg, unsigned int stack_size)
{
  ...
  if (!entry_event)
  {
    ...
    wjl_boost::asio::detail::throw_error(ec, "thread.entry_event");
  }
  ...
  if (!exit_event_)
  {
    ...
    wjl_boost::system::error_code ec(last_error,
        wjl_boost::asio::error::get_system_category());
    wjl_boost::asio::detail::throw_error(ec, "thread.exit_event");
  }
  ...
  if (!thread_)
  {
    ...
    wjl_boost::system::error_code ec(last_error,
        wjl_boost::asio::error::get_system_category());
    wjl_boost::asio::detail::throw_error(ec, "thread");
  }
