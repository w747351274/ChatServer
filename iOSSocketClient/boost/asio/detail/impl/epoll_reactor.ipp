...
epoll_reactor::epoll_reactor(wjl_boost::asio::execution_context& ctx)
  ...
  if (fork_ev == wjl_boost::asio::execution_context::fork_child)
  {
        ...
        state != 0; state = state->next_)
    {
      ...
      if (result != 0)
      {
        ...
        wjl_boost::asio::detail::throw_error(ec, "epoll re-registration");
      }
    }
  }
}
...
int epoll_reactor::do_epoll_create()
{
  ...
  if (fd == -1)
  {
    wjl_boost::system::error_code ec(errno,
        wjl_boost::asio::error::get_system_category());
    wjl_boost::asio::detail::throw_error(ec, "epoll");
  }
