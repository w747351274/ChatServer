...
public:
  ...
  {
    wjl_boost::system::error_code ec(result_ec);
    ...
    if (owner)
    {
      ...
      if (ec == wjl_boost::asio::error::connection_aborted
    ...
    detail::binder1<Handler, wjl_boost::system::error_code>
...
public:
  ...
  win_iocp_socket_move_accept_op(
      ...
      const Protocol& protocol, wjl_boost::asio::io_context& peer_io_context,
      typename Protocol::endpoint* peer_endpoint,
      bool enable_connection_aborted, Handler& handler)
      ...
      std::size_t /*bytes_transferred*/)
  {
    ...
    detail::move_binder2<Handler,
      wjl_boost::system::error_code, typename Protocol::socket>
