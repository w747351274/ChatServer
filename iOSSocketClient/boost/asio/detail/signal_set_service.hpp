...
public:
  ...
  // Constructor.
  BOOST_ASIO_DECL signal_set_service(wjl_boost::asio::io_context& io_context);
  ...
  BOOST_ASIO_DECL wjl_boost::system::error_code add(implementation_type& impl,
      int signal_number, wjl_boost::system::error_code& ec);

  // Remove a signal to a signal_set.
  BOOST_ASIO_DECL wjl_boost::system::error_code remove(implementation_type& impl,
      int signal_number, wjl_boost::system::error_code& ec);

  // Remove all signals from a signal_set.
  BOOST_ASIO_DECL wjl_boost::system::error_code clear(implementation_type& impl,
