...
class winrt_timer_scheduler
  : public wjl_boost::asio::detail::service_base<winrt_timer_scheduler>
{
public:
  // Constructor.
  BOOST_ASIO_DECL winrt_timer_scheduler(wjl_boost::asio::io_context& io_context);
...
private:
  ...
  wjl_boost::asio::detail::event event_;

  // The timer queues.
  timer_queue_set timer_queues_;

  // The background thread that is waiting for timers to expire.
  wjl_boost::asio::detail::thread* thread_;
