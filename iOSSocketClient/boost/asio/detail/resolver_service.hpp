...
public:
  ...
  // Constructor.
  resolver_service(wjl_boost::asio::io_context& io_context)
  ...
  void notify_fork(wjl_boost::asio::io_context::fork_event fork_ev)
  {
  ...
  {
    wjl_boost::asio::detail::addrinfo_type* address_info = 0;
