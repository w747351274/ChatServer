...
io_context::post(BOOST_ASIO_MOVE_ARG(LegacyCompletionHandler) handler)
{
  ...
  bool is_continuation =
    wjl_boost_asio_handler_cont_helpers::is_continuation(init.completion_handler);
    ...
    BOOST_ASIO_MOVE_ARG(Function) f, const Allocator& a) const
{
  ...
  if (io_context_.impl_.can_dispatch())
  {
    ...
    detail::fenced_block b(detail::fenced_block::full);
    wjl_boost_asio_handler_invoke_helpers::invoke(tmp, tmp);
    return;
  }
...
#if !defined(BOOST_ASIO_NO_DEPRECATED)
inline io_context::work::work(wjl_boost::asio::io_context& io_context)
...
inline wjl_boost::asio::io_context& io_context::work::get_io_context()
{
  return static_cast<wjl_boost::asio::io_context&>(io_context_impl_.context());
}

inline wjl_boost::asio::io_context& io_context::work::get_io_service()
{
  return static_cast<wjl_boost::asio::io_context&>(io_context_impl_.context());
}
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)

inline wjl_boost::asio::io_context& io_context::service::get_io_context()
{
  return static_cast<wjl_boost::asio::io_context&>(context());
}

#if !defined(BOOST_ASIO_NO_DEPRECATED)
inline wjl_boost::asio::io_context& io_context::service::get_io_service()
{
  return static_cast<wjl_boost::asio::io_context&>(context());
}
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)
