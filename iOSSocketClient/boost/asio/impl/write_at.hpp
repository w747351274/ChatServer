...
namespace detail
{
      ...
      wjl_boost::system::error_code& ec)
  {
    ...
    wjl_boost::asio::detail::consuming_buffers<const_buffer,
...
std::size_t write_at(SyncRandomAccessWriteDevice& d,
    uint64_t offset, const ConstBufferSequence& buffers,
    CompletionCondition completion_condition, wjl_boost::system::error_code& ec)
{
  return detail::write_at_buffer_sequence(d, offset, buffers,
      wjl_boost::asio::buffer_sequence_begin(buffers), completion_condition, ec);
}
    ...
    uint64_t offset, const ConstBufferSequence& buffers)
{
  ...
  wjl_boost::asio::detail::throw_error(ec, "write_at");
...
template <typename SyncRandomAccessWriteDevice, typename Allocator,
    typename CompletionCondition>
std::size_t write_at(SyncRandomAccessWriteDevice& d,
    uint64_t offset, wjl_boost::asio::basic_streambuf<Allocator>& b,
    CompletionCondition completion_condition, wjl_boost::system::error_code& ec)
{
  std::size_t bytes_transferred = write_at(
    ...
    BOOST_ASIO_MOVE_ARG(WriteHandler) handler)
{
  ...
  detail::start_write_at_buffer_sequence_op(d, offset, buffers,
      wjl_boost::asio::buffer_sequence_begin(buffers), completion_condition,
    ...
    BOOST_ASIO_MOVE_ARG(WriteHandler) handler)
{
  ...
  detail::start_write_at_buffer_sequence_op(d, offset, buffers,
      wjl_boost::asio::buffer_sequence_begin(buffers), transfer_all(),
      init.completion_handler);
...
namespace detail
{
  ...
  public:
    write_at_streambuf_op(
        wjl_boost::asio::basic_streambuf<Allocator>& streambuf,
        WriteHandler& handler)
  ...
  //private:
    wjl_boost::asio::basic_streambuf<Allocator>& streambuf_;
    WriteHandler handler_;
  };
  ...
  make_write_at_streambuf_op(
      wjl_boost::asio::basic_streambuf<Allocator>& b, WriteHandler handler)
  {
    ...
    BOOST_ASIO_MOVE_ARG(WriteHandler) handler)
{
  ...
  async_write_at(d, offset, b.data(), completion_condition,
    detail::write_at_streambuf_op<Allocator, BOOST_ASIO_HANDLER_TYPE(
      WriteHandler, void (wjl_boost::system::error_code, std::size_t))>(
