...
public:
  ...
  explicit waitable_timer_service(wjl_boost::asio::io_context& io_context)
  ...
  std::size_t expires_at(implementation_type& impl,
      const time_point& expiry_time, wjl_boost::system::error_code& ec)
  {
  ...
  std::size_t expires_after(implementation_type& impl,
      const duration& expiry_time, wjl_boost::system::error_code& ec)
  {
