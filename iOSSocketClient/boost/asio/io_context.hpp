 ...
 *
 * @li wjl_boost::asio::ip::tcp::socket
 * @li wjl_boost::asio::ip::tcp::acceptor
 * @li wjl_boost::asio::ip::udp::socket
 * @li wjl_boost::asio::deadline_timer.
 *
 ...
 *
 * To submit functions to the io_context, use the @ref wjl_boost::asio::dispatch,
 * @ref wjl_boost::asio::post or @ref wjl_boost::asio::defer free functions.
 *
 * For example:
 *
 * @code void my_task()
 ...
 * wjl_boost::asio::post(io_context, my_task);
 *
 * // Submit a lambda object to the io_context.
 * wjl_boost::asio::post(io_context,
 *     []()
 *     {
 *       ...
 *     });
 ...
 * wjl_boost::asio::executor_work_guard<io_context::executor_type>:
 *
 * @code wjl_boost::asio::io_context io_context;
 * wjl_boost::asio::executor_work_guard<wjl_boost::asio::io_context::executor_type>
 *   = wjl_boost::asio::make_work_guard(io_context);
 * ... @endcode
 *
...
public:
   ...
   * without blocking.
   */
  BOOST_ASIO_DECL count_type run(wjl_boost::system::error_code& ec);
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)
   ...
   * deadlock. It is the caller's reponsibility to avoid this.
   */
  BOOST_ASIO_DECL count_type run_one(wjl_boost::system::error_code& ec);
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)
   ...
   * @return The number of handlers that were executed.
   */
  BOOST_ASIO_DECL count_type poll(wjl_boost::system::error_code& ec);
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)
   ...
   * @return The number of handlers that were executed.
   */
  BOOST_ASIO_DECL count_type poll_one(wjl_boost::system::error_code& ec);
#endif // !defined(BOOST_ASIO_NO_DEPRECATED)
  ...
  /// (Deprecated: Use wjl_boost::asio::dispatch().) Request the io_context to
  ...
  /// (Deprecated: Use wjl_boost::asio::post().) Request the io_context to invoke
  ...
  /// (Deprecated: Use wjl_boost::asio::bind_executor().) Create a new handler that
   ...
   * @code io_context.dispatch(wjl_boost::bind(f, a1, ... an)); @endcode
   */
...
public:
   ...
   */
  explicit work(wjl_boost::asio::io_context& io_context);
...
protected:
   ...
   */
  BOOST_ASIO_DECL service(wjl_boost::asio::io_context& owner);
...
class service_base
  : public wjl_boost::asio::io_context::service
{
public:
  static wjl_boost::asio::detail::service_id<Type> id;

  // Constructor.
  service_base(wjl_boost::asio::io_context& io_context)
    : wjl_boost::asio::io_context::service(io_context)
  {
  }
};

template <typename Type>
wjl_boost::asio::detail::service_id<Type> service_base<Type>::id;
