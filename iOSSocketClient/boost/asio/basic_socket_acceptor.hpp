 ...
 * @code
 * wjl_boost::asio::ip::tcp::acceptor acceptor(io_context);
 * wjl_boost::asio::ip::tcp::endpoint endpoint(wjl_boost::asio::ip::tcp::v4(), port);
 * acceptor.open(endpoint.protocol());
 * acceptor.set_option(wjl_boost::asio::ip::tcp::acceptor::reuse_address(true));
...
public:
   ...
   * acceptor.
   */
  explicit basic_socket_acceptor(wjl_boost::asio::io_context& io_context)
   ...
   */
  basic_socket_acceptor(wjl_boost::asio::io_context& io_context,
    ...
    : basic_io_object<BOOST_ASIO_SVC_T>(io_context)
  {
    ...
    wjl_boost::asio::detail::throw_error(ec, "listen");
  }
   ...
   * @code
   * wjl_boost::asio::ip::tcp::acceptor acceptor(io_context);
   * acceptor.open(wjl_boost::asio::ip::tcp::v4());
   * @endcode
   */
   ...
   * wjl_boost::asio::ip::tcp::acceptor acceptor(io_context);
   * wjl_boost::system::error_code ec;
   * acceptor.open(wjl_boost::asio::ip::tcp::v4(), ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
  ...
  BOOST_ASIO_SYNC_OP_VOID assign(const protocol_type& protocol,
      const native_handle_type& native_acceptor, wjl_boost::system::error_code& ec)
  {
    this->get_service().assign(this->get_implementation(),
        protocol, native_acceptor, ec);
    BOOST_ASIO_SYNC_OP_VOID_RETURN(ec);
   ...
   * @code
   * wjl_boost::asio::ip::tcp::acceptor acceptor(io_context);
   * wjl_boost::asio::ip::tcp::endpoint endpoint(wjl_boost::asio::ip::tcp::v4(), 12345);
   * acceptor.open(endpoint.protocol());
   * acceptor.bind(endpoint);
   * @endcode
   */
   ...
   * ...
   * wjl_boost::system::error_code ec;
   * acceptor.listen(wjl_boost::asio::socket_base::max_listen_connections, ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   * @endcode
   */
  BOOST_ASIO_SYNC_OP_VOID listen(int backlog, wjl_boost::system::error_code& ec)
  {
    this->get_service().listen(this->get_implementation(), backlog, ec);
    BOOST_ASIO_SYNC_OP_VOID_RETURN(ec);
  }
   ...
   * passed the wjl_boost::asio::error::operation_aborted error. Ownership of the
   ...
   * wjl_boost::asio::socket_base::reuse_address
   * wjl_boost::asio::socket_base::enable_connection_aborted
   *
   * @par Example
   ...
   * wjl_boost::asio::ip::tcp::acceptor acceptor(io_context);
   * ...
   * wjl_boost::asio::ip::tcp::acceptor::reuse_address option(true);
   ...
   * wjl_boost::asio::ip::tcp::acceptor acceptor(io_context);
   * ...
   * wjl_boost::asio::ip::tcp::acceptor::reuse_address option;
   ...
   * wjl_boost::asio::ip::tcp::acceptor acceptor(io_context);
   * ...
   * wjl_boost::asio::ip::tcp::acceptor::non_blocking_io command(true);
   ...
   * with wjl_boost::asio::error::would_block if they are unable to perform the
   ...
   * wjl_boost::asio::ip::tcp::acceptor acceptor(io_context);
   * ...
   * wjl_boost::asio::ip::tcp::endpoint endpoint = acceptor.local_endpoint();
   * @endcode
   */
   ...
   * ...
   * wjl_boost::system::error_code ec;
   * wjl_boost::asio::ip::tcp::endpoint endpoint = acceptor.local_endpoint(ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   ...
   * wjl_boost::asio::ip::tcp::acceptor acceptor(io_context);
   * ...
   * acceptor.wait(wjl_boost::asio::ip::tcp::acceptor::wait_read);
   * @endcode
   */
   ...
   * ...
   * wjl_boost::system::error_code ec;
   * acceptor.wait(wjl_boost::asio::ip::tcp::acceptor::wait_read, ec);
   * @endcode
   */
   ...
   * ...
   * acceptor.async_wait(
   *     wjl_boost::asio::ip::tcp::acceptor::wait_read,
   *     wait_handler);
   * @endcode
   */
...
#endif // defined(BOOST_ASIO_ENABLE_OLD_SERVICES)
  {
    ...
    wjl_boost::asio::detail::throw_error(ec, "accept");
  }
  ...
  template <typename Protocol1>
  BOOST_ASIO_SYNC_OP_VOID accept(
      basic_socket<Protocol1>& peer, wjl_boost::system::error_code& ec,
      typename enable_if<is_convertible<Protocol, Protocol1>::value>::type* = 0)
#endif // defined(BOOST_ASIO_ENABLE_OLD_SERVICES)
  {
    this->get_service().accept(this->get_implementation(),
   ...
   * @par Example
   * @code
   * void accept_handler(const wjl_boost::system::error_code& error)
   * {
   *   if (!error)
   *   {
   *     // Accept succeeded.
  ...
  BOOST_ASIO_SYNC_OP_VOID accept(
      ...
      endpoint_type& peer_endpoint, wjl_boost::system::error_code& ec)
#else // defined(BOOST_ASIO_ENABLE_OLD_SERVICES)
   ...
   * wjl_boost::asio::ip::tcp::acceptor acceptor(io_context);
   * ...
   * wjl_boost::asio::ip::tcp::socket socket(acceptor.accept());
   * @endcode
   */
   ...
   * wjl_boost::asio::ip::tcp::acceptor acceptor(io_context);
   * ...
   * wjl_boost::asio::ip::tcp::socket socket(acceptor.accept(ec));
   * if (ec)
   * {
   *   // An error occurred.
   * }
   * @endcode
   */
  typename Protocol::socket accept(wjl_boost::system::error_code& ec)
  {
   ...
   * @code
   * void accept_handler(const wjl_boost::system::error_code& error,
   *     wjl_boost::asio::ip::tcp::socket peer)
   * {
   *   if (!error)
   *   {
   *     // Accept succeeded.
  ...
  BOOST_ASIO_INITFN_RESULT_TYPE(MoveAcceptHandler,
      void (wjl_boost::system::error_code, typename Protocol::socket))
  async_accept(BOOST_ASIO_MOVE_ARG(MoveAcceptHandler) handler)
  {
    ...
    return this->get_service().async_accept(
        this->get_implementation(), static_cast<wjl_boost::asio::io_context*>(0),
   ...
   * @endcode
   */
  typename Protocol::socket accept(wjl_boost::asio::io_context& io_context)
  {
    wjl_boost::system::error_code ec;
    typename Protocol::socket peer(
        this->get_service().accept(this->get_implementation(),
   ...
   * wjl_boost::asio::ip::tcp::acceptor acceptor(io_context);
   * ...
   * wjl_boost::asio::ip::tcp::socket socket(acceptor.accept(io_context2, ec));
   * if (ec)
   * {
   *   // An error occurred.
   * }
   ...
   */
  typename Protocol::socket accept(
      wjl_boost::asio::io_context& io_context, wjl_boost::system::error_code& ec)
  {
  ...
  BOOST_ASIO_INITFN_RESULT_TYPE(MoveAcceptHandler,
      void (wjl_boost::system::error_code, typename Protocol::socket))
  async_accept(wjl_boost::asio::io_context& io_context,
   ...
   * ...
   * wjl_boost::asio::ip::tcp::endpoint endpoint;
   * wjl_boost::asio::ip::tcp::socket socket(acceptor.accept(endpoint));
   * @endcode
   */
  typename Protocol::socket accept(endpoint_type& peer_endpoint)
  {
    ...
    typename Protocol::socket peer(
        this->get_service().accept(this->get_implementation(),
          static_cast<wjl_boost::asio::io_context*>(0), &peer_endpoint, ec));
    wjl_boost::asio::detail::throw_error(ec, "accept");
    return peer;
  }
   ...
   * ...
   * wjl_boost::asio::ip::tcp::endpoint endpoint;
   * wjl_boost::asio::ip::tcp::socket socket(acceptor.accept(endpoint, ec));
   * if (ec)
   * {
   *   // An error occurred.
   * }
...
#if defined(BOOST_ASIO_ENABLE_OLD_SERVICES)
    return this->get_service().async_accept(this->get_implementation(),
        static_cast<wjl_boost::asio::io_context*>(0), &peer_endpoint,
        BOOST_ASIO_MOVE_CAST(MoveAcceptHandler)(handler));
#else // defined(BOOST_ASIO_ENABLE_OLD_SERVICES)
    async_completion<MoveAcceptHandler,
      void (wjl_boost::system::error_code,
   ...
   * ...
   * wjl_boost::asio::ip::tcp::endpoint endpoint;
   * wjl_boost::asio::ip::tcp::socket socket(
   *     acceptor.accept(io_context2, endpoint));
   * @endcode
   */
  typename Protocol::socket accept(
      wjl_boost::asio::io_context& io_context, endpoint_type& peer_endpoint)
  {
    wjl_boost::system::error_code ec;
    typename Protocol::socket peer(
        this->get_service().accept(this->get_implementation(),
