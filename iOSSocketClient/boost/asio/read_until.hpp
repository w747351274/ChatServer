...
struct is_match_condition
{
  ...
  enum
  {
    value = wjl_boost::asio::is_function<
        typename wjl_boost::asio::remove_pointer<T>::type>::value
...
/**
 * @defgroup read_until wjl_boost::asio::read_until
 *
 ...
 * std::string n = wjl_boost::asio::read_until(s,
 *     wjl_boost::asio::dynamic_buffer(data), '\n');
...
std::size_t read_until(SyncReadStream& s,
    ...
    char delim, wjl_boost::system::error_code& ec);
 ...
 * @code std::string data;
 * std::string n = wjl_boost::asio::read_until(s,
 *     wjl_boost::asio::dynamic_buffer(data), wjl_boost::regex("\r\n"));
 * std::string line = data.substr(0, n);
 * data.erase(0, n); @endcode
 * After the @c read_until operation completes successfully, the string @c data
 * contains the delimiter:
...
std::size_t read_until(SyncReadStream& s,
    BOOST_ASIO_MOVE_ARG(DynamicBuffer) buffers,
    const wjl_boost::regex& expr, wjl_boost::system::error_code& ec);
 ...
 * @code typedef wjl_boost::asio::buffers_iterator<
 *     wjl_boost::asio::const_buffers_1> iterator;
 *
 ...
 * ...
 * std::string data;
 * wjl_boost::asio::read_until(s, data, match_whitespace);
 * @endcode
 *
 ...
 * ...
 * std::string data;
 * wjl_boost::asio::read_until(s, data, match_char('a'));
 * @endcode
 */
...
std::size_t read_until(SyncReadStream& s,
    BOOST_ASIO_MOVE_ARG(DynamicBuffer) buffers,
    MatchCondition match_condition, wjl_boost::system::error_code& ec,
    typename enable_if<is_match_condition<MatchCondition>::value>::type* = 0);
 ...
 * @code wjl_boost::asio::streambuf b;
 * wjl_boost::asio::read_until(s, b, '\n');
 * std::istream is(&b);
 * std::string line;
...
std::size_t read_until(SyncReadStream& s,
    wjl_boost::asio::basic_streambuf<Allocator>& b, char delim);
...
template <typename SyncReadStream, typename Allocator>
std::size_t read_until(SyncReadStream& s,
    wjl_boost::asio::basic_streambuf<Allocator>& b,
    BOOST_ASIO_STRING_VIEW_PARAM delim);
...
std::size_t read_until(SyncReadStream& s,
    wjl_boost::asio::basic_streambuf<Allocator>& b,
    BOOST_ASIO_STRING_VIEW_PARAM delim, wjl_boost::system::error_code& ec);
 ...
 * @code wjl_boost::asio::streambuf b;
 * wjl_boost::asio::read_until(s, b, wjl_boost::regex("\r\n"));
 * std::istream is(&b);
 * std::string line;
 * std::getline(is, line); @endcode
 * After the @c read_until operation completes successfully, the buffer @c b
...
template <typename SyncReadStream, typename Allocator>
std::size_t read_until(SyncReadStream& s,
    wjl_boost::asio::basic_streambuf<Allocator>& b, const wjl_boost::regex& expr);
 ...
 * @code typedef wjl_boost::asio::buffers_iterator<
 *     wjl_boost::asio::streambuf::const_buffers_type> iterator;
 *
 * std::pair<iterator, bool>
 * match_whitespace(iterator begin, iterator end)
 * {
 ...
 * }
 * ...
 * wjl_boost::asio::streambuf b;
 * wjl_boost::asio::read_until(s, b, match_whitespace);
 * @endcode
 *
 ...
 * ...
 * wjl_boost::asio::streambuf b;
 * wjl_boost::asio::read_until(s, b, match_char('a'));
 * @endcode
 */
template <typename SyncReadStream, typename Allocator, typename MatchCondition>
std::size_t read_until(SyncReadStream& s,
    wjl_boost::asio::basic_streambuf<Allocator>& b, MatchCondition match_condition,
    typename enable_if<is_match_condition<MatchCondition>::value>::type* = 0);
...
/*@}*/
/**
 * @defgroup async_read_until wjl_boost::asio::async_read_until
 *
 ...
 * @code void handler(
 *   // Result of operation.
 *   const wjl_boost::system::error_code& error,
 *
 ...
 * @code std::string data;
 * ...
 * void handler(const wjl_boost::system::error_code& e, std::size_t size)
 * {
 *   if (!e)
 *   {
 *     std::string line = data.substr(0, n);
 ...
 * }
 * ...
 * wjl_boost::asio::async_read_until(s, data, '\n', handler); @endcode
 ...
 * ...
 * std::string data;
 * wjl_boost::asio::async_read_until(s, data, match_whitespace, handler);
 * @endcode
 *
 ...
 * ...
 * std::string data;
 * wjl_boost::asio::async_read_until(s, data, match_char('a'), handler);
 * @endcode
 */
 ...
 * }
 * ...
 * wjl_boost::asio::async_read_until(s, b, '\n', handler); @endcode
 * After the @c async_read_until operation completes successfully, the buffer
 ...
 * }
 * ...
 * wjl_boost::asio::async_read_until(s, b, wjl_boost::regex("\r\n"), handler); @endcode
 * After the @c async_read_until operation completes successfully, the buffer
 ...
 * ...
 * wjl_boost::asio::streambuf b;
 * wjl_boost::asio::async_read_until(s, b, match_whitespace, handler);
 * @endcode
 *
 ...
 * ...
 * wjl_boost::asio::streambuf b;
 * wjl_boost::asio::async_read_until(s, b, match_char('a'), handler);
 * @endcode
 */
