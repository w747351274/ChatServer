...
#error "wjl_boost::format uses a local macro that is already defined."
#endif
...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost { namespace io { namespace detail {
#if ! defined(BOOST_NO_STD_LOCALE)
