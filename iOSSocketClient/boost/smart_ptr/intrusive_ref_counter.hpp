...
{
    typedef wjl_boost::detail::atomic_count type;

    static unsigned int load(wjl_boost::detail::atomic_count const& counter) BOOST_SP_NOEXCEPT
    {
        return static_cast< unsigned int >(static_cast< long >(counter));
    }

    static void increment(wjl_boost::detail::atomic_count& counter) BOOST_SP_NOEXCEPT
    {
        ++counter;
    }

    static unsigned int decrement(wjl_boost::detail::atomic_count& counter) BOOST_SP_NOEXCEPT
    {
