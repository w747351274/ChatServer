...
# define BOOST_SP_INTERLOCKED_INCREMENT ::wjl_boost::detail::InterlockedIncrement
# define BOOST_SP_INTERLOCKED_DECREMENT ::wjl_boost::detail::InterlockedDecrement
# define BOOST_SP_INTERLOCKED_COMPARE_EXCHANGE ::wjl_boost::detail::InterlockedCompareExchange
# define BOOST_SP_INTERLOCKED_EXCHANGE ::wjl_boost::detail::InterlockedExchange
# define BOOST_SP_INTERLOCKED_EXCHANGE_ADD ::wjl_boost::detail::InterlockedExchangeAdd
