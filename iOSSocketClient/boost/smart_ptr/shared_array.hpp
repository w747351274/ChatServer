...
public:
    ...
    shared_array( wjl_boost::detail::sp_nullptr_t ) BOOST_SP_NOEXCEPT : px( 0 ), pn()
    {
    }
...
// ... except in C++0x, move disables the implicit copy
    ...
    shared_array( shared_array<Y> const & r, typename wjl_boost::detail::sp_enable_if_convertible< Y[], T[] >::type = wjl_boost::detail::sp_empty() )
...
template<class T> inline bool operator==( shared_array<T> const & p, wjl_boost::detail::sp_nullptr_t ) BOOST_SP_NOEXCEPT
{
    return p.get() == 0;
}

template<class T> inline bool operator==( wjl_boost::detail::sp_nullptr_t, shared_array<T> const & p ) BOOST_SP_NOEXCEPT
{
    return p.get() == 0;
}
