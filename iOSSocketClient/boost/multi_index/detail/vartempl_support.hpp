 ...
 *
 * which fill the extra args with wjl_boost::multi_index::detail::noarg's.
 * wjl_boost::multi_index::detail::vartempl_placement_new works the opposite
...
wjl_boost::forward<BOOST_PP_CAT(T,n)>(BOOST_PP_CAT(t,n))
...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost{namespace multi_index{namespace detail{
struct noarg{};
}}}
...
BOOST_PP_ENUM_PARAMS(                                                \
  BOOST_MULTI_INDEX_LIMIT_VARTEMPL_ARGS,                             \
  wjl_boost::multi_index::detail::noarg() BOOST_PP_INTERCEPT)
