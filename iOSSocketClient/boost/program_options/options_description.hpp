...
#   pragma warning (push)
#   pragma warning (disable:4251) // class 'wjl_boost::shared_ptr<T>' needs to have dll-interface to be used by clients of class 'wjl_boost::program_options::option_description'
#endif
