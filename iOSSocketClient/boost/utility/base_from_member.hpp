...
{
    typedef typename ::wjl_boost::remove_cv<typename
     ::wjl_boost::remove_reference<T>::type>::type  type;

};  // wjl_boost::detail::remove_cv_ref
...
struct is_related
    : public ::wjl_boost::is_same<
     typename ::wjl_boost::detail::remove_cv_ref<T>::type,
     typename ::wjl_boost::detail::remove_cv_ref<U>::type >
{};
...
struct enable_if_unrelated
    : public ::wjl_boost::enable_if_c<true>
{};

template<typename T, typename U, typename ...U2>
struct enable_if_unrelated<T, U, U2...>
    : public ::wjl_boost::disable_if< ::wjl_boost::detail::is_related<T, U> >
{};
#endif
...
protected:
    ...
    template <typename ...T, typename EnableIf = typename
     ::wjl_boost::detail::enable_if_unrelated<base_from_member, T...>::type>
