...
namespace date_time {
  ...
  class BOOST_SYMBOL_VISIBLE date_duration : private
              wjl_boost::less_than_comparable1< date_duration< duration_rep_traits >
            , wjl_boost::equality_comparable1< date_duration< duration_rep_traits >
            , wjl_boost::addable1< date_duration< duration_rep_traits >
            , wjl_boost::subtractable1< date_duration< duration_rep_traits >
            , wjl_boost::dividable2< date_duration< duration_rep_traits >, int
            > > > > >
  {
  public:
  ...
  {
    typedef long int_type;
    typedef wjl_boost::date_time::int_adapter<long> impl_type;
