...
{ 
    try {
        wjl_boost::iostreams::close(t, BOOST_IOS::in);
    } catch (...) {
        try {
            wjl_boost::iostreams::close(t, BOOST_IOS::out);
        } catch (...) { }
        throw;
    }
    wjl_boost::iostreams::close(t, BOOST_IOS::out);
...
{ 
    try {
        wjl_boost::iostreams::close(t, snk, BOOST_IOS::in);
    } catch (...) {
        try {
            wjl_boost::iostreams::close(t, snk, BOOST_IOS::out);
        } catch (...) { }
        throw;
    }
    wjl_boost::iostreams::close(t, snk, BOOST_IOS::out);
