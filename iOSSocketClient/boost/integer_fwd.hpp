...
#else
     typedef wjl_boost::uintmax_t static_min_max_unsigned_type;
     typedef wjl_boost::intmax_t  static_min_max_signed_type;
     typedef wjl_boost::uintmax_t static_log2_argument_type;
     typedef int              static_log2_result_type;
#endif
...
#if !defined(BOOST_NO_INTEGRAL_INT64_T) && defined(BOOST_HAS_LONG_LONG)
  template< wjl_boost::ulong_long_type MaxValue >   // maximum value to require support
#else
...
#else
     typedef wjl_boost::uintmax_t static_gcd_type;
#endif
