...
//             wjl_boost::detail::type to boost/type.hpp. Made it compile with
...
//  numeric_cast  ------------------------------------------------------------//
    ...
    namespace detail
    {
      ...
      // Move to namespace wjl_boost in utility.hpp?
...
# ifdef BOOST_HAS_LONG_LONG
      ...
      template <>
      struct fixed_numeric_limits_base< ::wjl_boost::long_long_type, false>
      {
          BOOST_STATIC_CONSTANT(bool, is_specialized = true);
          BOOST_STATIC_CONSTANT(bool, is_signed = true);
          static  ::wjl_boost::long_long_type max BOOST_PREVENT_MACRO_SUBSTITUTION ()
          {
#  ifdef LONGLONG_MAX
              return LONGLONG_MAX;
#  else
...
#  endif
          ...
          static  ::wjl_boost::long_long_type min BOOST_PREVENT_MACRO_SUBSTITUTION ()
          {
#  ifdef LONGLONG_MIN
              return LONGLONG_MIN;
#  else
...
#  endif
      ...
      template <>
      struct fixed_numeric_limits_base< ::wjl_boost::ulong_long_type, false>
      {
          BOOST_STATIC_CONSTANT(bool, is_specialized = true);
          BOOST_STATIC_CONSTANT(bool, is_signed = false);
          static  ::wjl_boost::ulong_long_type max BOOST_PREVENT_MACRO_SUBSTITUTION ()
          {
#  ifdef ULONGLONG_MAX
...
#  endif
          ...
          static  ::wjl_boost::ulong_long_type min BOOST_PREVENT_MACRO_SUBSTITUTION () { return 0; }
      };
# endif
    } // namespace detail
