...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost
{
    namespace hash_detail
    {
        ...
        template <> struct basic_numbers<bool> :
            wjl_boost::hash_detail::enable_hash_value {};
        ...
        template <> struct long_numbers<wjl_boost::long_long_type> :
            wjl_boost::hash_detail::enable_hash_value {};
        template <> struct ulong_numbers<wjl_boost::ulong_long_type> :
            wjl_boost::hash_detail::enable_hash_value {};
#endif

#if defined(BOOST_HAS_INT128)
        template <> struct long_numbers2<wjl_boost::int128_type> :
            wjl_boost::hash_detail::enable_hash_value {};
        template <> struct ulong_numbers2<wjl_boost::uint128_type> :
            wjl_boost::hash_detail::enable_hash_value {};
#endif
    ...
    template <typename T>
    typename wjl_boost::hash_detail::basic_numbers<T>::type hash_value(T);
    template <typename T>
    typename wjl_boost::hash_detail::long_numbers<T>::type hash_value(T);
    template <typename T>
    typename wjl_boost::hash_detail::ulong_numbers<T>::type hash_value(T);

    template <typename T>
    typename wjl_boost::enable_if<wjl_boost::is_enum<T>, std::size_t>::type
        hash_value(T);
    ...
    template <typename T>
    typename wjl_boost::hash_detail::float_numbers<T>::type hash_value(T);
    ...
    namespace hash_detail
    {
        ...
        inline void hash_combine_impl(wjl_boost::uint32_t& h1,
                wjl_boost::uint32_t k1)
        {
...
// and also not for 32-bit gcc as it warns about the 64-bit constant.
        ...
        inline void hash_combine_impl(wjl_boost::uint64_t& h,
                wjl_boost::uint64_t k)
        {
            const wjl_boost::uint64_t m = UINT64_C(0xc6a4a7935bd1e995);
            const int r = 47;
    ...
    template <typename T>
    typename wjl_boost::hash_detail::basic_numbers<T>::type hash_value(T v)
    {
        return static_cast<std::size_t>(v);
    }

    template <typename T>
    typename wjl_boost::hash_detail::long_numbers<T>::type hash_value(T v)
    {
        return hash_detail::hash_value_signed(v);
    }

    template <typename T>
    typename wjl_boost::hash_detail::ulong_numbers<T>::type hash_value(T v)
    {
...
#pragma warning(disable:4267) // 'argument' : conversion from 'size_t' to
    ...
    {
        wjl_boost::hash<T> hasher;
        return wjl_boost::hash_detail::hash_combine_impl(seed, hasher(v));
    }
...
#pragma warning(pop)
    ...
    template <typename T>
    typename wjl_boost::hash_detail::float_numbers<T>::type hash_value(T v)
    {
        return wjl_boost::hash_detail::float_hash_value(v);
    }
    ...
    // wjl_boost::hash is defined later in extensions.hpp if
...
#define BOOST_HASH_SPECIALIZE(type) \
    template <> struct hash<type> \
         : public wjl_boost::hash_detail::hash_base<type> \
    { \
        std::size_t operator()(type v) const \
        { \
            return wjl_boost::hash_value(v); \
        } \
    };
...
#if !defined(BOOST_NO_LONG_LONG)
    BOOST_HASH_SPECIALIZE(wjl_boost::long_long_type)
    BOOST_HASH_SPECIALIZE(wjl_boost::ulong_long_type)
#endif

#if defined(BOOST_HAS_INT128)
    BOOST_HASH_SPECIALIZE(wjl_boost::int128_type)
    BOOST_HASH_SPECIALIZE(wjl_boost::uint128_type)
#endif
...
// Specializing wjl_boost::hash for pointers.

#if !defined(BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION)

    template <class T>
    struct hash<T*>
        : public wjl_boost::hash_detail::hash_base<T*>
    {
    ...
    // wjl_boost::hash for all remaining types. But hash_impl is only defined
        ...
        struct hash_impl<true>
        {
                ...
                : public wjl_boost::hash_detail::hash_base<T>
            {
                std::size_t operator()(T val) const
                {
                    ...
                    return wjl_boost::hash_value(val);
#else
                    std::size_t x = static_cast<std::size_t>(
    ...
    template <class T> struct hash
        : public wjl_boost::hash_detail::hash_impl<wjl_boost::is_pointer<T>::value>
