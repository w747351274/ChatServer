...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost { namespace parameter {
...
#define BOOST_PARAMETER_KEYWORD(tag_namespace,name)                 \
    ...
    namespace                                                       \
    {                                                               \
       ::wjl_boost::parameter::keyword<tag_namespace::name> const& name \
       = ::wjl_boost::parameter::keyword<tag_namespace::name>::instance;\
    }

}} // namespace wjl_boost::parameter
