...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost { namespace parameter { namespace aux {
...
template <
  ...
  , BOOST_PP_ENUM_BINARY_PARAMS(
        BOOST_PARAMETER_MAX_ARITY, class A, = wjl_boost::parameter::void_ BOOST_PP_INTERCEPT
    )
>
struct match
...
struct funptr_predicate
{
    ...
    struct apply
    {
        BOOST_STATIC_CONSTANT(bool, result = 
            sizeof(check_predicate(wjl_boost::type<T>(), (Args*)0, &p)) == 1
        );
...
}}} // namespace wjl_boost::parameter::aux
...
#  define BOOST_PARAMETER_FUNCTION_FWD_MATCH_Z(z, name, parameters, n) \
    , typename wjl_boost::parameter::aux::match< \
...
# define BOOST_PARAMETER_FUNCTION_FWD_FUNCTION00(z, n, r, data, elem) \
    ...
    BOOST_PP_EXPR_IF(n, typename) \
        ...
        BOOST_PP_EXPR_IF(n, typename) \
        wjl_boost::parameter::aux::argument_pack< \
...
// Builds wjl_boost::parameter::parameters<> specialization
...
#  define BOOST_PARAMETER_FUNCTION_PARAMETERS_M(r,tag_namespace,i,elem) \
    ...
    wjl_boost::parameter::BOOST_PP_CAT( \
      ...
      , typename wjl_boost::parameter::aux::unwrap_predicate< \
...
#  define BOOST_PARAMETER_FUNCTION_PARAMETERS_M(r,tag_namespace,i,elem) \
    ...
    wjl_boost::parameter::BOOST_PP_CAT( \
      ...
      , wjl_boost::mpl::always<wjl_boost::mpl::true_> \
    >
# endif
...
# define BOOST_PARAMETER_FUNCTION_PARAMETERS(tag_namespace, base, args)             \
    ...
    ) : wjl_boost::parameter::parameters<                                               \
...
# define BOOST_PARAMETER_FUNCTION_DEFAULT_EVAL_DEFAULT(arg, tag_namespace) \
    wjl_boost::parameter::keyword< \
        tag_namespace::BOOST_PARAMETER_FN_ARG_KEYWORD(arg) \
    >::instance | wjl_boost::parameter::aux::use_default_tag()
...
# define BOOST_PARAMETER_FUNCTION_DEFAULT_EVAL_ACTUAL_DEFAULT(arg) \
    BOOST_PARAMETER_FUNCTION_CAST( \
        wjl_boost::parameter::aux::as_lvalue(BOOST_PARAMETER_FN_ARG_DEFAULT(arg), 0L) \
      , BOOST_PARAMETER_FN_ARG_PRED(arg) \
      , Args \
    )
...
# define BOOST_PARAMETER_FUNCTION_DEFAULT_EVAL_DEFAULT_BODY(name, n, split_args, tag_ns, const_) \
    ...
    ResultType BOOST_PARAMETER_FUNCTION_DEFAULT_NAME(name)( \
      ...
      , wjl_boost::parameter::aux::use_default_tag \
...
# define BOOST_PARAMETER_FUNCTION_DEFAULT_GET_ARG(r, tag_ns, arg) \
    , BOOST_PARAMETER_FUNCTION_CAST( \
          args[ \
              wjl_boost::parameter::keyword<tag_ns::BOOST_PARAMETER_FN_ARG_KEYWORD(arg)>::instance \
          ] \
        , BOOST_PARAMETER_FN_ARG_PRED(arg) \
        , Args \
      )
