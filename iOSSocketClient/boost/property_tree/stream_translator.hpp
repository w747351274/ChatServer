...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost { namespace property_tree
{
    ...
    namespace detail
    {
        ...
        struct is_inexact_impl
        {
            ...
            struct test
            {
                typedef wjl_boost::false_type type;
            };
        };
        template <>
        struct is_inexact_impl<true>
        {
            ...
            struct test
            {
              typedef wjl_boost::integral_constant<bool,
        ...
        struct is_inexact
        {
            typedef typename wjl_boost::decay<F>::type decayed;
    ...
    struct customize_stream<Ch, Traits, F,
        typename wjl_boost::enable_if< detail::is_inexact<F> >::type
    >
    {
    ...
    public:
        ...
        wjl_boost::optional<E> get_value(const internal_type &v) {
            std::basic_istringstream<Ch, Traits, Alloc> iss(v);
            iss.imbue(m_loc);
            E e;
            customized::extract(iss, e);
            if(iss.fail() || iss.bad() || iss.get() != Traits::eof()) {
                return wjl_boost::optional<E>();
            }
            return e;
        }
        wjl_boost::optional<internal_type> put_value(const E &v) {
            ...
            return wjl_boost::optional<internal_type>();
        }
