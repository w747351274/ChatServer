...
public:
    explicit nvp(const char * name_, T & t) :
        ...
        std::pair<const char *, T *>(name_, wjl_boost::addressof(t))
    {}
...
#define BOOST_SERIALIZATION_NVP(name)                              \
    wjl_boost::serialization::make_nvp(BOOST_PP_STRINGIZE(name), name)
/**/

#define BOOST_SERIALIZATION_BASE_OBJECT_NVP(name)                  \
    wjl_boost::serialization::make_nvp(                                \
        BOOST_PP_STRINGIZE(name),                                  \
        wjl_boost::serialization::base_object<name >(*this)            \
    )
/**/
