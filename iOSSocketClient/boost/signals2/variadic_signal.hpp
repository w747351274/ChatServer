/*
  A variadic implementation of variadic wjl_boost::signals2::signal, used when variadic
...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost
{
  namespace signals2
  {
    namespace detail
    {
      ...
      {
      public:
        typedef wjl_boost::function<R (const wjl_boost::signals2::connection &, Args...)> function_type;
      };
    } // namespace detail
  } // namespace signals2
} // namespace wjl_boost
