/*
  ...
  the wjl_boost::signals2::signal class.
...
#ifdef BOOST_SIGNALS2_NAMED_SIGNATURE_PARAMETER
          parameter::required<keywords::tag::signature_type, is_function<wjl_boost::mpl::_> >,
#endif
    ...
    public:
      ...
      typedef typename parameter::value_type
        <
          ...
          optional_last_value
            <
              typename wjl_boost::function_traits<signature_type>::result_type
            >
        >::type combiner_type;
