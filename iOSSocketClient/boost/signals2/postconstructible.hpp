...
// The objects must inherit from wjl_boost::signals2::postconstructible, and
// have their lifetimes managed by
// wjl_boost::shared_ptr created with the wjl_boost::signals2::deconstruct_ptr()
// function.
//
...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost
{
  ...
  namespace signals2
  {
    ...
    namespace detail
    {
      void do_postconstruct(const wjl_boost::signals2::postconstructible_adl_barrier::postconstructible *ptr);
    } // namespace detail
