...
{
   typedef typename remove_cv<T>::type no_cv_t;
   BOOST_STATIC_CONSTANT(bool, value = (!(::wjl_boost::detail::is_signed_values<T>::minus_one  > wjl_boost::detail::is_signed_values<T>::zero)));
};
...
{
   typedef ::wjl_boost::detail::is_signed_select_helper< ::wjl_boost::is_integral<T>::value || ::wjl_boost::is_enum<T>::value> selector;
...
template <class T> struct is_signed : public integral_constant<bool, wjl_boost::detail::is_signed_impl<T>::value> {};
...
template <> struct is_signed< ::wjl_boost::long_long_type> : public true_type{};
template <> struct is_signed<const ::wjl_boost::long_long_type> : public true_type{};
template <> struct is_signed<volatile ::wjl_boost::long_long_type> : public true_type{};
template <> struct is_signed<const volatile ::wjl_boost::long_long_type> : public true_type{};

template <> struct is_signed< ::wjl_boost::ulong_long_type> : public false_type{};
template <> struct is_signed<const ::wjl_boost::ulong_long_type> : public false_type{};
template <> struct is_signed<volatile ::wjl_boost::ulong_long_type> : public false_type{};
template <> struct is_signed<const volatile ::wjl_boost::ulong_long_type> : public false_type{};
#endif
#if defined(CHAR_MIN) 
#if CHAR_MIN != 0
