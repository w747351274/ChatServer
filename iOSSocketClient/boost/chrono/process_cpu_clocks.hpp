...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost { namespace chrono {
...
namespace chrono
{
  ...
  typedef process_times<nanoseconds::rep> process_cpu_clock_times;
    ...
    public:
        ...
        typedef wjl_boost::chrono::duration<times,  nano>                duration;
        typedef duration::rep                       rep;
        typedef duration::period                    period;
...
namespace std {
    ...
    template <typename Rep>
    struct numeric_limits<wjl_boost::chrono::process_times<Rep> >
    {
        typedef wjl_boost::chrono::process_times<Rep> Res;
