...
#pragma warning(disable: 4355)
    ...
    private:
      ...
      private:
        ...
        wjl_boost::system::error_category const * pc_;

      public:

        BOOST_SYSTEM_CONSTEXPR explicit std_category( wjl_boost::system::error_category const * pc ): pc_( pc )
        {
        }
    ...
    public:
      ...
      template <class ErrorConditionEnum>
        error_condition(ErrorConditionEnum e,
          typename wjl_boost::enable_if<is_error_condition_enum<ErrorConditionEnum> >::type*
      ...
      template<typename ErrorConditionEnum>
        typename wjl_boost::enable_if<is_error_condition_enum<ErrorConditionEnum>,
    ...
    public:
      ...
      template <class ErrorCodeEnum>
        error_code(ErrorCodeEnum e,
          typename wjl_boost::enable_if<is_error_code_enum<ErrorCodeEnum> >::type* = 0)
          BOOST_SYSTEM_NOEXCEPT
      {
      ...
      template<typename ErrorCodeEnum>
        typename wjl_boost::enable_if<is_error_code_enum<ErrorCodeEnum>, error_code>::type &
...
# endif
    ...
    //  "throws" function in namespace wjl_boost rather than namespace wjl_boost::system.
  ...
  namespace system
  {
      ...
      const std::error_condition & condition ) const BOOST_NOEXCEPT
    {
      ...
      {
        wjl_boost::system::error_condition bn( condition.value(), *pc_ );
        return pc_->equivalent( code, bn );
      }
      else if( condition.category() == std::generic_category()
        || condition.category() == wjl_boost::system::generic_category() )
      {
        wjl_boost::system::error_condition bn( condition.value(),
          wjl_boost::system::generic_category() );
        ...
        &condition.category() ) )
      {
        wjl_boost::system::error_condition bn( condition.value(), *pc2->pc_ );
        return pc_->equivalent( code, bn );
      }
#endif
      else
      ...
      int condition ) const BOOST_NOEXCEPT
    {
      ...
      {
        wjl_boost::system::error_code bc( code.value(), *pc_ );
        return pc_->equivalent( bc, condition );
      }
      else if( code.category() == std::generic_category()
        || code.category() == wjl_boost::system::generic_category() )
      {
        wjl_boost::system::error_code bc( code.value(),
          wjl_boost::system::generic_category() );
        ...
        &code.category() ) )
      {
        wjl_boost::system::error_code bc( code.value(), *pc2->pc_ );
        return pc_->equivalent( bc, condition );
      }
#endif
      else if( *pc_ == wjl_boost::system::generic_category() )
      {
