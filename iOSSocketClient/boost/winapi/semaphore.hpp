...
CreateSemaphoreA(
    ...
    wjl_boost::winapi::LONG_ lInitialCount,
    wjl_boost::winapi::LONG_ lMaximumCount,
    wjl_boost::winapi::LPCSTR_ lpName);
...
CreateSemaphoreW(
    ...
    wjl_boost::winapi::LONG_ lInitialCount,
    wjl_boost::winapi::LONG_ lMaximumCount,
    wjl_boost::winapi::LPCWSTR_ lpName);
...
ReleaseSemaphore(
    wjl_boost::winapi::HANDLE_ hSemaphore,
    wjl_boost::winapi::LONG_ lReleaseCount,
    wjl_boost::winapi::LPLONG_ lpPreviousCount);
