...
typedef wjl_boost::winapi::VOID_ (BOOST_WINAPI_NTAPI_CC *WAITORTIMERCALLBACKFUNC)
    (wjl_boost::winapi::PVOID_, wjl_boost::winapi::BOOLEAN_);
typedef WAITORTIMERCALLBACKFUNC WAITORTIMERCALLBACK;

BOOST_SYMBOL_IMPORT wjl_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
RegisterWaitForSingleObject(
    wjl_boost::winapi::PHANDLE_ phNewWaitObject,
    wjl_boost::winapi::HANDLE_ hObject,
    WAITORTIMERCALLBACK Callback,
    wjl_boost::winapi::PVOID_ Context,
    wjl_boost::winapi::ULONG_ dwMilliseconds,
    wjl_boost::winapi::ULONG_ dwFlags);
#endif
} // extern "C"
#endif
...
#if BOOST_WINAPI_PARTITION_DESKTOP
BOOST_SYMBOL_IMPORT wjl_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
UnregisterWait(wjl_boost::winapi::HANDLE_ WaitHandle);
#endif

#if BOOST_WINAPI_PARTITION_DESKTOP || BOOST_WINAPI_PARTITION_SYSTEM
BOOST_SYMBOL_IMPORT wjl_boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
UnregisterWaitEx(
    wjl_boost::winapi::HANDLE_ WaitHandle,
    wjl_boost::winapi::HANDLE_ CompletionEvent);
#endif
} // extern "C"
#endif
