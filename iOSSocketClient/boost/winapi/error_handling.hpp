...
FormatMessageA(
    ...
    wjl_boost::winapi::LPCVOID_ lpSource,
    wjl_boost::winapi::DWORD_ dwMessageId,
    wjl_boost::winapi::DWORD_ dwLanguageId,
    wjl_boost::winapi::LPSTR_ lpBuffer,
...
FormatMessageW(
    ...
    wjl_boost::winapi::DWORD_ dwMessageId,
    wjl_boost::winapi::DWORD_ dwLanguageId,
    wjl_boost::winapi::LPWSTR_ lpBuffer,
    wjl_boost::winapi::DWORD_ nSize,
    va_list *Arguments);

#if BOOST_WINAPI_PARTITION_DESKTOP || BOOST_WINAPI_PARTITION_SYSTEM
BOOST_SYMBOL_IMPORT wjl_boost::winapi::UINT_ BOOST_WINAPI_WINAPI_CC
SetErrorMode(wjl_boost::winapi::UINT_ uMode);
#endif
} // extern "C"
#endif
