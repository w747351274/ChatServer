...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost
{
    namespace iterator_range_detail
    {
        ...
        struct iterator_range_impl {
            ...
            {
                return IteratorT( wjl_boost::begin( r ) );
            }

            template< class ForwardRange >
            static IteratorT adl_end( ForwardRange& r )
            {
                return IteratorT( wjl_boost::end( r ) );
            }
        };
        ...
        {
            return std::lexicographical_compare( wjl_boost::begin(l),
                                                 wjl_boost::end(l),
                                                 wjl_boost::begin(r),
                                                 wjl_boost::end(r) );
        }
...
incrementable_t test_traversal_tag(wjl_boost::incrementable_traversal_tag);
bidirectional_t test_traversal_tag(wjl_boost::bidirectional_traversal_tag);
random_access_t test_traversal_tag(wjl_boost::random_access_traversal_tag);

template<std::size_t S>
struct pure_iterator_traversal_impl
{
    typedef wjl_boost::incrementable_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(bidirectional_t)>
{
    typedef wjl_boost::bidirectional_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(random_access_t)>
{
    typedef wjl_boost::random_access_traversal_tag type;
};
...
public:
    ...
    reference back() const
    {
        ...
        return *wjl_boost::prior(this->m_End);
    }
...
//  iterator range template class -----------------------------------------//
        ...
        /*!
            ...
            \code
                wjl_boost::tolower( find( s, "UPPERCASE STRING" ) );
            \endcode
        ...
        */
        ...
        public:
            ...
            iterator_range(
                ...
                BOOST_DEDUCED_TYPENAME ::wjl_boost::enable_if<
...
//  iterator range free-standing operators ---------------------------//
        ...
        inline BOOST_DEDUCED_TYPENAME wjl_boost::enable_if<
        ...
        template< class IteratorT, class ForwardRange >
        inline BOOST_DEDUCED_TYPENAME wjl_boost::enable_if<
            mpl::not_<wjl_boost::is_base_and_derived<iterator_range_detail::iterator_range_tag, ForwardRange> >,
            bool
        >::type
        operator!=( const ForwardRange& l, const iterator_range<IteratorT>& r )
        {
...
//  iterator range utilities -----------------------------------------//
        ...
        */
        ...
        {
            return iterator_range<IteratorT>(first, wjl_boost::next(first, n));
        }
        ...
        make_iterator_range( Range& r )
        {
            return iterator_range< BOOST_DEDUCED_TYPENAME range_iterator<Range>::type >
                ( wjl_boost::begin( r ), wjl_boost::end( r ) );
        }
        ...
        namespace iterator_range_detail
        {
                             ...
                             BOOST_DEDUCED_TYPENAME range_difference<Range>::type advance_end )
            {
                ...
                BOOST_DEDUCED_TYPENAME range_iterator<Range>::type
                    new_begin = wjl_boost::begin( r ),
                    new_end   = wjl_boost::end( r );
        ...
        */
        ...
        {
            return SeqT( wjl_boost::begin( r ), wjl_boost::end( r ) );
        }
