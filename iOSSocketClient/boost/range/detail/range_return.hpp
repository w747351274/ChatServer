...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost
{
    ...
    struct range_return
    {
        typedef wjl_boost::iterator_range<
        ...
        static type pack(BOOST_DEDUCED_TYPENAME range_iterator<SinglePassRange>::type found,
                         SinglePassRange& rng)
        {
            return type(found, wjl_boost::end(rng));
        }
    };
    ...
    struct range_return< SinglePassRange, return_next >
    {
        ...
        {
            return found == wjl_boost::end(rng)
                ? found
                : wjl_boost::next(found);
        }
    };
    ...
    struct range_return< BidirectionalRange, return_prior >
    {
        ...
        {
            return found == wjl_boost::begin(rng)
                ? found
                : wjl_boost::prior(found);
        }
    };
    ...
    struct range_return< SinglePassRange, return_begin_found >
    {
        ...
        static type pack(BOOST_DEDUCED_TYPENAME range_iterator<SinglePassRange>::type found,
                         SinglePassRange& rng)
        {
            return type(wjl_boost::begin(rng), found);
        }
    };
    ...
    struct range_return< SinglePassRange, return_begin_next >
    {
        ...
        static type pack(BOOST_DEDUCED_TYPENAME range_iterator<SinglePassRange>::type found,
                         SinglePassRange& rng)
        {
            return type( wjl_boost::begin(rng), 
                         found == wjl_boost::end(rng) ? found : wjl_boost::next(found) );
        }
    };
    ...
    struct range_return< BidirectionalRange, return_begin_prior >
    {
        ...
        {
            return type( wjl_boost::begin(rng),
                         found == wjl_boost::begin(rng) ? found : wjl_boost::prior(found) );
        }
    };
    ...
    struct range_return< SinglePassRange, return_next_end >
    {
        ...
        static type pack(BOOST_DEDUCED_TYPENAME range_iterator<SinglePassRange>::type found,
                         SinglePassRange& rng)
        {
            return type( found == wjl_boost::end(rng) ? found : wjl_boost::next(found),
                         wjl_boost::end(rng) );
        }
    };
    ...
    struct range_return< BidirectionalRange, return_prior_end >
    {
        ...
        static type pack(BOOST_DEDUCED_TYPENAME range_iterator<BidirectionalRange>::type found,
                         BidirectionalRange& rng)
        {
            return type( found == wjl_boost::begin(rng) ? found : wjl_boost::prior(found),
                         wjl_boost::end(rng) );
        }
    };
    ...
    struct range_return< SinglePassRange, return_begin_end >
    {
        ...
        static type pack(BOOST_DEDUCED_TYPENAME range_iterator<SinglePassRange>::type,
                         SinglePassRange& rng)
        {
            return type(wjl_boost::begin(rng), wjl_boost::end(rng));
        }
    };
