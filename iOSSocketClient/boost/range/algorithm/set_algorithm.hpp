                     ...
                     const SinglePassRange2& rng2)
{
    ...
    return std::includes(wjl_boost::begin(rng1),wjl_boost::end(rng1),
                         wjl_boost::begin(rng2),wjl_boost::end(rng2));
}
                     ...
                     BinaryPredicate         pred)
{
    ...
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange2> ));
    return std::includes(wjl_boost::begin(rng1), wjl_boost::end(rng1),
                         wjl_boost::begin(rng2), wjl_boost::end(rng2), pred);
}
                                ...
                                OutputIterator          out)
{
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange1> ));
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange2> ));
    return std::set_union(wjl_boost::begin(rng1), wjl_boost::end(rng1),
                          wjl_boost::begin(rng2), wjl_boost::end(rng2), out);
}
                                ...
                                BinaryPredicate         pred)
{
    ...
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange2> ));
    return std::set_union(wjl_boost::begin(rng1), wjl_boost::end(rng1),
                          wjl_boost::begin(rng2), wjl_boost::end(rng2), out, pred);
}
                                       ...
                                       OutputIterator          out)
{
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange1> ));
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange2> ));
    return std::set_intersection(wjl_boost::begin(rng1), wjl_boost::end(rng1),
                                 wjl_boost::begin(rng2), wjl_boost::end(rng2), out);
}
                                     ...
                                     OutputIterator out)
{
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange1> ));
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange2> ));
    return std::set_difference(wjl_boost::begin(rng1), wjl_boost::end(rng1),
                               wjl_boost::begin(rng2), wjl_boost::end(rng2), out);
}
                                     ...
                                     BinaryPredicate         pred)
{
    ...
    return std::set_difference(
        wjl_boost::begin(rng1), wjl_boost::end(rng1),
        wjl_boost::begin(rng2), wjl_boost::end(rng2), out, pred);
}
                         ...
                         OutputIterator          out)
{
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange1> ));
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange2> ));
    return std::set_symmetric_difference(wjl_boost::begin(rng1), wjl_boost::end(rng1),
                                         wjl_boost::begin(rng2), wjl_boost::end(rng2), out);
}
