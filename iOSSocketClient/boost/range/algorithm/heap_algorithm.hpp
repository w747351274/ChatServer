...
inline RandomAccessRange& push_heap(RandomAccessRange& rng)
{
    ...
    std::push_heap(wjl_boost::begin(rng), wjl_boost::end(rng));
    return rng;
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::push_heap(wjl_boost::begin(rng), wjl_boost::end(rng), comp_pred);
    return rng;
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::pop_heap(wjl_boost::begin(rng), wjl_boost::end(rng));
    return rng;
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::pop_heap(wjl_boost::begin(rng), wjl_boost::end(rng), comp_pred);
    return rng;
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::make_heap(wjl_boost::begin(rng), wjl_boost::end(rng));
    return rng;
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::make_heap(wjl_boost::begin(rng), wjl_boost::end(rng), comp_pred);
    return rng;
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::sort_heap(wjl_boost::begin(rng), wjl_boost::end(rng));
    return rng;
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::sort_heap(wjl_boost::begin(rng), wjl_boost::end(rng), comp_pred);
    return rng;
}
