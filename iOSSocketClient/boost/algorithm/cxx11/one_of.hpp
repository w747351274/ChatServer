...
//  find_if
    ...
    return wjl_boost::algorithm::none_of (++first, last, p);
}
...
{
    return wjl_boost::algorithm::one_of ( wjl_boost::begin (r), wjl_boost::end (r), p );
}
...
//  find
    ...
    if (first == last)
        return false;                    // Didn't occur at all
    return wjl_boost::algorithm::none_of_equal (++first, last, val);
}
...
{
    return wjl_boost::algorithm::one_of_equal ( wjl_boost::begin (r), wjl_boost::end (r), val );
} 
