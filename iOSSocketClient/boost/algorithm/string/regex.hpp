...
//  find_regex  -----------------------------------------------//
        ...
        */
        ...
        {
            iterator_range<BOOST_STRING_TYPENAME range_iterator<RangeT>::type> lit_input(::wjl_boost::as_literal(Input));

            return ::wjl_boost::algorithm::regex_finder(Rx,Flags)(
                ::wjl_boost::begin(lit_input), ::wjl_boost::end(lit_input) );
        }
...
//  replace_regex --------------------------------------------------------------------//
        ...
        */
        ...
        {
            return ::wjl_boost::algorithm::find_format_copy( 
                Output,
                Input,
                ::wjl_boost::algorithm::regex_finder( Rx, Flags ),
                ::wjl_boost::algorithm::regex_formatter( Format, Flags ) );
        }
        ...
        */
        ...
        inline void replace_regex( 
            ...
            match_flag_type Flags=match_default | format_default )
        {
            ::wjl_boost::algorithm::find_format( 
                Input,
                ::wjl_boost::algorithm::regex_finder( Rx, Flags ),
                ::wjl_boost::algorithm::regex_formatter( Format, Flags ) );
        }
...
//  replace_all_regex --------------------------------------------------------------------//
        ...
        */
        ...
        inline OutputIteratorT replace_all_regex_copy(
            ...
            match_flag_type Flags=match_default | format_default )
        {
            return ::wjl_boost::algorithm::find_format_all_copy( 
                Output,
                Input,
                ::wjl_boost::algorithm::regex_finder( Rx, Flags ),
                ::wjl_boost::algorithm::regex_formatter( Format, Flags ) );
        ...
        */
        ...
        inline void replace_all_regex( 
            ...
            match_flag_type Flags=match_default | format_default )
        {
            ::wjl_boost::algorithm::find_format_all( 
                Input,
                ::wjl_boost::algorithm::regex_finder( Rx, Flags ),
                ::wjl_boost::algorithm::regex_formatter( Format, Flags ) );
        }
       ...
       */
            ...
            match_flag_type Flags=match_default )
        {
            return ::wjl_boost::algorithm::find_format_copy(
                ...
                Input,
                ::wjl_boost::algorithm::regex_finder( Rx, Flags ),
                ::wjl_boost::algorithm::empty_formatter( Input ) );
        }
...
//  find_all_regex ------------------------------------------------------------------//
        ...
        /*!
            ...
            or \c std::list<wjl_boost::iterator_range<std::string::iterator>>
        ...
        */
        ...
        inline SequenceSequenceT& find_all_regex(
            ...
            match_flag_type Flags=match_default )
        {
            return ::wjl_boost::algorithm::iter_find(
                Result,
                Input,
                ::wjl_boost::algorithm::regex_finder(Rx,Flags) );         
        }
...
//  split_regex ------------------------------------------------------------------//
        ...
        */
        ...
        inline SequenceSequenceT& split_regex(
            ...
            match_flag_type Flags=match_default )
        {
            return ::wjl_boost::algorithm::iter_split(
                Result,
                Input,
                ::wjl_boost::algorithm::regex_finder(Rx,Flags) );         
        }
...
//  join_if ------------------------------------------------------------------//
        ...
        */
            ...
            match_flag_type Flags=match_default )
        {
            ...
            // Parse input
            InputIteratorT itBegin=::wjl_boost::begin(Input);
            InputIteratorT itEnd=::wjl_boost::end(Input);
            ...
            while(
                itBegin!=itEnd && 
                !::wjl_boost::regex_match(::wjl_boost::begin(*itBegin), ::wjl_boost::end(*itBegin), Rx, Flags)) ++itBegin;

            // Add this element
            if(itBegin!=itEnd)
            {
                detail::insert(Result, ::wjl_boost::end(Result), *itBegin);
                ++itBegin;
            }

            for(;itBegin!=itEnd; ++itBegin)
            {
                if(::wjl_boost::regex_match(::wjl_boost::begin(*itBegin), ::wjl_boost::end(*itBegin), Rx, Flags))
                {
                    // Add separator
                    detail::insert(Result, ::wjl_boost::end(Result), ::wjl_boost::as_literal(Separator));
                    // Add element
                    detail::insert(Result, ::wjl_boost::end(Result), *itBegin);
                }
            }
