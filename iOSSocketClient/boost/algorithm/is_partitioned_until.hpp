...
typename wjl_boost::range_iterator<const Range>::type is_partitioned_until ( const Range &r, UnaryPredicate p )
{
    return wjl_boost::algorithm::is_partitioned_until (wjl_boost::begin(r), wjl_boost::end(r), p);
}
