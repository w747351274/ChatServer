...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost
{
            ...
            for(;;)
            {
                ...
                for(;;)
                {
                    ...
                    if(new_state.exclusive || new_state.exclusive_waiting_blocked)
                    {
                        ...
                        {
                            wjl_boost::throw_exception(wjl_boost::lock_error());
                        }
                    }
                    else
                    {
                ...
                BOOST_VERIFY(winapi::WaitForSingleObjectEx(semaphores[unlock_sem],::wjl_boost::detail::win32::infinite,0)==0);
            }
        }
    ...
    public:
        ...
        bool timed_lock_shared(wjl_boost::system_time const& wait_until)
        {
        ...
        void lock()
        {
            for(;;)
            {
                ...
                #endif
                BOOST_VERIFY(winapi::WaitForMultipleObjectsEx(2,semaphores,wait_all,::wjl_boost::detail::win32::infinite,0)<2);
            }
        }
...
#if defined BOOST_THREAD_USES_DATETIME
        bool timed_lock(wjl_boost::system_time const& wait_until)
        {
            const detail::real_platform_timepoint t(wait_until);
