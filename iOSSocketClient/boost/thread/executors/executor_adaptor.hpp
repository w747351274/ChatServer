...
namespace executors
{
  ...
  public:
    ...
    executor_adaptor(BOOST_THREAD_RV_REF(Args) ... args) : ex(wjl_boost::forward<Args>(args)...) {}
#else
    /**
     * executor_adaptor constructor
     */
    ...
    void submit(BOOST_THREAD_RV_REF(work) closure)  {
      return ex.submit(wjl_boost::move(closure));
    }
    ...
    {
      //submit(work(wjl_boost::forward<Closure>(closure)));
      work w((wjl_boost::forward<Closure>(closure)));
      submit(wjl_boost::move(w));
    }
