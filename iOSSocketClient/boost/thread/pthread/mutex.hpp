  ...
  namespace posix {
    ...
    public:
        ...
        mutex()
        {
            ...
            if(res)
            {
                wjl_boost::throw_exception(thread_resource_error(res, "wjl_boost:: mutex constructor failed in pthread_mutex_init"));
            }
        }
        ~mutex()
        {
          int const res = posix::pthread_mutex_destroy(&m);
          wjl_boost::ignore_unused(res);
          BOOST_ASSERT(!res);
        }
        ...
        void lock()
        {
            ...
            if (res)
            {
                wjl_boost::throw_exception(lock_error(res,"boost: mutex lock failed in pthread_mutex_lock"));
            }
        }
...
//            if (res)
//            {
//                wjl_boost::throw_exception(lock_error(res,"boost: mutex unlock failed in pthread_mutex_unlock"));
//            }
        }
...
#define BOOST_THREAD_DEFINES_MUTEX_NATIVE_HANDLE
    ...
    public:
        ...
        timed_mutex()
        {
            ...
            if(res)
            {
                wjl_boost::throw_exception(thread_resource_error(res, "wjl_boost:: timed_mutex constructor failed in pthread_mutex_init"));
            }
#ifndef BOOST_THREAD_USES_PTHREAD_TIMEDLOCK
            ...
            if(res2)
            {
                ...
                wjl_boost::throw_exception(thread_resource_error(res2, "wjl_boost:: timed_mutex constructor failed in pthread::cond_init"));
            }
            is_locked=false;
#endif
        }
