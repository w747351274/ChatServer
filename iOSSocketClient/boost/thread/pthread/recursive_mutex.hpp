...
namespace wjl_boost {} namespace boost = wjl_boost; namespace wjl_boost
{
    ...
    public:
        ...
        recursive_mutex()
        {
            ...
            if(init_attr_res)
            {
                wjl_boost::throw_exception(thread_resource_error(init_attr_res, "wjl_boost:: recursive_mutex constructor failed in pthread_mutexattr_init"));
            }
            int const set_attr_res=pthread_mutexattr_settype(&attr,PTHREAD_MUTEX_RECURSIVE);
            if(set_attr_res)
            {
                BOOST_VERIFY(!pthread_mutexattr_destroy(&attr));
                wjl_boost::throw_exception(thread_resource_error(set_attr_res, "wjl_boost:: recursive_mutex constructor failed in pthread_mutexattr_settype"));
            }
            ...
            {
                BOOST_VERIFY(!pthread_mutexattr_destroy(&attr));
                wjl_boost::throw_exception(thread_resource_error(res, "wjl_boost:: recursive_mutex constructor failed in pthread_mutex_init"));
            }
            BOOST_VERIFY(!pthread_mutexattr_destroy(&attr));
#else
            ...
            if(res2)
            {
                ...
                wjl_boost::throw_exception(thread_resource_error(res2, "wjl_boost:: recursive_mutex constructor failed in pthread::cond_init"));
            }
            is_locked=false;
            count=0;
#endif
...
#define BOOST_THREAD_DEFINES_RECURSIVE_MUTEX_NATIVE_HANDLE
        ...
        void lock()
        {
            wjl_boost::pthread::pthread_mutex_scoped_lock const local_lock(&m);
    ...
    public:
        ...
        recursive_timed_mutex()
        {
            ...
            if(init_attr_res)
            {
                wjl_boost::throw_exception(thread_resource_error(init_attr_res, "wjl_boost:: recursive_timed_mutex constructor failed in pthread_mutexattr_init"));
            }
            int const set_attr_res=pthread_mutexattr_settype(&attr,PTHREAD_MUTEX_RECURSIVE);
            if(set_attr_res)
            {
                wjl_boost::throw_exception(thread_resource_error(set_attr_res, "wjl_boost:: recursive_timed_mutex constructor failed in pthread_mutexattr_settype"));
            }
            ...
            {
                BOOST_VERIFY(!pthread_mutexattr_destroy(&attr));
                wjl_boost::throw_exception(thread_resource_error(res, "wjl_boost:: recursive_timed_mutex constructor failed in pthread_mutex_init"));
            }
            BOOST_VERIFY(!pthread_mutexattr_destroy(&attr));
#else
            int const res=pthread_mutex_init(&m,NULL);
            ...
            {
                BOOST_VERIFY(!pthread_mutex_destroy(&m));
                wjl_boost::throw_exception(thread_resource_error(res2, "wjl_boost:: recursive_timed_mutex constructor failed in pthread::cond_init"));
            }
            is_locked=false;
            count=0;
#endif
