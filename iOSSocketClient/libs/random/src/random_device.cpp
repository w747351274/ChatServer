...
const bool wjl_boost::random::random_device::has_fixed_range;
#endif
...
class wjl_boost::random::random_device::impl
{
public:
...
private:
  ...
  void error(const char * msg) {
    ...
    wjl_boost::throw_exception(
      wjl_boost::system::system_error(
        error_code, wjl_boost::system::system_category(),
        std::string("wjl_boost::random_device: ") + msg + 
...
BOOST_RANDOM_DECL wjl_boost::random::random_device::random_device()
  : pimpl(new impl(default_token))
{}

BOOST_RANDOM_DECL wjl_boost::random::random_device::random_device(const std::string& token)
  : pimpl(new impl(token))
{}

BOOST_RANDOM_DECL wjl_boost::random_device::~random_device()
{
  delete pimpl;
}

BOOST_RANDOM_DECL double wjl_boost::random_device::entropy() const
{
  return 10;
}

BOOST_RANDOM_DECL unsigned int wjl_boost::random_device::operator()()
{
  return pimpl->next();
}
